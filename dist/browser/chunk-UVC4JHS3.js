...
function EditPartModalComponent_Conditional_76_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " Updating... ");
    \u0275\u0275element(1, "span", 40);
  }
}
function EditPartModalComponent_Conditional_77_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " Update Part ");
  }
}
var EditPartModalComponent = class _EditPartModalComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EditPartModalComponent, selectors: [["app-edit-part-modal"]], inputs: { part: "part", manageLoading: "manageLoading" }, outputs: { closeModal: "closeModal", updatePart: "updatePart" }, decls: 78, vars: 14, consts: [[1, "modal-overlay", 3, "click"], [1, "modal-content", 3, "click"], [1, "modal-header"], [1, "modal-title"], [1, "close-btn", 3, "click"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-5", "h-5"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M6 18L18 6M6 6l12 12"], [1, "edit-form", 3, "ngSubmit"], [1, "form-grid"], [1, "form-section"], [1, "section-title"], [1, "form-group"], ["for", "name", 1, "form-label"], ["type", "text", "id", "name", "name", "name", "required", "", 1, "form-input", 3, "ngModelChange", "ngModel"], ["for", "part_number", 1, "form-label"], ["type", "text", "id", "part_number", "name", "part_number", "required", "", 1, "form-input", 3, "ngModelChange", "ngModel"], ["for", "description", 1, "form-label"], ["id", "description", "name", "description", "rows", "3", "placeholder", "Enter part description...", 1, "form-textarea", 3, "ngModelChange", "ngModel"], ["for", "uom", 1, "form-label"], ["type", "text", "id", "uom", "name", "uom", "required", "", "placeholder", "e.g., pcs, kg, m", 1, "form-input", 3, "ngModelChange", "ngModel"], ["for", "unit_cost", 1, "form-label"], ["type", "number", "id", "unit_cost", "name", "unit_cost", "min", "0", "step", "0.01", "placeholder", "0.00", 1, "form-input", 3, "ngModelChange", "ngModel"], ["for", "category_id", 1, "form-label"], ["type", "number", "id", "category_id", "name", "category_id", "placeholder", "Category ID", 1, "form-input", 3, "ngModelChange", "ngModel"], ["for", "reorder_point", 1, "form-label"], ["type", "number", "id", "reorder_point", "name", "reorder_point", "min", "0", "placeholder", "0", 1, "form-input", 3, "ngModelChange", "ngModel"], ["for", "reorder_qty", 1, "form-label"], ["type", "number", "id", "reorder_qty", "name", "reorder_qty", "min", "0", "placeholder", "0", 1, "form-input", 3, "ngModelChange", "ngModel"], ["for", "barcode", 1, "form-label"], ["type", "text", "id", "barcode", "name", "barcode", "placeholder", "Barcode", 1, "form-input", 3, "ngModelChange", "ngModel"], ["for", "status", 1, "form-label"], ["id", "status", "name", "status", 1, "form-select", 3, "ngModelChange", "ngModel"], ["value", ""], [3, "value", 4, "ngFor", "ngForOf"], ["for", "abc_class", 1, "form-label"], ["id", "abc_class", "name", "abc_class", 1, "form-select", 3, "ngModelChange", "ngModel"], [1, "form-actions"], ["type", "button", 1, "btn", "btn-secondary", 3, "click"], ["type", "submit", 1, "btn", "btn-primary"], [3, "value"], [1, "border-t", "border-white", "border-opacity-25", "ml-2", "w-4", "h-4", "rounded-full", "animate-spin", "inline-block"]], template: function EditPartModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275template(76, EditPartModalComponent_Conditional_76_Template, 2, 0)(77, EditPartModalComponent_Conditional_77_Template, 1, 0);
      \u0275\u0275elementEnd()()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(16);
      ...
      \u0275\u0275advance(5);
      \u0275\u0275conditional(ctx.manageLoading ? 76 : 77);
    }
...
function AddPartModalComponent_Conditional_80_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " Creating... ");
    \u0275\u0275element(1, "span", 40);
  }
}
function AddPartModalComponent_Conditional_81_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " Create Part ");
  }
}
var AddPartModalComponent = class _AddPartModalComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AddPartModalComponent, selectors: [["app-add-part-modal"]], inputs: { manageLoading: "manageLoading" }, outputs: { closeModal: "closeModal", createPart: "createPart" }, decls: 82, vars: 12, consts: [[1, "modal-overlay", 3, "click"], [1, "modal-container", 3, "click"], [1, "modal-header"], [1, "header-left"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-6", "h-6"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M20 7l-8-4-8 4m16 0l-8 4m8-14V4a2 2 0 00-2-2H6a2 2 0 00-2 2v3m16 0H4"], [1, "modal-title"], [1, "modal-form", 3, "ngSubmit", "formGroup"], [1, "form-section"], [1, "section-header"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-5", "h-5"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"], [1, "section-title"], [1, "form-row"], [1, "form-field"], ["for", "part_number", 1, "field-label"], [1, "required"], ["type", "text", "id", "part_number", "formControlName", "part_number", "placeholder", "Enter part number", 1, "form-input"], ["class", "error-message", 4, "ngIf"], ["for", "name", 1, "field-label"], ["type", "text", "id", "name", "formControlName", "name", "placeholder", "Enter part name", 1, "form-input"], ["for", "description", 1, "field-label"], ["id", "description", "formControlName", "description", "rows", "3", "placeholder", "Enter part description", 1, "form-textarea"], ["for", "category_id", 1, "field-label"], ["type", "number", "id", "category_id", "formControlName", "category_id", "placeholder", "Enter category ID", 1, "form-input"], ["for", "barcode", 1, "field-label"], ["type", "text", "id", "barcode", "formControlName", "barcode", "placeholder", "Enter barcode", 1, "form-input"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1"], ["for", "uom", 1, "field-label"], ["type", "text", "id", "uom", "formControlName", "uom", "placeholder", "e.g., pcs, kg, m", 1, "form-input"], ["for", "unit_cost", 1, "field-label"], ["type", "number", "id", "unit_cost", "formControlName", "unit_cost", "placeholder", "0.00", "step", "0.01", "min", "0", 1, "form-input"], ["for", "reorder_point", 1, "field-label"], ["type", "number", "id", "reorder_point", "formControlName", "reorder_point", "placeholder", "0", "min", "0", 1, "form-input"], ["for", "reorder_qty", 1, "field-label"], ["type", "number", "id", "reorder_qty", "formControlName", "reorder_qty", "placeholder", "1", "min", "1", 1, "form-input"], [1, "modal-footer"], ["type", "button", 1, "btn", "btn-secondary", 3, "click"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], [1, "error-message"], [1, "border-t", "border-white", "border-opacity-25", "ml-2", "w-4", "h-4", "rounded-full", "animate-spin", "inline-block"]], template: function AddPartModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275template(80, AddPartModalComponent_Conditional_80_Template, 2, 0)(81, AddPartModalComponent_Conditional_81_Template, 1, 0);
      \u0275\u0275elementEnd()()()()();
    }
    if (rf & 2) {
      let tmp_1_0;
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.manageLoading ? 80 : 81);
    }
...
function PartsCatalogComponent_div_3_div_64_div_1_span_7_Template(rf, ctx) {
  if (rf & 1) {
...
function PartsCatalogComponent_div_3_div_64_div_1_div_14_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const part_r7 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("$", part_r7.unit_cost.toLocaleString(), "");
  }
}
function PartsCatalogComponent_div_3_div_64_div_1_div_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 77)(1, "span", 78);
...
function PartsCatalogComponent_div_3_div_64_div_1_div_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 77)(1, "span", 78);
    \u0275\u0275text(2, "ABC Class:");
    \u0275\u0275elementEnd();
...
function PartsCatalogComponent_div_3_div_64_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 67)(1, "div", 68)(2, "div", 69)(3, "h4", 70);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "span", 71);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275template(7, PartsCatalogComponent_div_3_div_64_div_1_span_7_Template, 2, 1, "span", 72);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(14, PartsCatalogComponent_div_3_div_64_div_1_div_14_Template, 5, 1, "div", 76);
    \u0275\u0275elementStart(15, "div", 77)(16, "span", 78);
    \u0275\u0275text(17, "UOM:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "span", 79);
    \u0275\u0275text(19);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(20, PartsCatalogComponent_div_3_div_64_div_1_div_20_Template, 5, 1, "div", 76)(21, PartsCatalogComponent_div_3_div_64_div_1_div_21_Template, 5, 1, "div", 76);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "div", 80)(23, "button", 81);
    \u0275\u0275listener("click", function PartsCatalogComponent_div_3_div_64_div_1_Template_button_click_23_listener() {
    ...
    \u0275\u0275element(25, "path", 82);
    \u0275\u0275elementEnd();
    \u0275\u0275text(26, " Edit ");
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(27, "button", 83);
    \u0275\u0275listener("click", function PartsCatalogComponent_div_3_div_64_div_1_Template_button_click_27_listener() {
      const part_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
...
function PartsCatalogComponent_div_3_div_64_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 65);
    \u0275\u0275template(1, PartsCatalogComponent_div_3_div_64_div_1_Template, 31, 10, "div", 66);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function PartsCatalogComponent_div_3_div_65_tr_23_td_9_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("$", part_r9.unit_cost.toLocaleString(), "");
  }
}
function PartsCatalogComponent_div_3_div_65_tr_23_td_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 99);
    \u0275\u0275text(1, "-");
    \u0275\u0275elementEnd();
...
function PartsCatalogComponent_div_3_div_65_tr_23_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr")(1, "td", 90);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "td", 70);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275template(9, PartsCatalogComponent_div_3_div_65_tr_23_td_9_Template, 2, 1, "td", 93)(10, PartsCatalogComponent_div_3_div_65_tr_23_td_10_Template, 2, 0, "td", 93);
    ...
    \u0275\u0275text(14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "td", 96)(16, "span", 74);
    \u0275\u0275text(17);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "td", 80)(19, "button", 97);
    \u0275\u0275listener("click", function PartsCatalogComponent_div_3_div_65_tr_23_Template_button_click_19_listener() {
      const part_r9 = \u0275\u0275restoreView(_r8).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.openEditPartModal(part_r9));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(20, "svg", 17);
    \u0275\u0275element(21, "path", 82);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(22, "button", 98);
    \u0275\u0275listener("click", function PartsCatalogComponent_div_3_div_65_tr_23_Template_button_click_22_listener() {
      const part_r9 = \u0275\u0275restoreView(_r8).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.openDeleteConfirmationModal(part_r9));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(23, "svg", 17);
    \u0275\u0275element(24, "path", 84);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(part_r9.part_number);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(part_r9.name);
    \u0275\u0275advance();
    \u0275\u0275propertyInterpolate("title", part_r9.description);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(part_r9.description || "-");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(part_r9.uom);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", part_r9.unit_cost);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !part_r9.unit_cost);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(part_r9.reorder_point || "-");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(part_r9.abc_class || "-");
    \u0275\u0275advance(2);
    \u0275\u0275classMap(ctx_r1.getStockStatus(part_r9).class);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.getStockStatus(part_r9).status, " ");
  }
}
function PartsCatalogComponent_div_3_div_65_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 86)(1, "table", 87)(2, "thead")(3, "tr", 88)(4, "th");
    ...
    \u0275\u0275template(23, PartsCatalogComponent_div_3_div_65_tr_23_Template, 25, 12, "tr", 89);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function PartsCatalogComponent_div_3_div_66_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function PartsCatalogComponent_div_3_div_66_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function PartsCatalogComponent_div_3_div_67_button_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r12 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 111);
    \u0275\u0275listener("click", function PartsCatalogComponent_div_3_div_67_button_6_Template_button_click_0_listener() {
...
function PartsCatalogComponent_div_3_div_67_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 105)(1, "button", 106);
    \u0275\u0275listener("click", function PartsCatalogComponent_div_3_div_67_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275template(6, PartsCatalogComponent_div_3_div_67_button_6_Template, 2, 3, "button", 109);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "button", 106);
    \u0275\u0275listener("click", function PartsCatalogComponent_div_3_div_67_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.onPageChange(ctx_r1.currentPage + 1));
    });
...
function PartsCatalogComponent_div_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(11, "div", 26)(12, "div", 21);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(13, "svg", 5);
    \u0275\u0275element(14, "path", 14);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(15, "div", 23)(16, "div", 27);
    \u0275\u0275text(17);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "div", 25);
    \u0275\u0275text(19, "Low Stock Items");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(20, "div", 28)(21, "div", 21);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(22, "svg", 5);
    \u0275\u0275element(23, "path", 29);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    ...
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(29, "div", 30)(30, "div", 31)(31, "div", 32);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(32, "svg", 33);
    \u0275\u0275element(33, "path", 34);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(34, "input", 35);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(37, "div", 37)(38, "select", 38);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(41, PartsCatalogComponent_div_3_option_41_Template, 3, 4, "option", 40);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceSVG();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(44, "div", 43)(45, "div", 44)(46, "div", 45)(47, "button", 46);
    \u0275\u0275listener("click", function PartsCatalogComponent_div_3_Template_button_click_47_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275element(49, "path", 47);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(50, "button", 48);
    \u0275\u0275listener("click", function PartsCatalogComponent_div_3_Template_button_click_50_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(53, "button", 50);
    \u0275\u0275listener("click", function PartsCatalogComponent_div_3_Template_button_click_53_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(56, "button", 52);
    \u0275\u0275listener("click", function PartsCatalogComponent_div_3_Template_button_click_56_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275element(58, "path", 53);
    \u0275\u0275elementEnd()()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(59, "button", 54);
    \u0275\u0275listener("click", function PartsCatalogComponent_div_3_Template_button_click_59_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.openAddPartModal());
    });
    ...
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(63, "div", 55);
    \u0275\u0275template(64, PartsCatalogComponent_div_3_div_64_Template, 2, 1, "div", 56)(65, PartsCatalogComponent_div_3_div_65_Template, 24, 1, "div", 57)(66, PartsCatalogComponent_div_3_div_66_Template, 11, 0, "div", 58);
    \u0275\u0275elementEnd();
    \u0275\u0275template(67, PartsCatalogComponent_div_3_div_67_Template, 11, 4, "div", 59);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.searchTerm || ctx_r1.selectedStatus ? 36 : -1);
    \u0275\u0275advance(2);
...
function PartsCatalogComponent_app_add_part_modal_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-add-part-modal", 112);
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("manageLoading", ctx_r1.partLoading);
  }
}
function PartsCatalogComponent_app_edit_part_modal_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r15 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-edit-part-modal", 113);
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("manageLoading", ctx_r1.partLoading)("part", ctx_r1.selectedPart);
  }
}
var PartsCatalogComponent = class _PartsCatalogComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PartsCatalogComponent, selectors: [["app-parts-catalog"]], decls: 10, vars: 10, consts: [[1, "parts-catalog"], ["class", "loading-state", 4, "ngIf"], ["class", "error-state", 4, "ngIf"], [4, "ngIf"], ["title", "Add New Part", 1, "fab", 3, "click"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-6", "h-6"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M12 4v16m8-8H4"], [3, "manageLoading", "closeModal", "createPart", 4, "ngIf"], [3, "manageLoading", "part", "closeModal", "updatePart", 4, "ngIf"], [3, "closeModal", "confirmDelete", "isOpen", "selectedCount", "entitySingular", "entityPlural", "warningText"], [1, "loading-state"], [1, "loading-spinner"], [1, "error-state"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-12", "h-12", "text-red-500"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z"], [1, "error-title"], [1, "btn", "btn-primary", 3, "click"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-4", "h-4"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"], [1, "summary-cards-row"], [1, "summary-card", "total-parts"], [1, "card-icon"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M20 7l-8-4-8 4m16 0l-8 4m8-14V4a2 2 0 00-2-2H6a2 2 0 00-2 2v3m16 0H4"], [1, "card-content"], [1, "card-value"], [1, "card-label"], [1, "summary-card", "low-stock"], [1, "card-value", "warning"], [1, "summary-card", "total-value"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1"], [1, "search-filters-section"], [1, "search-row"], [1, "search-container", "grid-cols-2", "!grid"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "search-icon"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"], ["type", "text", "placeholder", "Search here...", 1, "search-input", 3, "ngModelChange", "ngModel"], [1, "grid-cols-2"], [1, "status-filter", "relative"], [1, "status-select", 3, "mousedown", "change", "blur", "ngModelChange", "ngModel"], ["value", ""], [3, "value", 4, "ngFor", "ngForOf"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "dropdown-arrow", "absolute", "top-1/2", "right-2", "transform", "-translate-y-1/2", "w-4", "h-4"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M19 9l-7 7-7-7"], [1, "actions-row"], [1, "view-controls"], [1, "view-toggles", "gap-2"], ["title", "Grid View", 1, "view-toggle", 3, "click"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"], ["title", "List View", 1, "view-toggle", "!hidden", 3, "click"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M4 6h16M4 10h16M4 14h16M4 18h16"], ["title", "Compact Grid", 1, "view-toggle", "!hidden", 3, "click"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z"], ["title", "Table View", 1, "view-toggle", 3, "click"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M3 10h18M3 14h18m-9-4v8m-7 0h14a2 2 0 002-2V8a2 2 0 00-2-2H6a2 2 0 00-2 2v8a2 2 0 002 2z"], [1, "add-part-btn", 3, "click"], [1, "parts-display"], ["class", "parts-grid", 4, "ngIf"], ["class", "parts-table-container", 4, "ngIf"], ["class", "no-results", 4, "ngIf"], ["class", "pagination", 4, "ngIf"], [1, "btn", "btn-outline", 2, "margin-left", "0.5rem", 3, "click"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-4", "h-4", 2, "margin-right", ".5rem"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M6 18L18 6M6 6l12 12"], [1, "btn", "btn-primary", 2, "margin-left", "0.5rem", 3, "click"], [3, "value"], [1, "parts-grid"], ["class", "part-card", 4, "ngFor", "ngForOf"], [1, "part-card"], [1, "part-header"], [1, "part-info"], [1, "part-name"], [1, "part-id"], ["class", "part-description !line-clamp-2", 4, "ngIf"], [1, "stock-status"], [1, "status-badge"], [1, "part-details"], ["class", "detail-row", 4, "ngIf"], [1, "detail-row"], [1, "detail-label"], [1, "detail-value"], [1, "part-actions"], [1, "action-btn", "edit", 3, "click"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"], [1, "action-btn", "delete", 3, "click"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"], [1, "part-description", "!line-clamp-2"], [1, "parts-table-container"], [1, "parts-table"], [1, "uppercase"], [4, "ngFor", "ngForOf"], [1, "part-number"], [1, "part-description", "truncate", 3, "title"], [1, "part-uom"], ["class", "part-cost", 4, "ngIf"], [1, "part-reorder"], [1, "part-abc"], [1, "part-status"], ["title", "Edit", 1, "action-btn", "edit", 3, "click"], ["title", "Delete", 1, "action-btn", "delete", 3, "click"], [1, "part-cost"], [1, "no-results"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-12", "h-12", "text-gray-400"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"], [1, "no-results-title"], [1, "no-results-description"], [1, "pagination"], [1, "pagination-btn", 3, "click", "disabled"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M15 19l-7-7 7-7"], [1, "pagination-pages"], ["class", "pagination-page", 3, "active", "click", 4, "ngFor", "ngForOf"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M9 5l7 7-7 7"], [1, "pagination-page", 3, "click"], [3, "closeModal", "createPart", "manageLoading"], [3, "closeModal", "updatePart", "manageLoading", "part"]], template: function PartsCatalogComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0);
      \u0275\u0275template(1, PartsCatalogComponent_div_1_Template, 4, 0, "div", 1)(2, PartsCatalogComponent_div_2_Template, 9, 1, "div", 2)(3, PartsCatalogComponent_div_3_Template, 68, 21, "div", 3);
      ...
      \u0275\u0275element(6, "path", 6);
      \u0275\u0275elementEnd()();
      \u0275\u0275template(7, PartsCatalogComponent_app_add_part_modal_7_Template, 1, 1, "app-add-part-modal", 7)(8, PartsCatalogComponent_app_edit_part_modal_8_Template, 1, 2, "app-edit-part-modal", 8);
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(9, "app-delete-confirmation-modal", 9);
      \u0275\u0275listener("closeModal", function PartsCatalogComponent_Template_app_delete_confirmation_modal_closeModal_9_listener() {
        return ctx.closeDeleteModal();
      })("confirmDelete", function PartsCatalogComponent_Template_app_delete_confirmation_modal_confirmDelete_9_listener() {
...
\r
          <div class="grid-cols-2">\r
            @if (searchTerm || selectedStatus) {\r
...
\r
          <div class="part-actions">\r
            ...
            <button class="action-btn delete" (click)="openDeleteConfirmationModal(part)">\r
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">\r
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"\r
        ...
        <table class="parts-table">\r
          ...
          <tr *ngFor="let part of parts">\r
            ...
            <td class="part-actions">\r
              ...
              <button class="action-btn delete" (click)="openDeleteConfirmationModal(part)" title="Delete">\r
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">\r
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"\r
                        d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>\r
                </svg>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PartsCatalogComponent, { className: "PartsCatalogComponent", filePath: "src/app/inventory/components/parts-catalog/parts-catalog.component.ts", lineNumber: 18 });
})();
export {
  PartsCatalogComponent
};
//# sourceMappingURL=chunk-UVC4JHS3.js.map
