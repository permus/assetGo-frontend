...
function PlanDialogComponent_div_0_button_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("bg-blue-600", i_r4 === ctx_r1.step())("text-white", i_r4 === ctx_r1.step())("disabled", !ctx_r1.isTabAccessible(i_r4));
    \u0275\u0275advance();
...
function PlanDialogComponent_div_0_ng_container_16_div_25_Template(rf, ctx) {
  if (rf & 1) {
    const _r18 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 85)(1, "button", 86);
    \u0275\u0275listener("click", function PlanDialogComponent_div_0_ng_container_16_div_25_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r18);
      const ctx_r1 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275listener("click", function PlanDialogComponent_div_0_ng_container_16_div_25_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r18);
      const ctx_r1 = \u0275\u0275nextContext(3);
...
function PlanDialogComponent_div_0_ng_container_16_div_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 88)(1, "div", 89);
    \u0275\u0275element(2, "div", 90);
    \u0275\u0275elementStart(3, "p", 91);
    \u0275\u0275text(4, "Loading assets...");
    \u0275\u0275elementEnd()()();
  }
}
function PlanDialogComponent_div_0_ng_container_16_div_27_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5, "Failed to load assets");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p", 97);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "button", 98);
    \u0275\u0275listener("click", function PlanDialogComponent_div_0_ng_container_16_div_27_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r19);
      const ctx_r1 = \u0275\u0275nextContext(3);
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(ctx_r1.assetsError);
  }
}
function PlanDialogComponent_div_0_ng_container_16_div_28_span_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "No assets match your search criteria.");
    \u0275\u0275elementEnd();
  }
}
function PlanDialogComponent_div_0_ng_container_16_div_28_span_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "No assets available for selection.");
    \u0275\u0275elementEnd();
  }
}
function PlanDialogComponent_div_0_ng_container_16_div_28_button_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r20 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 98);
    \u0275\u0275listener("click", function PlanDialogComponent_div_0_ng_container_16_div_28_button_9_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r20);
      const ctx_r1 = \u0275\u0275nextContext(4);
      ctx_r1.searchAssets.set("");
      return \u0275\u0275resetView(ctx_r1.loadAssets());
    });
...
function PlanDialogComponent_div_0_ng_container_16_div_28_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(4, "h3", 103);
    \u0275\u0275text(5, "No assets found");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p", 104);
    \u0275\u0275template(7, PlanDialogComponent_div_0_ng_container_16_div_28_span_7_Template, 2, 0, "span", 105)(8, PlanDialogComponent_div_0_ng_container_16_div_28_span_8_Template, 2, 0, "span", 105);
    \u0275\u0275elementEnd();
    \u0275\u0275template(9, PlanDialogComponent_div_0_ng_container_16_div_28_button_9_Template, 2, 0, "button", 106);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(7);
    \u0275\u0275property("ngIf", ctx_r1.searchAssets());
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r1.searchAssets());
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.searchAssets());
...
function PlanDialogComponent_div_0_ng_container_16_div_29_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r21 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 109)(1, "div", 110)(2, "label", 111)(3, "input", 112);
    \u0275\u0275listener("change", function PlanDialogComponent_div_0_ng_container_16_div_29_div_1_Template_input_change_3_listener() {
      const a_r22 = \u0275\u0275restoreView(_r21).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.toggleAssetSelection(a_r22.id));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "span", 113);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 114);
    \u0275\u0275text(6, " No Schedule ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 115)(8, "div", 116);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 117)(11, "div", 118);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(12, "svg", 119);
    \u0275\u0275element(13, "path", 120)(14, "path", 121);
    \u0275\u0275elementEnd();
    \u0275\u0275text(15);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(17, "svg", 123);
    \u0275\u0275element(18, "path", 124)(19, "path", 125);
    \u0275\u0275elementEnd();
    \u0275\u0275text(20);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(21, "div", 122);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(22, "svg", 123);
    \u0275\u0275element(23, "path", 126);
    \u0275\u0275elementEnd();
    \u0275\u0275text(24);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(4);
    \u0275\u0275classProp("!border-blue-200", ctx_r1.isAssetSelected(a_r22.id));
    \u0275\u0275advance(3);
    \u0275\u0275property("checked", ctx_r1.isAssetSelected(a_r22.id));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(a_r22.name || a_r22.asset_name);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", a_r22.asset_id || a_r22.serial_number || a_r22.id, " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", (a_r22.location == null ? null : a_r22.location.name) || (a_r22.department == null ? null : a_r22.department.name) || a_r22.brand || "N/A", " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", (a_r22.manufacturer == null ? null : a_r22.manufacturer.name) || (a_r22.department == null ? null : a_r22.department.manufacturer) || "N/A", " ");
  }
}
function PlanDialogComponent_div_0_ng_container_16_div_29_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 107);
    \u0275\u0275template(1, PlanDialogComponent_div_0_ng_container_16_div_29_div_1_Template, 25, 7, "div", 108);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function PlanDialogComponent_div_0_ng_container_16_div_30_Template(rf, ctx) {
  if (rf & 1) {
    const _r23 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 127)(1, "button", 86);
    \u0275\u0275listener("click", function PlanDialogComponent_div_0_ng_container_16_div_30_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r23);
      const ctx_r1 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275listener("click", function PlanDialogComponent_div_0_ng_container_16_div_30_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r23);
      const ctx_r1 = \u0275\u0275nextContext(3);
...
function PlanDialogComponent_div_0_ng_container_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(25, PlanDialogComponent_div_0_ng_container_16_div_25_Template, 7, 3, "div", 78)(26, PlanDialogComponent_div_0_ng_container_16_div_26_Template, 5, 0, "div", 79)(27, PlanDialogComponent_div_0_ng_container_16_div_27_Template, 10, 1, "div", 80)(28, PlanDialogComponent_div_0_ng_container_16_div_28_Template, 10, 3, "div", 81)(29, PlanDialogComponent_div_0_ng_container_16_div_29_Template, 2, 1, "div", 82)(30, PlanDialogComponent_div_0_ng_container_16_div_30_Template, 7, 4, "div", 83);
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.assetsError && !ctx_r1.assetsLoading);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r1.assetsLoading && !ctx_r1.assetsError && ctx_r1.assets().length === 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r1.assetsLoading && !ctx_r1.assetsError && ctx_r1.assets().length > 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r1.assetsLoading && !ctx_r1.assetsError && ctx_r1.assets().length > 0);
...
function PlanDialogComponent_div_0_ng_container_17_div_25_button_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function PlanDialogComponent_div_0_ng_container_17_div_25_button_3_Template_button_click_0_listener() {
      ...
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.selectNewItemType(t_r26));
    });
    \u0275\u0275elementStart(1, "div", 64)(2, "div", 65)(3, "div", 66);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()()()();
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(4);
    \u0275\u0275classProp("selected", ctx_r1.newChecklistItem.type === t_r26);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(t_r26);
  }
}
...
function PlanDialogComponent_div_0_ng_container_17_div_46_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function PlanDialogComponent_div_0_ng_container_17_div_46_div_1_Template_button_click_5_listener() {
      ...
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.removeItem(i_r28));
    });
    \u0275\u0275text(6, "Remove");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const it_r29 = ctx.$implicit;
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(it_r29.title);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2("", it_r29.type, " \u2022 ", it_r29.is_required ? "Required" : "Optional", "");
  }
}
function PlanDialogComponent_div_0_ng_container_17_div_46_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 143);
    \u0275\u0275template(1, PlanDialogComponent_div_0_ng_container_17_div_46_div_1_Template, 7, 3, "div", 144);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function PlanDialogComponent_div_0_ng_container_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "div", 129)(2, "h3", 70);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 130)(5, "div", 131)(6, "div", 132);
    \u0275\u0275text(7, "Add New Item");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div", 87);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "div", 133)(11, "div", 34)(12, "label");
    \u0275\u0275text(13, "Title");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "textarea", 136);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(30, "div", 137)(31, "label", 138)(32, "input", 139);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(33, "span", 113);
    \u0275\u0275text(34, " Required");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "label", 138)(36, "input", 139);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(37, "span", 113);
    \u0275\u0275text(38, " Safety Critical");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "label", 138)(40, "input", 139);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(41, "span", 113);
    \u0275\u0275text(42, " Photo Required");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(43, "div", 140)(44, "button", 141);
    ...
    \u0275\u0275text(45, "+ Add Item");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(46, PlanDialogComponent_div_0_ng_container_17_div_46_Template, 2, 1, "div", 142);
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function PlanDialogComponent_div_0_ng_container_18_div_13_button_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function PlanDialogComponent_div_0_ng_container_18_div_13_button_3_Template_button_click_0_listener() {
      ...
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.selectFrequencyType(opt_r32.value));
    });
    \u0275\u0275elementStart(1, "div", 64)(2, "div", 56);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(3, "svg", 57);
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(4);
    \u0275\u0275classProp("selected", ctx_r1.model.frequency_type === opt_r32.value);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(opt_r32.name);
  }
}
...
function PlanDialogComponent_div_0_ng_container_18_div_31_button_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function PlanDialogComponent_div_0_ng_container_18_div_31_button_3_Template_button_click_0_listener() {
      ...
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.selectFrequencyUnit(u_r34));
    });
    \u0275\u0275elementStart(1, "div", 64)(2, "div", 56);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(3, "svg", 57);
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(4);
    \u0275\u0275classProp("selected", ctx_r1.model.frequency_unit === u_r34);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(u_r34);
  }
}
...
function PlanDialogComponent_div_0_ng_container_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "div", 149)(2, "div", 33)(3, "div", 34)(4, "label");
...
function PlanDialogComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(15, PlanDialogComponent_div_0_ng_container_15_Template, 56, 31, "ng-container", 14)(16, PlanDialogComponent_div_0_ng_container_16_Template, 31, 21, "ng-container", 14)(17, PlanDialogComponent_div_0_ng_container_17_Template, 47, 15, "ng-container", 14)(18, PlanDialogComponent_div_0_ng_container_18_Template, 33, 25, "ng-container", 14);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementEnd();
    ...
    if (this.assetCategoryOptions.length === 0) {
      this.assetsApi.getAssetCategories().subscribe({
        next: (res) => {
          ...
          this.assetCategoryOptions = data.map((cat) => ({
            id: cat.id,
    ...
    if (this.assetStatusOptions.length === 0) {
      this.assetsApi.getAssetStatuses().subscribe({
        next: (res) => {
          ...
          this.assetStatusOptions = data.map((status) => ({
            id: status.id,
...
\r
        <div class="mt-3 grid grid-cols-4 w-full gap-2 bg-white p-3 rounded-lg">\r
          <button *ngFor="let s of steps; index as i" class="tab-btn p-2 rounded-lg" [class.bg-blue-600]="i === step()"\r
                  [class.text-white]="i===step()" [class.disabled]="!isTabAccessible(i)" (click)="onTabClick(i)">{{ s }}\r
          </button>\r
        </div>\r
      </div>\r
\r
...
\r
              <!-- Loading State -->\r
              <div *ngIf="assetsLoading" class="assets-loading">\r
                <div class="loading-spinner">\r
                  <div class="spinner"></div>\r
                  <p class="loading-text">Loading assets...</p>\r
                </div>\r
              </div>\r
\r
              <!-- Error State -->\r
              <div *ngIf="assetsError && !assetsLoading" class="assets-error">\r
                <div class="error-content">\r
                  ...
                  <h3 class="error-title">Failed to load assets</h3>\r
                  <p class="error-message">{{ assetsError }}</p>\r
                  <button class="btn btn-secondary" (click)="loadAssets()">Try Again</button>\r
                </div>\r
              </div>\r
\r
              <!-- Empty State -->\r
              <div *ngIf="!assetsLoading && !assetsError && assets().length === 0" class="assets-empty">\r
                <div class="empty-content">\r
                  <svg class="empty-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">\r
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" \r
                          d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>\r
                  </svg>\r
                  <h3 class="empty-title">No assets found</h3>\r
                  <p class="empty-message">\r
                    <span *ngIf="searchAssets()">No assets match your search criteria.</span>\r
                    <span *ngIf="!searchAssets()">No assets available for selection.</span>\r
                  </p>\r
                  <button *ngIf="searchAssets()" class="btn btn-secondary" (click)="searchAssets.set(''); loadAssets()">\r
                    Clear Search\r
                  </button>\r
                </div>\r
              </div>\r
\r
              <!-- Assets Grid -->\r
              <div *ngIf="!assetsLoading && !assetsError && assets().length > 0" class="assets-grid">\r
...
\r
              <!-- Pagination - Only show when there are assets and not loading -->\r
              <div *ngIf="!assetsLoading && !assetsError && assets().length > 0" class="pagination-row">\r
...
//# sourceMappingURL=chunk-WN5YL3LI.js.map
