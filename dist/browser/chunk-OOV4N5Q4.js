...
var routes = [
  {
    ...
    children: [
      ...
      {
        path: "plans",
        loadComponent: () => import("./chunk-QNBWFZQV.js").then((m) => m.PlansPageComponent),
        title: "Preventive Maintenance \u2014 Plans"
      },
      {
        path: "scheduled",
        loadComponent: () => import("./chunk-CZ47QOTA.js").then((m) => m.ScheduledPageComponent),
        title: "Preventive Maintenance \u2014 Scheduled"
      },
      {
        path: "ppm-gantt",
        loadComponent: () => import("./chunk-XLYQ2ECS.js").then((m) => m.GanttPageComponent),
        title: "Preventive Maintenance \u2014 PPM Gantt"
      },
      {
        path: "inspections",
        loadComponent: () => import("./chunk-DNRB3UKR.js").then((m) => m.InspectionsPageComponent),
        title: "Preventive Maintenance \u2014 Inspections"
      },
      {
        path: "history",
        loadComponent: () => import("./chunk-TSEBPZW3.js").then((m) => m.HistoryPageComponent),
        title: "Preventive Maintenance \u2014 History"
      },
      {
        path: "analytics",
        loadComponent: () => import("./chunk-QSZM5654.js").then((m) => m.AnalyticsPageComponent),
  ...
  {
    path: "plans/:id",
    loadComponent: () => import("./chunk-T66FYZXH.js").then((m) => m.PlanPreviewPageComponent),
    title: "Maintenance Plan Preview"
  },
  {
    path: "scheduled/:id",
    loadComponent: () => import("./chunk-OP2FZTVT.js").then((m) => m.SchedulePreviewPageComponent),
...
//# sourceMappingURL=chunk-OOV4N5Q4.js.map
