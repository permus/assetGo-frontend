...
function TeamFormModalComponent_p_17_Template(rf, ctx) {
  if (rf & 1) {
...
function TeamFormModalComponent_p_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 38);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function TeamFormModalComponent_p_27_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 38);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function TeamFormModalComponent_div_28_p_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 38);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function TeamFormModalComponent_div_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 12)(1, "label", 39);
    \u0275\u0275text(2, " Password (Optional) ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(3, "input", 40);
    \u0275\u0275template(4, TeamFormModalComponent_div_28_p_4_Template, 2, 1, "p", 15);
    \u0275\u0275elementStart(5, "p", 27);
    \u0275\u0275text(6, " Leave blank to auto-generate a secure password and send via email. ");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_1_0;
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275classProp("border-red-300", ((tmp_1_0 = ctx_r0.teamMemberForm.get("password")) == null ? null : tmp_1_0.invalid) && (((tmp_1_0 = ctx_r0.teamMemberForm.get("password")) == null ? null : tmp_1_0.dirty) || ((tmp_1_0 = ctx_r0.teamMemberForm.get("password")) == null ? null : tmp_1_0.touched)));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.getFieldError("password"));
  }
}
function TeamFormModalComponent_div_29_p_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 38);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function TeamFormModalComponent_div_29_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 12)(1, "label", 41);
    \u0275\u0275text(2, " Confirm Password ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(3, "input", 42);
    \u0275\u0275template(4, TeamFormModalComponent_div_29_p_4_Template, 2, 1, "p", 15);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_1_0;
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275classProp("border-red-300", ((tmp_1_0 = ctx_r0.teamMemberForm.get("password_confirmation")) == null ? null : tmp_1_0.invalid) && (((tmp_1_0 = ctx_r0.teamMemberForm.get("password_confirmation")) == null ? null : tmp_1_0.dirty) || ((tmp_1_0 = ctx_r0.teamMemberForm.get("password_confirmation")) == null ? null : tmp_1_0.touched)));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.getFieldError("password_confirmation"));
  }
}
function TeamFormModalComponent_option_36_Template(rf, ctx) {
  if (rf & 1) {
...
function TeamFormModalComponent_p_37_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 38);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function TeamFormModalComponent_p_38_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 38);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function TeamFormModalComponent_p_43_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 38);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function TeamFormModalComponent_div_46_div_10_Template(rf, ctx) {
  if (rf & 1) {
...
function TeamFormModalComponent_div_46_div_11_Template(rf, ctx) {
  if (rf & 1) {
...
function TeamFormModalComponent_div_46_div_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
    \u0275\u0275element(1, "ng-select", 57);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function TeamFormModalComponent_div_46_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function TeamFormModalComponent_div_46_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementStart(8, "label", 50);
    \u0275\u0275text(9, "Include descendants (recommended)");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(10, TeamFormModalComponent_div_46_div_10_Template, 2, 0, "div", 51)(11, TeamFormModalComponent_div_46_div_11_Template, 2, 1, "div", 52)(12, TeamFormModalComponent_div_46_div_12_Template, 2, 4, "div", 53);
...
function TeamFormModalComponent__svg_svg_51_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 58);
    \u0275\u0275element(1, "circle", 59)(2, "path", 60);
    \u0275\u0275elementEnd();
  }
}
var TeamFormModalComponent = class _TeamFormModalComponent {
  ...
  flatLocationOptions = [];
  constructor(fb, teamService, roleService, locationTreeService, toastService) {
    this.fb = fb;
    ...
    }, { validators: _TeamFormModalComponent.passwordMatchValidator });
  ...
  loadTeamMember() {
    if (this.teamMember) {
      let roleName;
      if (this.teamMember.role_id) {
        roleName = this.teamMember.role?.name;
      } else if (this.teamMember.role?.name) {
        roleName = this.teamMember.role.name;
      } else if (Array.isArray(this.teamMember.roles) && this.teamMember.roles.length > 0) {
        const firstRole = this.teamMember.roles[0];
  ...
  static passwordMatchValidator(form) {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TeamFormModalComponent, selectors: [["app-team-form-modal"]], inputs: { teamMember: "teamMember", isEditMode: "isEditMode" }, outputs: { teamMemberSaved: "teamMemberSaved", cancelled: "cancelled" }, features: [\u0275\u0275NgOnChangesFeature], decls: 53, vars: 26, consts: [[1, "modal-overlay", "fixed", "inset-0", "bg-[#00000085]", "flex", "items-center", "justify-center", "z-50", 3, "click"], [1, "bg-white", "rounded-xl", "shadow-2xl", "w-full", "max-w-4xl", "mx-4", "transform", "transition-all"], [1, "px-6", "py-4", "border-b", "border-gray-200"], [1, "flex", "items-center", "justify-between"], [1, "text-lg", "font-semibold", "text-gray-900"], [1, "text-gray-400", "hover:text-gray-600", "transition-colors", 3, "click"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-6", "h-6"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M6 18L18 6M6 6l12 12"], [1, "px-6", "py-4"], [3, "ngSubmit", "formGroup"], ["class", "mb-4 p-3 bg-red-50 border border-red-200 rounded-lg", 4, "ngIf"], [1, "grid", "grid-cols-2", "gap-4"], [1, "mb-4"], ["for", "first_name", 1, "block", "text-sm", "font-medium", "text-gray-700", "mb-2"], ["id", "first_name", "type", "text", "formControlName", "first_name", "placeholder", "Enter first name", 1, "w-full", "px-3", "py-2", "border", "border-gray-300", "rounded-lg", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", "focus:border-transparent", "transition-colors"], ["class", "mt-1 text-sm text-red-600", 4, "ngIf"], ["for", "last_name", 1, "block", "text-sm", "font-medium", "text-gray-700", "mb-2"], ["id", "last_name", "type", "text", "formControlName", "last_name", "placeholder", "Enter last name", 1, "w-full", "px-3", "py-2", "border", "border-gray-300", "rounded-lg", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", "focus:border-transparent", "transition-colors"], ["for", "email", 1, "block", "text-sm", "font-medium", "text-gray-700", "mb-2"], ["id", "email", "type", "email", "formControlName", "email", "placeholder", "Enter email address", 1, "w-full", "px-3", "py-2", "border", "border-gray-300", "rounded-lg", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", "focus:border-transparent", "transition-colors"], ["class", "mb-4", 4, "ngIf"], ["for", "role_id", 1, "block", "text-sm", "font-medium", "text-gray-700", "mb-2"], ["id", "role_id", "formControlName", "role_id", 1, "w-full", "px-3", "py-2", "border", "border-gray-300", "rounded-lg", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", "focus:border-transparent", "transition-colors"], ["value", ""], [3, "value", 4, "ngFor", "ngForOf"], ["for", "hourly_rate", 1, "block", "text-sm", "font-medium", "text-gray-700", "mb-2"], ["id", "hourly_rate", "type", "number", "formControlName", "hourly_rate", "placeholder", "Enter hourly rate", "min", "0", "step", "0.01", 1, "w-full", "px-3", "py-2", "border", "border-gray-300", "rounded-lg", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", "focus:border-transparent", "transition-colors"], [1, "mt-1", "text-xs", "text-gray-500"], ["class", "mb-4 border rounded-lg p-3 bg-gray-50", 4, "ngIf"], [1, "flex", "justify-end", "space-x-3", "pt-4", "border-t", "border-gray-200"], ["type", "button", 1, "px-4", "py-2", "text-sm", "font-medium", "text-gray-700", "bg-white", "border", "border-gray-300", "rounded-lg", "hover:bg-gray-50", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", "focus:ring-offset-2", "transition-colors", 3, "click"], ["type", "submit", 1, "px-4", "py-2", "text-sm", "font-medium", "text-white", "bg-blue-600", "border", "border-transparent", "rounded-lg", "hover:bg-blue-700", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", "focus:ring-offset-2", "transition-colors", "disabled:opacity-50", "disabled:cursor-not-allowed", 3, "disabled"], ["class", "animate-spin -ml-1 mr-2 h-4 w-4 text-white inline", "fill", "none", "viewBox", "0 0 24 24", 4, "ngIf"], [1, "mb-4", "p-3", "bg-red-50", "border", "border-red-200", "rounded-lg"], [1, "flex"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-5", "h-5", "text-red-400", "mt-0.5"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"], [1, "ml-2", "text-sm", "text-red-700"], [1, "mt-1", "text-sm", "text-red-600"], ["for", "password", 1, "block", "text-sm", "font-medium", "text-gray-700", "mb-2"], ["id", "password", "type", "password", "formControlName", "password", "placeholder", "Enter custom password", 1, "w-full", "px-3", "py-2", "border", "border-gray-300", "rounded-lg", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", "focus:border-transparent", "transition-colors"], ["for", "password_confirmation", 1, "block", "text-sm", "font-medium", "text-gray-700", "mb-2"], ["id", "password_confirmation", "type", "password", "formControlName", "password_confirmation", "placeholder", "Confirm password", 1, "w-full", "px-3", "py-2", "border", "border-gray-300", "rounded-lg", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", "focus:border-transparent", "transition-colors"], [3, "value"], [1, "mb-4", "border", "rounded-lg", "p-3", "bg-gray-50"], [1, "flex", "items-center", "justify-between", "mb-2"], [1, "font-medium", "text-gray-800"], ["type", "button", 1, "text-sm", "text-blue-600", "hover:underline", 3, "click"], [1, "flex", "items-center", "mb-3"], ["type", "checkbox", "id", "expand_descendants", "formControlName", "expand_descendants", 1, "mr-2"], ["for", "expand_descendants", 1, "text-sm", "text-gray-700"], ["class", "text-sm text-gray-500", 4, "ngIf"], ["class", "text-sm text-red-600", 4, "ngIf"], [4, "ngIf"], [1, "mt-2", "text-xs", "text-gray-500"], [1, "text-sm", "text-gray-500"], [1, "text-sm", "text-red-600"], ["bindLabel", "label", "bindValue", "id", "placeholder", "Select locations (empty = full access)", "formControlName", "location_ids", 3, "items", "multiple", "closeOnSelect", "searchable"], ["fill", "none", "viewBox", "0 0 24 24", 1, "animate-spin", "-ml-1", "mr-2", "h-4", "w-4", "text-white", "inline"], ["cx", "12", "cy", "12", "r", "10", "stroke", "currentColor", "stroke-width", "4", 1, "opacity-25"], ["fill", "currentColor", "d", "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z", 1, "opacity-75"]], template: function TeamFormModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275template(17, TeamFormModalComponent_p_17_Template, 2, 1, "p", 15);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(18, "div", 12)(19, "label", 16);
      \u0275\u0275text(20, " Last Name * ");
      \u0275\u0275elementEnd();
      \u0275\u0275element(21, "input", 17);
      \u0275\u0275template(22, TeamFormModalComponent_p_22_Template, 2, 1, "p", 15);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(23, "div", 12)(24, "label", 18);
      \u0275\u0275text(25, " Email * ");
      \u0275\u0275elementEnd();
      \u0275\u0275element(26, "input", 19);
      \u0275\u0275template(27, TeamFormModalComponent_p_27_Template, 2, 1, "p", 15);
      \u0275\u0275elementEnd();
      \u0275\u0275template(28, TeamFormModalComponent_div_28_Template, 7, 3, "div", 20)(29, TeamFormModalComponent_div_29_Template, 5, 3, "div", 20);
      \u0275\u0275elementStart(30, "div", 12)(31, "label", 21);
      \u0275\u0275text(32, " Team Role * ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(33, "select", 22)(34, "option", 23);
      \u0275\u0275text(35, "Select a role");
      \u0275\u0275elementEnd();
      \u0275\u0275template(36, TeamFormModalComponent_option_36_Template, 2, 2, "option", 24);
      \u0275\u0275elementEnd();
      \u0275\u0275template(37, TeamFormModalComponent_p_37_Template, 2, 1, "p", 15)(38, TeamFormModalComponent_p_38_Template, 2, 1, "p", 15);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(39, "div", 12)(40, "label", 25);
      \u0275\u0275text(41, " Hourly Rate (Optional) ");
      \u0275\u0275elementEnd();
      \u0275\u0275element(42, "input", 26);
      \u0275\u0275template(43, TeamFormModalComponent_p_43_Template, 2, 1, "p", 15);
      \u0275\u0275elementStart(44, "p", 27);
      \u0275\u0275text(45, " Optional hourly rate for this team member ");
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(46, TeamFormModalComponent_div_46_Template, 15, 3, "div", 28);
      \u0275\u0275elementStart(47, "div", 29)(48, "button", 30);
      \u0275\u0275listener("click", function TeamFormModalComponent_Template_button_click_48_listener() {
        return ctx.onCancel();
      });
      \u0275\u0275text(49, " Cancel ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(50, "button", 31);
      \u0275\u0275template(51, TeamFormModalComponent__svg_svg_51_Template, 3, 0, "svg", 32);
      \u0275\u0275text(52);
      \u0275\u0275elementEnd()()()()()();
    }
    if (rf & 2) {
      ...
      \u0275\u0275property("ngIf", !ctx.isEditMode);
      \u0275\u0275advance(4);
      \u0275\u0275classProp("border-red-300", ((tmp_11_0 = ctx.teamMemberForm.get("role_id")) == null ? null : tmp_11_0.invalid) && (((tmp_11_0 = ctx.teamMemberForm.get("role_id")) == null ? null : tmp_11_0.dirty) || ((tmp_11_0 = ctx.teamMemberForm.get("role_id")) == null ? null : tmp_11_0.touched)));
      \u0275\u0275advance(3);
      ...
      \u0275\u0275advance(4);
      \u0275\u0275classProp("border-red-300", ((tmp_15_0 = ctx.teamMemberForm.get("hourly_rate")) == null ? null : tmp_15_0.invalid) && (((tmp_15_0 = ctx.teamMemberForm.get("hourly_rate")) == null ? null : tmp_15_0.dirty) || ((tmp_15_0 = ctx.teamMemberForm.get("hourly_rate")) == null ? null : tmp_15_0.touched)));
      \u0275\u0275advance();
...
(() => {
  ...
  <!-- Modal Content -->\r
  <div class="bg-white rounded-xl shadow-2xl w-full max-w-4xl mx-4 transform transition-all">\r
    <!-- Modal Header -->\r
...
\r
          <!-- Password (only for new team members) -->\r
          <div *ngIf="!isEditMode" class="mb-4">\r
            <label for="password" class="block text-sm font-medium text-gray-700 mb-2">\r
              Password (Optional)\r
            </label>\r
            <input\r
              id="password"\r
              ...
              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"\r
              placeholder="Enter custom password"\r
              [class.border-red-300]="teamMemberForm.get('password')?.invalid && (teamMemberForm.get('password')?.dirty || teamMemberForm.get('password')?.touched)">\r
            <p *ngIf="getFieldError('password')" class="mt-1 text-sm text-red-600">\r
              {{ getFieldError('password') }}\r
            </p>\r
            <p class="mt-1 text-xs text-gray-500">\r
              Leave blank to auto-generate a secure password and send via email.\r
            </p>\r
          </div>\r
\r
          <!-- Password Confirmation (only for new team members) -->\r
          <div *ngIf="!isEditMode" class="mb-4">\r
            <label for="password_confirmation" class="block text-sm font-medium text-gray-700 mb-2">\r
              Confirm Password\r
            </label>\r
            <input\r
              ...
              [class.border-red-300]="teamMemberForm.get('password_confirmation')?.invalid && (teamMemberForm.get('password_confirmation')?.dirty || teamMemberForm.get('password_confirmation')?.touched)">\r
            <p *ngIf="getFieldError('password_confirmation')" class="mt-1 text-sm text-red-600">\r
...
`, styles: ["/* src/app/teams/components/team-form-modal/team-form-modal.component.scss */\n.modal-overlay {\n  animation: modalSlideIn 0.3s ease-out;\n}\n@keyframes modalSlideIn {\n  from {\n    opacity: 0;\n    transform: translateY(-20px);\n  }\n  to {\n    opacity: 1;\n    transform: translateY(0);\n  }\n}\n.modal-enter {\n  opacity: 0;\n  transform: scale(0.9);\n}\n.modal-enter-active {\n  opacity: 1;\n  transform: scale(1);\n  transition: opacity 0.2s ease-out, transform 0.2s ease-out;\n}\n.modal-exit {\n  opacity: 1;\n  transform: scale(1);\n}\n.modal-exit-active {\n  opacity: 0;\n  transform: scale(0.9);\n  transition: opacity 0.2s ease-in, transform 0.2s ease-in;\n}\n.backdrop-enter {\n  opacity: 0;\n}\n.backdrop-enter-active {\n  opacity: 1;\n  transition: opacity 0.2s ease-out;\n}\n.backdrop-exit {\n  opacity: 1;\n}\n.backdrop-exit-active {\n  opacity: 0;\n  transition: opacity 0.2s ease-in;\n}\ninput:focus,\ntextarea:focus {\n  box-shadow: 0 0 0 3px rgba(59, 130, 246, 0.1);\n}\nbutton:not(:disabled):hover {\n  transform: translateY(-1px);\n  transition: transform 0.1s ease-in-out;\n}\n@keyframes spin {\n  to {\n    transform: rotate(360deg);\n  }\n}\n.animate-spin {\n  animation: spin 1s linear infinite;\n}\n/*# sourceMappingURL=team-form-modal.component.css.map */\n"] }]
  }], () => [{ type: FormBuilder }, { type: TeamService }, { type: RoleService }, { type: LocationTreeService }, { type: ToastService }], { teamMember: [{
    type: Input
  }], isEditMode: [{
    type: Input
  }], teamMemberSaved: [{
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TeamFormModalComponent, { className: "TeamFormModalComponent", filePath: "src/app/teams/components/team-form-modal/team-form-modal.component.ts", lineNumber: 18 });
})();
...
function AssignWorkOrderModalComponent_div_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 17);
    \u0275\u0275element(1, "div", 18);
    \u0275\u0275elementStart(2, "span");
    \u0275\u0275text(3, "Loading work orders...");
    \u0275\u0275elementEnd()();
  }
}
function AssignWorkOrderModalComponent_div_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4, "No available work orders to assign");
    \u0275\u0275elementEnd()();
  }
}
function AssignWorkOrderModalComponent_span_26_Template(rf, ctx) {
  if (rf & 1) {
...
function AssignWorkOrderModalComponent_span_27_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
...
var AssignWorkOrderModalComponent = class _AssignWorkOrderModalComponent {
  ...
  fetchWorkOrders() {
    ...
    this.workOrderService.getWorkOrders({
      ...
      next: (response) => {
        ...
        const availableWorkOrders = (response.data.data || []).filter((workOrder) => workOrder.assigned_to !== this.teamMemberId && workOrder.status?.slug !== "completed" && workOrder.status?.slug !== "cancelled");
        this.workOrders = availableWorkOrders.map((workOrder) => ({
          id: workOrder.id,
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssignWorkOrderModalComponent, selectors: [["app-assign-work-order-modal"]], inputs: { teamMemberName: "teamMemberName", teamMemberId: "teamMemberId" }, outputs: { closed: "closed", submitted: "submitted" }, decls: 28, vars: 15, consts: [[1, "modal-overlay", 3, "click"], [1, "modal", 3, "click"], [1, "modal-header"], [1, "close-btn", 3, "click"], [1, "subtitle"], ["class", "error-message", 4, "ngIf"], [1, "form-group"], ["label", "Available Work Orders", 3, "selectionChange", "required", "options", "selectedOption", "placeholder", "searchable", "disabled"], ["class", "loading-indicator", 4, "ngIf"], ["class", "no-work-orders", 4, "ngIf"], ["type", "datetime-local", 1, "input", 3, "ngModelChange", "input", "ngModel"], ["rows", "5", "placeholder", "Add any specific instructions or notes for this assignment...", 1, "textarea", 3, "ngModelChange", "input", "ngModel"], [1, "modal-actions"], [1, "btn", "secondary", 3, "click"], [1, "btn", "primary", 3, "click", "disabled"], [4, "ngIf"], [1, "error-message"], [1, "loading-indicator"], [1, "spinner"], [1, "no-work-orders"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-6", "h-6", "text-gray-400"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"]], template: function AssignWorkOrderModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(12, AssignWorkOrderModalComponent_div_12_Template, 4, 0, "div", 8)(13, AssignWorkOrderModalComponent_div_13_Template, 5, 0, "div", 9);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(14, "div", 6)(15, "label");
      \u0275\u0275text(16, "Due Date (Optional)");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(17, "input", 10);
      \u0275\u0275twoWayListener("ngModelChange", function AssignWorkOrderModalComponent_Template_input_ngModelChange_17_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.dueDate, $event) || (ctx.dueDate = $event);
        return $event;
      });
      \u0275\u0275listener("input", function AssignWorkOrderModalComponent_Template_input_input_17_listener() {
        return ctx.onInputChange();
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(18, "div", 6)(19, "label");
      \u0275\u0275text(20, "Assignment Notes (Optional)");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(21, "textarea", 11);
      \u0275\u0275twoWayListener("ngModelChange", function AssignWorkOrderModalComponent_Template_textarea_ngModelChange_21_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.notes, $event) || (ctx.notes = $event);
        return $event;
      });
      \u0275\u0275listener("input", function AssignWorkOrderModalComponent_Template_textarea_input_21_listener() {
        return ctx.onInputChange();
      });
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275listener("click", function AssignWorkOrderModalComponent_Template_button_click_25_listener() {
        return ctx.submit();
      });
      \u0275\u0275template(26, AssignWorkOrderModalComponent_span_26_Template, 2, 0, "span", 15)(27, AssignWorkOrderModalComponent_span_27_Template, 2, 0, "span", 15);
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(4);
  ...
  <div class="modal" (click)="$event.stopPropagation()">\r
    ...
    <div class="form-group">\r
      <app-global-dropdown\r
        label="Available Work Orders"\r
        [required]="true"\r
        [options]="workOrders"\r
        [selectedOption]="selectedWorkOrder"\r
        [placeholder]="loading ? 'Loading work orders...' : 'Select a work order'"\r
        [searchable]="true"\r
        [disabled]="loading"\r
        (selectionChange)="selectWorkOrder($event)">\r
      </app-global-dropdown>\r
      <div *ngIf="loading" class="loading-indicator">\r
        <div class="spinner"></div>\r
        <span>Loading work orders...</span>\r
      </div>\r
      <div *ngIf="!loading && workOrders.length === 0" class="no-work-orders">\r
        ...
        <span>No available work orders to assign</span>\r
      </div>\r
    </div>\r
    \r
    <div class="form-group">\r
      <label>Due Date (Optional)</label>\r
      <input class="input" type="datetime-local" [(ngModel)]="dueDate" (input)="onInputChange()" />\r
    </div>\r
    \r
    <div class="form-group">\r
      <label>Assignment Notes (Optional)</label>\r
      <textarea class="textarea" rows="5" [(ngModel)]="notes" (input)="onInputChange()" placeholder="Add any specific instructions or notes for this assignment..."></textarea>\r
    </div>\r
    \r
    <div class="modal-actions">\r
      <button class="btn secondary" (click)="close()">Cancel</button>\r
      <button class="btn primary" [disabled]="!selectedWorkOrderId || loading || workOrders.length === 0" (click)="submit()">\r
        <span *ngIf="loading">Assigning...</span>\r
        <span *ngIf="!loading">Assign Work Order</span>\r
      </button>\r
    </div>\r
  </div>\r
</div>\r
...
function TeamListComponent_Conditional_24_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("", (ctx_r0.statistics == null ? null : ctx_r0.statistics.active_team_members) || 0, " Active");
  }
}
...
function TeamListComponent_div_75_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, TeamListComponent_div_75_div_2__svg_svg_3_Template, 2, 0, "svg", 63);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function TeamListComponent_div_75_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 47)(1, "div", 60);
    \u0275\u0275template(2, TeamListComponent_div_75_div_2_Template, 4, 4, "div", 61);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function TeamListComponent_Conditional_86_For_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function TeamListComponent_Conditional_86_For_3_Template_div_click_0_listener() {
      ...
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.selectRole(role_r5));
    });
    \u0275\u0275elementStart(1, "span");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, TeamListComponent_Conditional_86_For_3__svg_svg_3_Template, 2, 0, "svg", 63);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const role_r5 = ctx.$implicit;
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("bg-blue-100", (ctx_r0.selectedRole == null ? null : ctx_r0.selectedRole.value) === role_r5.value);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(role_r5.label);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (ctx_r0.selectedRole == null ? null : ctx_r0.selectedRole.value) === role_r5.value);
  }
}
function TeamListComponent_Conditional_86_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 47)(1, "div", 60);
    \u0275\u0275repeaterCreate(2, TeamListComponent_Conditional_86_For_3_Template, 4, 4, "div", 66, _forTrack0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275repeater(ctx_r0.roleOptions);
  }
}
...
function TeamListComponent_Conditional_94_For_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function TeamListComponent_Conditional_94_For_3_Template_div_click_0_listener() {
      ...
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.selectStatus(status_r7));
    });
    \u0275\u0275elementStart(1, "span");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, TeamListComponent_Conditional_94_For_3__svg_svg_3_Template, 2, 0, "svg", 63);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const status_r7 = ctx.$implicit;
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("bg-blue-100", (ctx_r0.selectedStatus == null ? null : ctx_r0.selectedStatus.value) === status_r7.value);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(status_r7.label);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (ctx_r0.selectedStatus == null ? null : ctx_r0.selectedStatus.value) === status_r7.value);
  }
}
function TeamListComponent_Conditional_94_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 47)(1, "div", 60);
    \u0275\u0275repeaterCreate(2, TeamListComponent_Conditional_94_For_3_Template, 4, 4, "div", 66, _forTrack0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function TeamListComponent_Conditional_95_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 48)(1, "div", 67);
    \u0275\u0275namespaceSVG();
...
function TeamListComponent_Conditional_97_div_1_div_25_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 111);
    \u0275\u0275listener("click", function TeamListComponent_Conditional_97_div_1_div_25_Template_div_click_0_listener($event) {
      \u0275\u0275restoreView(_r10);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementStart(1, "div", 60)(2, "button", 112);
    \u0275\u0275listener("click", function TeamListComponent_Conditional_97_div_1_div_25_Template_button_click_2_listener($event) {
      \u0275\u0275restoreView(_r10);
      const teamMember_r9 = \u0275\u0275nextContext().$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.onEditClick($event, teamMember_r9));
    });
    \u0275\u0275namespaceSVG();
    ...
    \u0275\u0275listener("click", function TeamListComponent_Conditional_97_div_1_div_25_Template_button_click_7_listener($event) {
      \u0275\u0275restoreView(_r10);
      const teamMember_r9 = \u0275\u0275nextContext().$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.onToggleStatusClick($event, teamMember_r9));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(8, "svg", 116);
    \u0275\u0275element(9, "path", 117);
    \u0275\u0275elementEnd();
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(11, "button", 118);
    \u0275\u0275listener("click", function TeamListComponent_Conditional_97_div_1_div_25_Template_button_click_11_listener($event) {
      \u0275\u0275restoreView(_r10);
      const teamMember_r9 = \u0275\u0275nextContext().$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.onDeleteClick($event, teamMember_r9));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(12, "svg", 119);
    \u0275\u0275element(13, "path", 120);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
  ...
  if (rf & 2) {
    const teamMember_r9 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance(7);
    \u0275\u0275classProp("text-red-500", teamMember_r9.active)("text-green-600", !teamMember_r9.active)("hover:bg-red-50", teamMember_r9.active)("hover:bg-green-50", !teamMember_r9.active);
    \u0275\u0275advance();
    \u0275\u0275classMap(teamMember_r9.active ? "size-4 text-red-500 mr-2.5" : "size-4 text-green-500 mr-2.5");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", teamMember_r9.active ? "Inactive" : "Active", " ");
  }
}
function TeamListComponent_Conditional_97_div_1_div_31_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const teamMember_r9 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(teamMember_r9.role.name);
  }
}
function TeamListComponent_Conditional_97_div_1_div_39_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 123)(1, "span");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const teamMember_r9 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("$", teamMember_r9.hourly_rate, "/hour");
  }
}
function TeamListComponent_Conditional_97_div_1_span_48_Template(rf, ctx) {
  if (rf & 1) {
...
function TeamListComponent_Conditional_97_div_1_ng_container_49_span_2_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const loc_r11 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", loc_r11.name, " ");
  }
}
function TeamListComponent_Conditional_97_div_1_ng_container_49_span_4_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const teamMember_r9 = \u0275\u0275nextContext(2).$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", teamMember_r9.locations.length - 2, " more+ ");
  }
}
function TeamListComponent_Conditional_97_div_1_ng_container_49_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "div", 125);
    \u0275\u0275template(2, TeamListComponent_Conditional_97_div_1_ng_container_49_span_2_Template, 2, 1, "span", 126);
    \u0275\u0275pipe(3, "slice");
    \u0275\u0275template(4, TeamListComponent_Conditional_97_div_1_ng_container_49_span_4_Template, 2, 1, "span", 127);
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const teamMember_r9 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind3(3, 2, teamMember_r9.locations, 0, 2));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", teamMember_r9.locations.length > 2);
  }
}
function TeamListComponent_Conditional_97_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 72)(1, "div", 73)(2, "div", 11)(3, "div", 56)(4, "div", 74);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(5, "svg", 75);
    \u0275\u0275element(6, "path", 76);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(7, "div")(8, "span", 77);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 56)(11, "div", 78);
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function TeamListComponent_Conditional_97_div_1_Template_button_click_16_listener($event) {
      const teamMember_r9 = \u0275\u0275restoreView(_r8).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      ctx_r0.openAssign(teamMember_r9);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(17, "svg", 82);
    ...
    \u0275\u0275listener("click", function TeamListComponent_Conditional_97_div_1_Template_button_click_22_listener($event) {
      const teamMember_r9 = \u0275\u0275restoreView(_r8).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.onToggleMenuClick($event, teamMember_r9.id));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(23, "svg", 86);
    \u0275\u0275element(24, "path", 87);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(25, TeamListComponent_Conditional_97_div_1_div_25_Template, 16, 11, "div", 88);
    \u0275\u0275elementEnd()()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(26, "div", 89)(27, "h3", 90);
    \u0275\u0275text(28);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "p", 91);
    \u0275\u0275text(30);
    \u0275\u0275elementEnd();
    \u0275\u0275template(31, TeamListComponent_Conditional_97_div_1_div_31_Template, 5, 1, "div", 92);
    \u0275\u0275elementStart(32, "div", 93);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(33, "svg", 94);
    ...
    \u0275\u0275text(38);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(39, TeamListComponent_Conditional_97_div_1_div_39_Template, 3, 1, "div", 97);
    \u0275\u0275elementStart(40, "div", 98)(41, "div", 99);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(42, "svg", 94);
    \u0275\u0275element(43, "path", 100);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    ...
    \u0275\u0275pipe(46, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(47, "div", 101);
    \u0275\u0275template(48, TeamListComponent_Conditional_97_div_1_span_48_Template, 2, 0, "span", 102)(49, TeamListComponent_Conditional_97_div_1_ng_container_49_Template, 5, 6, "ng-container", 103);
    \u0275\u0275elementEnd()();
    \u0275\u0275element(50, "hr", 104);
    \u0275\u0275elementStart(51, "div", 105)(52, "div", 106)(53, "div", 107);
    \u0275\u0275text(54);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(55, "div", 108);
    \u0275\u0275text(56, "Assigned");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(57, "div", 106)(58, "div", 109);
    \u0275\u0275text(59);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(60, "div", 108);
    \u0275\u0275text(61, "Active");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(62, "div", 106)(63, "div", 110);
    \u0275\u0275text(64);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(65, "div", 108);
    \u0275\u0275text(66, "Completed");
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    ...
    let tmp_22_0;
    let tmp_23_0;
    const teamMember_r9 = ctx.$implicit;
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate1(" ", ctx_r0.getTeamMemberFullName(teamMember_r9), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", teamMember_r9.roles[0].name, " ");
    \u0275\u0275advance();
    \u0275\u0275classProp("bg-green-100", teamMember_r9.active)("text-green-800", teamMember_r9.active)("bg-red-100", !teamMember_r9.active)("text-red-800", !teamMember_r9.active);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", teamMember_r9.active ? "Active" : "Inactive", " ");
    \u0275\u0275advance(11);
    \u0275\u0275property("ngIf", teamMember_r9.showMenu);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r0.getTeamMemberFullName(teamMember_r9));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(teamMember_r9.email);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", teamMember_r9.role);
    \u0275\u0275advance(6);
    \u0275\u0275classProp("text-green-600", teamMember_r9.active)("text-red-600", !teamMember_r9.active);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", teamMember_r9.active ? "Active" : "Inactive", " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", teamMember_r9.hourly_rate !== void 0 && teamMember_r9.hourly_rate !== null);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1("Created ", \u0275\u0275pipeBind2(46, 27, teamMember_r9.created_at, "MMM d, y"), "");
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", teamMember_r9.has_full_location_access);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !teamMember_r9.has_full_location_access && (teamMember_r9.locations == null ? null : teamMember_r9.locations.length));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("", (tmp_21_0 = (tmp_21_0 = teamMember_r9.assigned_work_orders_total_count) !== null && tmp_21_0 !== void 0 ? tmp_21_0 : teamMember_r9.assigned_work_orders_count) !== null && tmp_21_0 !== void 0 ? tmp_21_0 : 0, " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("", (tmp_22_0 = teamMember_r9.assigned_work_orders_active_count) !== null && tmp_22_0 !== void 0 ? tmp_22_0 : 0, " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("", (tmp_23_0 = teamMember_r9.assigned_work_orders_completed_count) !== null && tmp_23_0 !== void 0 ? tmp_23_0 : 0, " ");
  }
}
function TeamListComponent_Conditional_97_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 50);
    \u0275\u0275template(1, TeamListComponent_Conditional_97_div_1_Template, 67, 30, "div", 71);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function TeamListComponent_app_pagination_100_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-pagination", 139);
    \u0275\u0275listener("pageChange", function TeamListComponent_app_pagination_100_Template_app_pagination_pageChange_0_listener($event) {
      \u0275\u0275restoreView(_r13);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onPageChange($event));
    })("perPageChange", function TeamListComponent_app_pagination_100_Template_app_pagination_perPageChange_0_listener($event) {
      \u0275\u0275restoreView(_r13);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onPerPageChange($event));
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("pagination", ctx_r0.pagination);
  }
}
function TeamListComponent_app_team_delete_confirmation_modal_101_Template(rf, ctx) {
  if (rf & 1) {
    const _r14 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-team-delete-confirmation-modal", 140);
    \u0275\u0275listener("confirmed", function TeamListComponent_app_team_delete_confirmation_modal_101_Template_app_team_delete_confirmation_modal_confirmed_0_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.confirmDeleteTeamMember($event));
    })("cancelled", function TeamListComponent_app_team_delete_confirmation_modal_101_Template_app_team_delete_confirmation_modal_cancelled_0_listener() {
      \u0275\u0275restoreView(_r14);
      const ctx_r0 = \u0275\u0275nextContext();
...
function TeamListComponent_app_team_form_modal_102_Template(rf, ctx) {
  if (rf & 1) {
    const _r15 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-team-form-modal", 141);
    \u0275\u0275listener("teamMemberSaved", function TeamListComponent_app_team_form_modal_102_Template_app_team_form_modal_teamMemberSaved_0_listener($event) {
      \u0275\u0275restoreView(_r15);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onTeamMemberSaved($event));
    })("cancelled", function TeamListComponent_app_team_form_modal_102_Template_app_team_form_modal_cancelled_0_listener() {
      \u0275\u0275restoreView(_r15);
      const ctx_r0 = \u0275\u0275nextContext();
...
function TeamListComponent_app_assign_work_order_modal_103_Template(rf, ctx) {
  if (rf & 1) {
    const _r16 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-assign-work-order-modal", 142);
    \u0275\u0275listener("closed", function TeamListComponent_app_assign_work_order_modal_103_Template_app_assign_work_order_modal_closed_0_listener() {
      \u0275\u0275restoreView(_r16);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.closeAssign());
    })("submitted", function TeamListComponent_app_assign_work_order_modal_103_Template_app_assign_work_order_modal_submitted_0_listener($event) {
      \u0275\u0275restoreView(_r16);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onAssignmentSubmitted($event));
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("teamMemberName", ctx_r0.teamMemberToAssign ? ctx_r0.getTeamMemberFullName(ctx_r0.teamMemberToAssign) : "")("teamMemberId", ctx_r0.teamMemberToAssign ? ctx_r0.teamMemberToAssign.id : 0);
  }
}
var TeamListComponent = class _TeamListComponent {
  ...
  constructor(teamService, toastService, cdr, authService) {
    this.teamService = teamService;
    this.toastService = toastService;
    this.cdr = cdr;
  ...
  loadTeamMembers(page = 1, perPage = 10) {
    this.loading = true;
    this.error = "";
    let activeParam;
  ...
  loadStatistics() {
    ...
    this.teamService.getTeamAnalytics({ date_range: 30 }).subscribe({
      ...
      error: (e) => {
        this.toastService.error("Failed to load team analytics");
      }
    });
  }
  refreshStats() {
  ...
  filterTeamMembers() {
    ...
    if (!this.searchTerm.trim()) {
      ...
      this.filteredTeamMembers = membersExcludingCurrentUser.filter((teamMember) => `${teamMember.first_name} ${teamMember.last_name}`.toLowerCase().includes(this.searchTerm.toLowerCase()) || teamMember.email.toLowerCase().includes(this.searchTerm.toLowerCase()) || teamMember.role?.name && teamMember.role.name.toLowerCase().includes(this.searchTerm.toLowerCase()));
    }
  ...
  toggleTeamMemberStatus(teamMember) {
    const memberName = `${teamMember.first_name} ${teamMember.last_name}`;
    ...
    this.teamService.toggleTeamMemberStatus(teamMember.id).subscribe({
      next: (response) => {
        const updatedTeamMember = __spreadProps(__spreadValues({}, teamMember), { active: !teamMember.active });
  ...
  onEditClick(event, teamMember) {
    event.preventDefault();
    event.stopPropagation();
    this.closeAllDropdowns();
    this.editTeamMember(teamMember);
  }
  onToggleStatusClick(event, teamMember) {
    event.preventDefault();
    event.stopPropagation();
    this.closeAllDropdowns();
    this.toggleTeamMemberStatus(teamMember);
  }
  onDeleteClick(event, teamMember) {
    event.preventDefault();
    event.stopPropagation();
    this.closeAllDropdowns();
    this.deleteTeamMember(teamMember);
  }
  onToggleMenuClick(event, teamMemberId) {
    event.preventDefault();
    event.stopPropagation();
  ...
  static \u0275fac = function TeamListComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _TeamListComponent)(\u0275\u0275directiveInject(TeamService), \u0275\u0275directiveInject(ToastService), \u0275\u0275directiveInject(ChangeDetectorRef), \u0275\u0275directiveInject(AuthService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TeamListComponent, selectors: [["app-team-list"]], hostBindings: function TeamListComponent_HostBindings(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(12, TeamListComponent_Conditional_12_Template, 6, 1, "div", 8);
      \u0275\u0275namespaceHTML();
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(100, TeamListComponent_app_pagination_100_Template, 1, 1, "app-pagination", 52)(101, TeamListComponent_app_team_delete_confirmation_modal_101_Template, 1, 1, "app-team-delete-confirmation-modal", 53)(102, TeamListComponent_app_team_form_modal_102_Template, 1, 2, "app-team-form-modal", 54)(103, TeamListComponent_app_assign_work_order_modal_103_Template, 1, 2, "app-assign-work-order-modal", 55);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      let tmp_2_0;
      ...
      \u0275\u0275advance();
      \u0275\u0275property("title", ctx.selectedSortDir === "asc" ? "Currently: Ascending (A-Z, 1-9). Click to sort Descending (Z-A, 9-1)" : "Currently: Descending (Z-A, 9-1). Click to sort Ascending (A-Z, 1-9)");
      \u0275\u0275advance(2);
      ...
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.pagination && (ctx.teamMembers.length > 0 || ctx.pagination.total > 0));
      \u0275\u0275advance();
...
\r
      ...
      <button\r
        ...
        [title]="selectedSortDir === 'asc' ? 'Currently: Ascending (A-Z, 1-9). Click to sort Descending (Z-A, 9-1)' : 'Currently: Descending (Z-A, 9-1). Click to sort Ascending (A-Z, 1-9)'"\r
        class="px-3 py-2 border border-gray-300 rounded-lg bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors group relative">\r
        <svg class="w-4 h-4 text-gray-600 group-hover:text-blue-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">\r
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"\r
...
\r
  <div class="grid grid-cols-1 gap-6 mb-5">\r
    @if (!loading) {\r
      <!--Team Card grid-->\r
...
\r
                  <div class="flex items-center">\r
                    <div\r
                      class="px-3  py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800 inline">{{ teamMember.roles[0].name }}\r
                    </div>\r
\r
                    <!-- Status Badge -->\r
                    <div class="ml-2 px-2 py-1 rounded-full text-xs font-medium"\r
                         [class.bg-green-100]="teamMember.active"\r
                         [class.text-green-800]="teamMember.active"\r
                         [class.bg-red-100]="!teamMember.active"\r
                         [class.text-red-800]="!teamMember.active">\r
                      {{ teamMember.active ? 'Active' : 'Inactive' }}\r
                    </div>\r
                  </div>\r
                </div>\r
              </div>\r
\r
              ...
              <div class="relative flex items-center gap-2">\r
                ...
                <button\r
                  ...
                  title="Assign"\r
                  (click)="openAssign(teamMember); $event.stopPropagation()"\r
                >\r
...
\r
                <button\r
                  type="button"\r
                  (click)="onToggleMenuClick($event, teamMember.id)"\r
...
\r
                ...
                <div *ngIf="teamMember.showMenu"\r
                     ...
                     class="absolute right-0 top-full mt-1 w-40 bg-white rounded-lg shadow-lg border border-gray-200 z-50">\r
                  <div class="py-1">\r
                    <!-- Edit Option -->\r
                    <button\r
                      type="button"\r
                      (click)="onEditClick($event, teamMember)"\r
...
\r
                    ...
                    <button type="button"\r
                            (click)="onToggleStatusClick($event, teamMember)"\r
                            class="flex items-center w-full px-3 py-2.5 text-sm transition-colors"\r
                            [class.text-red-500]="teamMember.active"\r
                            [class.text-green-600]="!teamMember.active"\r
                            [class.hover:bg-red-50]="teamMember.active"\r
                            [class.hover:bg-green-50]="!teamMember.active">\r
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"\r
                           stroke="currentColor"\r
                           [class]="teamMember.active ? 'size-4 text-red-500 mr-2.5' : 'size-4 text-green-500 mr-2.5'">\r
                        <path stroke-linecap="round" stroke-linejoin="round"\r
                              d="M14.25 9v6m-4.5 0V9M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>\r
                      </svg>\r
\r
                      {{ teamMember.active ? 'Inactive' : 'Active' }}\r
                    </button>\r
\r
                    <!-- Remove Option -->\r
                    <button\r
                      type="button"\r
                      (click)="onDeleteClick($event, teamMember)"\r
...
\r
            ...
            <div class="flex items-center text-sm mb-3">\r
              <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">\r
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"\r
                      d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>\r
              </svg>\r
              <span class="text-gray-500">Status: </span>\r
              <span class="ml-1 font-medium"\r
                    [class.text-green-600]="teamMember.active"\r
                    [class.text-red-600]="!teamMember.active">\r
                  {{ teamMember.active ? 'Active' : 'Inactive' }}\r
                </span>\r
            </div>\r
\r
          ...
          <span *ngIf="teamMember.has_full_location_access"\r
                ...
                <ng-container *ngIf="!teamMember.has_full_location_access && teamMember.locations?.length">\r
                  <div class="flex flex-wrap gap-1">\r
                    <!-- Show first 2 locations -->\r
                    <span *ngFor="let loc of teamMember.locations | slice:0:2"\r
                          class="inline-flex items-center px-2 py-0.5 rounded bg-gray-100 text-gray-700 border border-gray-200">\r
                      {{ loc.name }}\r
                    </span>\r
                    <!-- Show "more" indicator if there are more than 2 locations -->\r
                    <span *ngIf="teamMember.locations.length > 2"\r
                          class="inline-flex items-center px-2 py-0.5 rounded bg-blue-100 text-blue-700 border border-blue-200">\r
                      {{ teamMember.locations.length - 2 }} more+\r
                    </span>\r
                  </div>\r
                </ng-container>\r
              </div>\r
...
\r
            <div class="grid grid-cols-3">\r
              <div class="text-center">\r
                <div\r
                  class="text-lg font-semibold text-blue-600">{{ teamMember.assigned_work_orders_total_count ?? teamMember.assigned_work_orders_count ?? 0 }}\r
                </div>\r
                <div class="text-xs text-gray-500">Assigned</div>\r
              </div>\r
              <div class="text-center">\r
                <div\r
                  class="text-lg font-semibold text-yellow-600">{{ teamMember.assigned_work_orders_active_count ?? 0 }}\r
                </div>\r
                <div class="text-xs text-gray-500">Active</div>\r
              </div>\r
              <div class="text-center">\r
                <div\r
                  class="text-lg font-semibold text-green-600">{{ teamMember.assigned_work_orders_completed_count ?? 0 }}\r
                </div>\r
...
\r
  <!-- Pagination -->\r
  <app-pagination\r
    *ngIf="pagination && (teamMembers.length > 0 || pagination.total > 0)"\r
...
`, styles: ["/* src/app/teams/team-list/team-list.component.scss */\n.team-list-page .team-card {\n  border-radius: 1rem;\n  box-shadow: 0 2px 8px 0 rgba(16, 30, 54, 0.08);\n  overflow: hidden;\n  background: #fff;\n  border: 1px solid #bfdbfe;\n  display: flex;\n  flex-direction: column;\n  transition: box-shadow 0.2s;\n}\n.team-list-page .team-card hr {\n  margin-top: 0.75rem;\n  margin-bottom: 0.75rem;\n  border-color: #e5e7eb;\n}\n.team-list-page .team-card-header {\n  background: #e0edff;\n  height: 8rem;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  position: relative;\n  border-top-left-radius: 1rem;\n  border-top-right-radius: 1rem;\n  overflow: hidden;\n}\n.team-list-page .dropdown-enter {\n  opacity: 0;\n  transform: translateY(-10px);\n}\n.team-list-page .dropdown-enter-active {\n  opacity: 1;\n  transform: translateY(0);\n  transition: opacity 0.2s, transform 0.2s;\n}\n.team-list-page .dropdown-exit {\n  opacity: 1;\n  transform: translateY(0);\n}\n.team-list-page .dropdown-exit-active {\n  opacity: 0;\n  transform: translateY(-10px);\n  transition: opacity 0.2s, transform 0.2s;\n}\n.team-list-page .team-card:hover {\n  box-shadow: 0 4px 12px 0 rgba(16, 30, 54, 0.12);\n}\n.team-list-page .stat-card {\n  transition: transform 0.2s ease-in-out;\n}\n.team-list-page .stat-card:hover {\n  transform: translateY(-2px);\n}\n.team-list-page .search-input:focus {\n  border-color: #3b82f6;\n  box-shadow: 0 0 0 3px rgba(59, 130, 246, 0.1);\n}\n.team-list-page .btn-primary {\n  transition: all 0.2s ease-in-out;\n}\n.team-list-page .btn-primary:hover {\n  transform: translateY(-1px);\n  box-shadow: 0 4px 12px rgba(59, 130, 246, 0.3);\n}\n.team-list-page .table-row:hover {\n  background-color: #f9fafb;\n}\n.team-list-page .loading-spinner {\n  animation: spin 1s linear infinite;\n}\n@keyframes spin {\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n}\n@media (max-width: 768px) {\n  .team-list-page .grid {\n    grid-template-columns: 1fr;\n  }\n  .team-list-page .statistics-grid {\n    grid-template-columns: repeat(2, 1fr);\n  }\n}\n@media (max-width: 640px) {\n  .team-list-page .statistics-grid {\n    grid-template-columns: 1fr;\n  }\n}\n/*# sourceMappingURL=team-list.component.css.map */\n"] }]
  }], () => [{ type: TeamService }, { type: ToastService }, { type: ChangeDetectorRef }, { type: AuthService }], { onDocumentClick: [{
    type: HostListener,
    args: ["document:click", ["$event"]]
  }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TeamListComponent, { className: "TeamListComponent", filePath: "src/app/teams/team-list/team-list.component.ts", lineNumber: 19 });
})();
...
//# sourceMappingURL=chunk-JTGHOOB7.js.map
