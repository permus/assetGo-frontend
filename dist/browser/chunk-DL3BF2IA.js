...
function CreatePurchaseOrderModalComponent_div_77_option_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 55);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function CreatePurchaseOrderModalComponent_div_77_div_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 56);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.getArrayFieldError("items", i_r4, "part_id"), " ");
  }
}
function CreatePurchaseOrderModalComponent_div_77_div_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 56);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function CreatePurchaseOrderModalComponent_div_77_div_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 56);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function CreatePurchaseOrderModalComponent_div_77_div_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 56);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function CreatePurchaseOrderModalComponent_div_77_div_37_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 56);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function CreatePurchaseOrderModalComponent_div_77_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(10, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "select", 62)(12, "option", 19);
    \u0275\u0275text(13, "Select a part");
    \u0275\u0275elementEnd();
    \u0275\u0275template(14, CreatePurchaseOrderModalComponent_div_77_option_14_Template, 2, 3, "option", 20);
    \u0275\u0275elementEnd();
    \u0275\u0275template(15, CreatePurchaseOrderModalComponent_div_77_div_15_Template, 2, 1, "div", 24);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "div", 15)(17, "label", 61);
    \u0275\u0275text(18, "Part Number *");
    \u0275\u0275elementEnd();
    \u0275\u0275element(19, "input", 63);
    \u0275\u0275template(20, CreatePurchaseOrderModalComponent_div_77_div_20_Template, 2, 1, "div", 24);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "div", 14)(22, "div", 35)(23, "label", 61);
    \u0275\u0275text(24, "Description *");
    \u0275\u0275elementEnd();
    \u0275\u0275element(25, "input", 64);
    \u0275\u0275template(26, CreatePurchaseOrderModalComponent_div_77_div_26_Template, 2, 1, "div", 24);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(27, "div", 14)(28, "div", 15)(29, "label", 61);
    \u0275\u0275text(30, "Quantity *");
    \u0275\u0275elementEnd();
    \u0275\u0275element(31, "input", 65);
    \u0275\u0275template(32, CreatePurchaseOrderModalComponent_div_77_div_32_Template, 2, 1, "div", 24);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "div", 15)(34, "label", 61);
    \u0275\u0275text(35, "Unit Cost *");
    \u0275\u0275elementEnd();
    \u0275\u0275element(36, "input", 66);
    \u0275\u0275template(37, CreatePurchaseOrderModalComponent_div_77_div_37_Template, 2, 1, "div", 24);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "div", 15)(39, "label", 67);
    \u0275\u0275text(40, "Line Total");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "div", 68);
    \u0275\u0275text(42);
    \u0275\u0275pipe(43, "currency");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.getArrayFieldError("items", i_r4, "part_id"));
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(43, 20, ctx_r1.calculateItemTotal(i_r4)));
  }
}
...
var CreatePurchaseOrderModalComponent = class _CreatePurchaseOrderModalComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CreatePurchaseOrderModalComponent, selectors: [["app-create-purchase-order-modal"]], outputs: { closeModal: "closeModal", createPurchaseOrder: "createPurchaseOrder" }, decls: 115, vars: 19, consts: [[1, "modal-overlay", 3, "click"], [1, "modal-container", 3, "click"], [1, "modal-header"], [1, "modal-title"], [1, "close-btn", 3, "click"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-5", "h-5"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M6 18L18 6M6 6l12 12"], [1, "modal-body"], [3, "ngSubmit", "formGroup"], [1, "form-section"], [1, "section-header"], [1, "section-icon", "supplier"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"], [1, "section-title"], [1, "form-row"], [1, "form-field"], ["for", "supplier", 1, "field-label"], [1, "supplier-selection"], ["id", "supplier", "formControlName", "supplier_id", 1, "form-select"], ["value", ""], [3, "value", 4, "ngFor", "ngForOf"], ["type", "button", 1, "btn", "btn-sm", "btn-outline", 3, "click"], ["for", "vendorName", 1, "field-label"], ["type", "text", "id", "vendorName", "formControlName", "vendor_name", "placeholder", "Enter vendor name", 1, "form-input"], ["class", "error-message", 4, "ngIf"], ["for", "vendorContact", 1, "field-label"], ["type", "text", "id", "vendorContact", "formControlName", "vendor_contact", "placeholder", "Enter vendor contact information", 1, "form-input"], [1, "section-icon", "order"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"], ["for", "orderDate", 1, "field-label"], ["type", "date", "id", "orderDate", "formControlName", "order_date", 1, "form-input"], ["for", "expectedDelivery", 1, "field-label"], ["type", "date", "id", "expectedDelivery", "formControlName", "expected_date", 1, "form-input"], ["for", "taxRate", 1, "field-label"], ["type", "number", "id", "taxRate", "formControlName", "tax_rate", "min", "0", "max", "100", "step", "0.01", "placeholder", "0.00", 1, "form-input"], [1, "form-field", "full-width"], ["for", "terms", 1, "field-label"], ["id", "terms", "formControlName", "terms", "rows", "2", "placeholder", "Enter payment terms and conditions...", 1, "form-textarea"], [1, "section-icon", "items"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"], ["formArrayName", "items", 1, "items-container"], ["class", "item-row", 3, "formGroupName", 4, "ngFor", "ngForOf"], [1, "total-section"], [1, "total-row"], [1, "total-label"], [1, "total-value"], [1, "total-row", "total-final"], [1, "section-icon", "notes"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"], ["for", "notes", 1, "field-label"], ["id", "notes", "formControlName", "notes", "rows", "3", "placeholder", "Add any additional notes or special instructions...", 1, "form-textarea"], [1, "modal-footer"], ["type", "button", 1, "btn", "btn-secondary", 3, "click"], ["type", "submit", 1, "btn", "btn-primary", 3, "click", "disabled"], [3, "closeModal", "supplierCreated", 4, "ngIf"], [3, "value"], [1, "error-message"], [1, "item-row", 3, "formGroupName"], [1, "item-header"], [1, "item-title"], ["type", "button", "class", "btn btn-sm btn-danger", 3, "click", 4, "ngIf"], [1, "field-label", 3, "for"], ["formControlName", "part_id", 1, "form-select", 3, "id"], ["type", "text", "formControlName", "part_number", "placeholder", "Enter part number", 1, "form-input", 3, "id"], ["type", "text", "formControlName", "description", "placeholder", "Enter item description", 1, "form-input", 3, "id"], ["type", "number", "formControlName", "qty", "min", "1", 1, "form-input", 3, "id"], ["type", "number", "formControlName", "unit_cost", "min", "0.01", "step", "0.01", 1, "form-input", 3, "id"], [1, "field-label"], [1, "line-total"], ["type", "button", 1, "btn", "btn-sm", "btn-danger", 3, "click"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-4", "h-4"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"], [3, "closeModal", "supplierCreated"]], template: function CreatePurchaseOrderModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275template(77, CreatePurchaseOrderModalComponent_div_77_Template, 44, 22, "div", 41);
      \u0275\u0275elementEnd();
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(6);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(84, 13, ctx.calculateSubtotal()));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate1("Tax (", ((tmp_8_0 = ctx.poForm.get("tax_rate")) == null ? null : tmp_8_0.value) || 0, "%):");
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(90, 15, ctx.calculateTax()));
      \u0275\u0275advance(6);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(96, 17, ctx.calculateTotal()));
      \u0275\u0275advance(17);
...
function PurchaseOrdersComponent_Conditional_60_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 33);
    \u0275\u0275listener("click", function PurchaseOrdersComponent_Conditional_60_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function PurchaseOrdersComponent_Conditional_60_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
...
function PurchaseOrdersComponent_div_75_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function PurchaseOrdersComponent_div_75_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
...
function PurchaseOrdersComponent_div_76_div_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function PurchaseOrdersComponent_div_76_div_7_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function PurchaseOrdersComponent_div_76_div_8_tr_21_button_37_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 98);
    \u0275\u0275listener("click", function PurchaseOrdersComponent_div_76_div_8_tr_21_button_37_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r7);
      const po_r6 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.approvePurchaseOrder(po_r6));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 34);
    \u0275\u0275element(2, "path", 11);
...
function PurchaseOrdersComponent_div_76_div_8_tr_21_button_38_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 98);
    \u0275\u0275listener("click", function PurchaseOrdersComponent_div_76_div_8_tr_21_button_38_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r8);
      const po_r6 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.markAsOrdered(po_r6));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 34);
...
function PurchaseOrdersComponent_div_76_div_8_tr_21_button_39_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 98);
    \u0275\u0275listener("click", function PurchaseOrdersComponent_div_76_div_8_tr_21_button_39_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const po_r6 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.openReceiveItemsModal(po_r6));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 34);
    \u0275\u0275element(2, "path", 9);
...
function PurchaseOrdersComponent_div_76_div_8_tr_21_button_40_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 98);
    \u0275\u0275listener("click", function PurchaseOrdersComponent_div_76_div_8_tr_21_button_40_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r10);
      const po_r6 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.sendEmail(po_r6));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 34);
...
function PurchaseOrdersComponent_div_76_div_8_tr_21_button_41_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 98);
    \u0275\u0275listener("click", function PurchaseOrdersComponent_div_76_div_8_tr_21_button_41_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r11);
      const po_r6 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.closePurchaseOrder(po_r6));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 34);
    \u0275\u0275element(2, "path", 45);
...
function PurchaseOrdersComponent_div_76_div_8_tr_21_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr", 76)(1, "td", 77)(2, "div", 78);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "td", 79)(5, "div", 80)(6, "div", 81);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "td", 84);
    \u0275\u0275text(13);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "td", 85)(15, "span", 86);
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "td", 87)(18, "div", 88)(19, "div", 89);
    \u0275\u0275text(20);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "div", 90);
    \u0275\u0275text(22);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(23, "td", 91)(24, "div", 92);
    \u0275\u0275text(25);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(26, "td", 93)(27, "div", 94)(28, "button", 95);
    \u0275\u0275listener("click", function PurchaseOrdersComponent_div_76_div_8_tr_21_Template_button_click_28_listener($event) {
      const po_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(po_r6.id && ctx_r1.toggleDropdown($event, po_r6.id));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(29, "svg", 34);
    \u0275\u0275element(30, "path", 96);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(31, "div", 97)(32, "button", 98);
    \u0275\u0275listener("click", function PurchaseOrdersComponent_div_76_div_8_tr_21_Template_button_click_32_listener() {
      const po_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.viewPurchaseOrder(po_r6));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(33, "svg", 34);
    \u0275\u0275element(34, "path", 99)(35, "path", 100);
    \u0275\u0275elementEnd();
    \u0275\u0275text(36, " View Details ");
    \u0275\u0275elementEnd();
    \u0275\u0275template(37, PurchaseOrdersComponent_div_76_div_8_tr_21_button_37_Template, 4, 0, "button", 101)(38, PurchaseOrdersComponent_div_76_div_8_tr_21_button_38_Template, 4, 0, "button", 101)(39, PurchaseOrdersComponent_div_76_div_8_tr_21_button_39_Template, 4, 0, "button", 101)(40, PurchaseOrdersComponent_div_76_div_8_tr_21_button_40_Template, 4, 0, "button", 101)(41, PurchaseOrdersComponent_div_76_div_8_tr_21_button_41_Template, 4, 0, "button", 101);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const po_r6 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(po_r6.po_number);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate((po_r6.supplier == null ? null : po_r6.supplier.name) || "Unknown Supplier");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("ID: ", po_r6.supplier_id, "");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.formatDate(po_r6.order_date), " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.formatDate(po_r6.expected_date), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", ctx_r1.getStatusClass(po_r6.status));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.getStatusLabel(po_r6.status), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("", (po_r6.items == null ? null : po_r6.items.length) || 0, " items");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.calculateItemsTotal(po_r6.items), " total qty ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r1.formatCurrency(po_r6.total));
    \u0275\u0275advance(6);
    \u0275\u0275classProp("show", po_r6.id && ctx_r1.openDropdownId === po_r6.id);
    \u0275\u0275advance(6);
    \u0275\u0275property("ngIf", po_r6.status === "draft" || po_r6.status === "pending");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", po_r6.status === "approved");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", po_r6.status === "ordered");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", po_r6.status === "received" || po_r6.status === "closed");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", po_r6.status === "received" || po_r6.status === "ordered");
  }
}
function PurchaseOrdersComponent_div_76_div_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 65)(1, "table", 53)(2, "thead")(3, "tr", 66)(4, "th", 67);
    \u0275\u0275text(5, "PO Number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "th", 68);
    \u0275\u0275text(7, "Supplier");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(13, "Status");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "th", 72);
    \u0275\u0275text(15, "Items");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "th", 73);
    \u0275\u0275text(17, "Total");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(21, PurchaseOrdersComponent_div_76_div_8_tr_21_Template, 42, 17, "tr", 75);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function PurchaseOrdersComponent_div_76_div_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function PurchaseOrdersComponent_div_76_div_9_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function PurchaseOrdersComponent_div_76_div_9_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.onPageChange(ctx_r1.currentPage + 1));
    });
...
function PurchaseOrdersComponent_div_76_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(7, PurchaseOrdersComponent_div_76_div_7_Template, 11, 0, "div", 58)(8, PurchaseOrdersComponent_div_76_div_8_Template, 22, 1, "div", 59)(9, PurchaseOrdersComponent_div_76_div_9_Template, 8, 5, "div", 60);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function PurchaseOrdersComponent_app_create_purchase_order_modal_77_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-create-purchase-order-modal", 108);
    \u0275\u0275listener("closeModal", function PurchaseOrdersComponent_app_create_purchase_order_modal_77_Template_app_create_purchase_order_modal_closeModal_0_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeCreatePOModal());
    })("createPurchaseOrder", function PurchaseOrdersComponent_app_create_purchase_order_modal_77_Template_app_create_purchase_order_modal_createPurchaseOrder_0_listener($event) {
      \u0275\u0275restoreView(_r13);
      const ctx_r1 = \u0275\u0275nextContext();
...
function PurchaseOrdersComponent_app_view_purchase_order_modal_78_Template(rf, ctx) {
  if (rf & 1) {
    const _r14 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-view-purchase-order-modal", 109);
    \u0275\u0275listener("closeModal", function PurchaseOrdersComponent_app_view_purchase_order_modal_78_Template_app_view_purchase_order_modal_closeModal_0_listener() {
      \u0275\u0275restoreView(_r14);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeViewPOModal());
    })("purchaseOrderUpdated", function PurchaseOrdersComponent_app_view_purchase_order_modal_78_Template_app_view_purchase_order_modal_purchaseOrderUpdated_0_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r1 = \u0275\u0275nextContext();
...
function PurchaseOrdersComponent_app_receive_items_modal_79_Template(rf, ctx) {
  if (rf & 1) {
    const _r15 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-receive-items-modal", 110);
    \u0275\u0275listener("closeModal", function PurchaseOrdersComponent_app_receive_items_modal_79_Template_app_receive_items_modal_closeModal_0_listener() {
      \u0275\u0275restoreView(_r15);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeReceiveItemsModal());
    })("itemsReceived", function PurchaseOrdersComponent_app_receive_items_modal_79_Template_app_receive_items_modal_itemsReceived_0_listener() {
      \u0275\u0275restoreView(_r15);
      const ctx_r1 = \u0275\u0275nextContext();
...
var PurchaseOrdersComponent = class _PurchaseOrdersComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PurchaseOrdersComponent, selectors: [["app-purchase-orders"]], decls: 80, vars: 13, consts: [[1, "purchase-orders"], [1, "overview-cards-row"], [1, "overview-card", "total-pos"], [1, "card-content"], [1, "card-value"], [1, "card-label"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "card-icon"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"], [1, "overview-card", "pending"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"], [1, "overview-card", "approved"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M5 13l4 4L19 7"], [1, "overview-card", "total-value"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1"], [1, "control-bar"], [1, "search-controls"], [1, "search-container"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "search-icon"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"], ["type", "text", "placeholder", "Search purchase orders...", 1, "search-input", 3, "ngModelChange", "ngModel"], [1, "status-dropdown"], [1, "status-select", 3, "ngModelChange", "ngModel"], ["value", ""], ["value", "draft"], ["value", "pending"], ["value", "approved"], ["value", "ordered"], ["value", "rejected"], ["value", "closed"], ["value", "cancelled"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "dropdown-arrow"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M19 9l-7 7-7-7"], [1, "action-buttons"], [1, "btn", "btn-secondary", 3, "click"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-4", "h-4"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"], [1, "btn", "btn-secondary", "!hidden"], [1, "btn", "btn-primary", 3, "click"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M12 4v16m8-8H4"], ["class", "loading-state", 4, "ngIf"], ["class", "error-state", 4, "ngIf"], ["class", "purchase-orders-table", 4, "ngIf"], [3, "closeModal", "createPurchaseOrder", 4, "ngIf"], [3, "purchaseOrder", "closeModal", "purchaseOrderUpdated", 4, "ngIf"], [3, "purchaseOrder", "closeModal", "itemsReceived", 4, "ngIf"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M6 18L18 6M6 6l12 12"], [1, "loading-state"], [1, "loading-spinner"], [1, "error-state"], [1, "error-icon"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-8", "h-8"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"], [1, "error-message"], [1, "purchase-orders-table"], [1, "table-header"], [1, "table-title"], [1, "table-actions"], [1, "text-sm", "text-gray-500"], ["class", "empty-state", 4, "ngIf"], ["class", "table-wrapper", 4, "ngIf"], ["class", "pagination", 4, "ngIf"], [1, "empty-state"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "empty-icon"], [1, "empty-title"], [1, "empty-description"], [1, "table-wrapper"], [1, "uppercase"], [1, "th-po-number"], [1, "th-supplier"], [1, "th-order-date"], [1, "th-expected-date"], [1, "th-status"], [1, "th-items"], [1, "th-total"], [1, "th-actions"], ["class", "table-row", 4, "ngFor", "ngForOf"], [1, "table-row"], [1, "td-po-number"], [1, "po-number"], [1, "td-supplier"], [1, "supplier-info"], [1, "supplier-name"], [1, "supplier-id"], [1, "td-order-date"], [1, "td-expected-date"], [1, "td-status"], [1, "status-badge", 3, "ngClass"], [1, "td-items"], [1, "items-info"], [1, "items-count"], [1, "items-summary"], [1, "td-total"], [1, "total-amount"], [1, "td-actions"], [1, "dropdown-container"], [1, "dropdown-trigger", 3, "click"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z"], [1, "dropdown-menu"], [1, "dropdown-item", 3, "click"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M15 12a3 3 0 11-6 0 3 3 0 016 0z"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"], ["class", "dropdown-item", 3, "click", 4, "ngIf"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M16 12H8m8 0H8m8 0H8m12 0a9 9 0 11-18 0 9 9 0 0118 0z"], [1, "pagination"], [1, "pagination-info"], [1, "pagination-buttons"], [1, "btn", "btn-outline", 3, "click", "disabled"], [3, "closeModal", "createPurchaseOrder"], [3, "closeModal", "purchaseOrderUpdated", "purchaseOrder"], [3, "closeModal", "itemsReceived", "purchaseOrder"]], template: function PurchaseOrdersComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275template(60, PurchaseOrdersComponent_Conditional_60_Template, 8, 0);
      \u0275\u0275elementEnd();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(61, "div", 32)(62, "button", 33);
      \u0275\u0275listener("click", function PurchaseOrdersComponent_Template_button_click_62_listener() {
        return ctx.refreshData();
      });
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(63, "svg", 34);
      \u0275\u0275element(64, "path", 35);
      \u0275\u0275elementEnd();
      \u0275\u0275text(65, " Refresh ");
      \u0275\u0275elementEnd();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(66, "button", 36);
      \u0275\u0275namespaceSVG();
      ...
      \u0275\u0275listener("click", function PurchaseOrdersComponent_Template_button_click_70_listener() {
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(74, PurchaseOrdersComponent_div_74_Template, 4, 0, "div", 39)(75, PurchaseOrdersComponent_div_75_Template, 8, 1, "div", 40)(76, PurchaseOrdersComponent_div_76_Template, 10, 6, "div", 41)(77, PurchaseOrdersComponent_app_create_purchase_order_modal_77_Template, 1, 0, "app-create-purchase-order-modal", 42)(78, PurchaseOrdersComponent_app_view_purchase_order_modal_78_Template, 1, 1, "app-view-purchase-order-modal", 43)(79, PurchaseOrdersComponent_app_receive_items_modal_79_Template, 1, 1, "app-receive-items-modal", 44);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(5);
      ...
      \u0275\u0275advance(19);
      \u0275\u0275conditional(ctx.filters.search || ctx.filters.status ? 60 : -1);
      \u0275\u0275advance(14);
      \u0275\u0275property("ngIf", ctx.loading);
      \u0275\u0275advance();
...
\r
      @if (filters.search || filters.status) {\r
...
\r
                <button class="dropdown-item" (click)="sendEmail(po)"\r
                        *ngIf="po.status === 'received' || po.status === 'closed'">\r
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">\r
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"\r
                          d="M16 12H8m8 0H8m8 0H8m12 0a9 9 0 11-18 0 9 9 0 0118 0z"></path>\r
                  </svg>\r
                  Send Email\r
                </button>\r
\r
...
//# sourceMappingURL=chunk-DL3BF2IA.js.map
