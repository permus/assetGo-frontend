...
function AbcAnalysisComponent_div_3_tr_126_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "td", 64)(12, "span", 65);
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("AED ", item_r4.value.toLocaleString(), "");
    \u0275\u0275advance(2);
...
function AbcAnalysisComponent_div_3_div_127_Template(rf, ctx) {
  if (rf & 1) {
...
function AbcAnalysisComponent_div_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(40, "div", 33);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(41, "div", 34)(42, "div", 25)(43, "div", 35);
    \u0275\u0275text(44, "B");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(45, "h3", 27);
    \u0275\u0275text(46, "Class B Items");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(47, "div", 28)(48, "div", 29)(49, "span", 30);
    \u0275\u0275text(50, "Count:");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(57);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(58, "div", 29)(59, "span", 30);
    \u0275\u0275text(60, "Value %:");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275element(64, "div", 36);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(65, "div", 37)(66, "div", 25)(67, "div", 38);
    \u0275\u0275text(68, "C");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(69, "h3", 27);
    \u0275\u0275text(70, "Class C Items");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(71, "div", 28)(72, "div", 29)(73, "span", 30);
    \u0275\u0275text(74, "Count:");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(84, "Value %:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(85, "span", 31);
    \u0275\u0275text(86);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(87, "div", 32);
    \u0275\u0275element(88, "div", 39);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(89, "div", 40)(90, "h3", 41);
    \u0275\u0275text(91, "Detailed Analysis");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(92, "div", 42)(93, "div", 43);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(94, "svg", 44);
    \u0275\u0275element(95, "path", 45);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(96, "input", 46);
    \u0275\u0275listener("input", function AbcAnalysisComponent_div_3_Template_input_input_96_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("change", function AbcAnalysisComponent_div_3_Template_select_change_98_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onClassFilterChange($event));
    });
    \u0275\u0275elementStart(99, "option", 49);
    \u0275\u0275text(100, "All Classes");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(104, "Class B");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(105, "option", 52);
    \u0275\u0275text(106, "Class C");
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(107, "svg", 53);
    \u0275\u0275element(108, "path", 54);
    \u0275\u0275elementEnd()()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(109, "div", 55)(110, "table", 56)(111, "thead")(112, "tr")(113, "th");
    \u0275\u0275text(114, "Part Number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(115, "th");
    \u0275\u0275text(116, "Part Name");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(117, "th");
    \u0275\u0275text(118, "Total Value");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(119, "th");
    \u0275\u0275text(120, "Value %");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(121, "th");
    \u0275\u0275text(122, "Cumulative %");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(123, "th");
    \u0275\u0275text(124, "ABC Class");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(125, "tbody");
    \u0275\u0275template(126, AbcAnalysisComponent_div_3_tr_126_Template, 14, 8, "tr", 57);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(127, AbcAnalysisComponent_div_3_div_127_Template, 7, 0, "div", 58);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("AED ", ctx_r1.abcData.classA.value.toLocaleString(), "");
    \u0275\u0275advance(5);
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("AED ", ctx_r1.abcData.classB.value.toLocaleString(), "");
    \u0275\u0275advance(5);
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("AED ", ctx_r1.abcData.classC.value.toLocaleString(), "");
    \u0275\u0275advance(5);
...
//# sourceMappingURL=chunk-5XDQ2FWK.js.map
