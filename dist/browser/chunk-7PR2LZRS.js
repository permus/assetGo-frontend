...
var routes = [
  {
    ...
    children: [
      ...
      {
        path: "dashboard",
        loadComponent: () => import("./chunk-HTF22UCC.js").then((m) => m.InventoryDashboardComponent),
        children: [
          {
            path: "",
            redirectTo: "overview",
          ...
          {
            path: "overview",
            loadComponent: () => import("./chunk-3UQLY2OB.js").then((m) => m.DashboardOverviewComponent)
          },
          {
            path: "automation",
            loadComponent: () => import("./chunk-G5DZC5UB.js").then((m) => m.DashboardAutomationComponent)
          },
          {
            path: "alerts",
            loadComponent: () => import("./chunk-QRIPTWFO.js").then((m) => m.DashboardAlertsComponent)
          }
        ]
      },
      {
        path: "parts-catalog",
        loadComponent: () => import("./chunk-UVC4JHS3.js").then((m) => m.PartsCatalogComponent)
      },
      {
        path: "stock-levels",
        loadComponent: () => import("./chunk-F2CDK2IE.js").then((m) => m.StockLevelsComponent)
      },
      {
        path: "transactions",
        loadComponent: () => import("./chunk-VKJRXIAJ.js").then((m) => m.TransactionsComponent)
      },
      {
        path: "purchase-orders",
        loadComponent: () => import("./chunk-DL3BF2IA.js").then((m) => m.PurchaseOrdersComponent)
      },
      {
        path: "abc-analysis",
        loadComponent: () => import("./chunk-WKBHZWCM.js").then((m) => m.AbcAnalysisComponent)
      },
      {
        path: "analytics",
        loadComponent: () => import("./chunk-CA65MMXQ.js").then((m) => m.AnalyticsComponent)
      }
    ]
  }
];
...
//# sourceMappingURL=chunk-7PR2LZRS.js.map
