...
function LoginComponent_div_26_button_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 41);
    \u0275\u0275listener("click", function LoginComponent_div_26_button_3_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
...
function LoginComponent_div_26_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, LoginComponent_div_26_button_3_Template, 2, 1, "button", 40);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var LoginComponent = class _LoginComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginComponent, selectors: [["app-login"]], decls: 60, vars: 10, consts: [[1, "min-h-screen", "bg-gray-50", "flex", "items-center", "justify-center", "py-12", "px-4", "sm:px-6", "lg:px-8"], [1, "max-w-md", "w-full", "space-y-8"], [1, "text-center"], [1, "flex", "justify-center", "mb-6"], [1, "flex", "items-center", "space-x-3"], [1, "relative"], [1, "w-10", "h-10", "bg-blue-600", "rounded-full"], [1, "absolute", "top-1", "left-1", "w-2", "h-2", "bg-blue-400", "rounded-full"], [1, "absolute", "top-2", "right-1", "w-2", "h-2", "bg-blue-400", "rounded-full"], [1, "absolute", "bottom-1", "left-2", "w-2", "h-2", "bg-blue-400", "rounded-full"], [1, "absolute", "bottom-1", "right-2", "w-2", "h-2", "bg-blue-400", "rounded-full"], [1, "text-2xl", "font-bold", "text-gray-900"], [1, "text-gray-600"], [1, "bg-white", "rounded-2xl", "shadow-lg", "p-8", "max-w-md", "mx-auto"], [1, "text-center", "mb-8"], [1, "text-2xl", "font-bold", "text-gray-900", "mb-2"], [1, "flex", "mb-8", "bg-gray-100", "rounded-lg", "p-1"], ["type", "button", 1, "flex-1", "py-2", "px-4", "text-center", "font-medium", "rounded-md", "bg-blue-600", "text-white", "transition-all", "cursor-pointer"], ["type", "button", 1, "flex-1", "py-2", "px-4", "text-center", "font-medium", "rounded-md", "text-gray-600", "hover:text-gray-800", "transition-all", "cursor-pointer", 3, "click"], ["class", "mb-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg", 4, "ngIf"], ["class", "mb-4 p-3 bg-red-50 border border-red-200 rounded-lg", 4, "ngIf"], [3, "ngSubmit", "formGroup"], [1, "space-y-6"], ["for", "email", 1, "block", "text-sm", "font-medium", "text-gray-700", "mb-2"], ["id", "email", "type", "email", "formControlName", "email", "placeholder", "Enter your email", "required", "", 1, "w-full", "px-4", "py-3", "border", "border-gray-300", "rounded-lg", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", "focus:border-transparent", "transition-all", "placeholder-gray-400"], ["for", "password", 1, "block", "text-sm", "font-medium", "text-gray-700", "mb-2"], ["id", "password", "type", "password", "formControlName", "password", "placeholder", "Enter your password", "required", "", 1, "w-full", "px-4", "py-3", "border", "border-gray-300", "rounded-lg", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", "focus:border-transparent", "transition-all", "placeholder-gray-400"], [1, "text-left"], ["type", "button", 1, "text-blue-600", "hover:text-blue-500", "text-sm", "font-medium", "cursor-pointer", 3, "click"], ["type", "submit", 1, "w-full", "bg-blue-600", "text-white", "py-3", "px-4", "rounded-lg", "font-medium", "hover:bg-blue-700", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", "focus:ring-offset-2", "transition-all", "disabled:opacity-50", "disabled:cursor-not-allowed", "cursor-pointer", 3, "disabled"], [4, "ngIf"], ["class", "flex items-center justify-center", 4, "ngIf"], [1, "flex", "justify-center", "space-x-12", "text-sm", "text-gray-500", "mt-8"], [1, "flex", "flex-col", "items-center"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-6", "h-6", "text-blue-600", "mb-2"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z"], [1, "mb-4", "p-3", "bg-yellow-50", "border", "border-yellow-200", "rounded-lg"], [1, "text-yellow-800", "text-sm"], ["class", "mt-2 text-blue-600 hover:text-blue-500 text-sm font-medium disabled:opacity-50 cursor-pointer disabled:cursor-not-allowed", 3, "disabled", "click", 4, "ngIf"], [1, "mt-2", "text-blue-600", "hover:text-blue-500", "text-sm", "font-medium", "disabled:opacity-50", "cursor-pointer", "disabled:cursor-not-allowed", 3, "click", "disabled"], [1, "mb-4", "p-3", "bg-red-50", "border", "border-red-200", "rounded-lg"], [1, "text-red-600", "text-sm"], [1, "flex", "items-center", "justify-center"], ["xmlns", "http://www.w3.org/2000/svg", "fill", "none", "viewBox", "0 0 24 24", 1, "animate-spin", "-ml-1", "mr-3", "h-5", "w-5", "text-white"], ["cx", "12", "cy", "12", "r", "10", "stroke", "currentColor", "stroke-width", "4", 1, "opacity-25"], ["fill", "currentColor", "d", "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z", 1, "opacity-75"]], template: function LoginComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(25, " Sign Up ");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(26, LoginComponent_div_26_Template, 4, 2, "div", 19)(27, LoginComponent_div_27_Template, 3, 1, "div", 20);
      \u0275\u0275elementStart(28, "form", 21);
      \u0275\u0275listener("ngSubmit", function LoginComponent_Template_form_ngSubmit_28_listener() {
        return ctx.onSubmit();
      });
      \u0275\u0275elementStart(29, "div", 22)(30, "div")(31, "label", 23);
      \u0275\u0275text(32, "Email");
      \u0275\u0275elementEnd();
      \u0275\u0275element(33, "input", 24);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(34, "div")(35, "label", 25);
      \u0275\u0275text(36, "Password");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275template(42, LoginComponent_span_42_Template, 2, 0, "span", 30)(43, LoginComponent_span_43_Template, 5, 0, "span", 31);
      \u0275\u0275elementEnd()()()();
      ...
      <div class="flex justify-center mb-6">\r
        <div class="flex items-center space-x-3">\r
          <div class="relative">\r
            <div class="w-10 h-10 bg-blue-600 rounded-full"></div>\r
            <div class="absolute top-1 left-1 w-2 h-2 bg-blue-400 rounded-full"></div>\r
            <div class="absolute top-2 right-1 w-2 h-2 bg-blue-400 rounded-full"></div>\r
            <div class="absolute bottom-1 left-2 w-2 h-2 bg-blue-400 rounded-full"></div>\r
            <div class="absolute bottom-1 right-2 w-2 h-2 bg-blue-400 rounded-full"></div>\r
          </div>\r
          <span class="text-2xl font-bold text-gray-900">AssetGo</span>\r
        </div>\r
      </div>\r
...
function RegisterComponent_div_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 20)(1, "div", 2)(2, "div", 3)(3, "div", 21);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(4, "svg", 22);
    \u0275\u0275element(5, "path", 23);
    \u0275\u0275elementEnd()()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(6, "h2", 24);
    \u0275\u0275text(7, "Registration Successful!");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "p", 25);
    \u0275\u0275text(9, " User registered successfully. Please check your email to verify your account. ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 26)(11, "p", 27);
    ...
    \u0275\u0275listener("click", function RegisterComponent_div_15_Template_button_click_16_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
...
function RegisterComponent_div_16_div_11_Template(rf, ctx) {
  if (rf & 1) {
...
function RegisterComponent_div_16_div_39_Template(rf, ctx) {
  if (rf & 1) {
...
function RegisterComponent_div_16_span_41_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "Sign Up");
    \u0275\u0275elementEnd();
...
function RegisterComponent_div_16_span_42_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 58);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 59);
    \u0275\u0275element(2, "circle", 60)(3, "path", 61);
    \u0275\u0275elementEnd();
...
function RegisterComponent_div_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 20)(1, "div", 30)(2, "h2", 31);
    \u0275\u0275text(3, "Welcome");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function RegisterComponent_div_16_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleMode());
    });
    ...
    \u0275\u0275text(10, " Sign Up ");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(11, RegisterComponent_div_16_div_11_Template, 3, 0, "div", 35);
    \u0275\u0275elementStart(12, "form", 36);
    \u0275\u0275listener("ngSubmit", function RegisterComponent_div_16_Template_form_ngSubmit_12_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onSubmit());
    });
    \u0275\u0275elementStart(13, "div", 37)(14, "div", 38)(15, "div")(16, "label", 39);
    \u0275\u0275text(17, "First Name");
    \u0275\u0275elementEnd();
    \u0275\u0275element(18, "input", 40);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "div")(20, "label", 41);
    \u0275\u0275text(21, "Last Name");
    \u0275\u0275elementEnd();
    \u0275\u0275element(22, "input", 42);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(23, "div")(24, "label", 43);
    \u0275\u0275text(25, "Company Name");
    \u0275\u0275elementEnd();
    \u0275\u0275element(26, "input", 44);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "div")(28, "label", 45);
    \u0275\u0275text(29, "Email");
    \u0275\u0275elementEnd();
    \u0275\u0275element(30, "input", 46);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "div")(32, "label", 47);
    \u0275\u0275text(33, "Password");
    \u0275\u0275elementEnd();
    \u0275\u0275element(34, "input", 48);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "div")(36, "label", 49);
    \u0275\u0275text(37, "Confirm Password");
    \u0275\u0275elementEnd();
    \u0275\u0275element(38, "input", 50);
    \u0275\u0275template(39, RegisterComponent_div_16_div_39_Template, 2, 0, "div", 51);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "button", 52);
    \u0275\u0275template(41, RegisterComponent_div_16_span_41_Template, 2, 0, "span", 53)(42, RegisterComponent_div_16_span_42_Template, 5, 0, "span", 54);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    let tmp_3_0;
...
var RegisterComponent = class _RegisterComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RegisterComponent, selectors: [["app-register"]], decls: 33, vars: 2, consts: [[1, "min-h-screen", "bg-gray-50", "flex", "items-center", "justify-center", "py-12", "px-4", "sm:px-6", "lg:px-8"], [1, "max-w-md", "w-full", "space-y-8"], [1, "text-center"], [1, "flex", "justify-center", "mb-6"], [1, "flex", "items-center", "space-x-3"], [1, "relative"], [1, "w-10", "h-10", "bg-blue-600", "rounded-full"], [1, "absolute", "top-1", "left-1", "w-2", "h-2", "bg-blue-400", "rounded-full"], [1, "absolute", "top-2", "right-1", "w-2", "h-2", "bg-blue-400", "rounded-full"], [1, "absolute", "bottom-1", "left-2", "w-2", "h-2", "bg-blue-400", "rounded-full"], [1, "absolute", "bottom-1", "right-2", "w-2", "h-2", "bg-blue-400", "rounded-full"], [1, "text-2xl", "font-bold", "text-gray-900"], [1, "text-gray-600"], ["class", "bg-white rounded-2xl shadow-lg p-8 max-w-md mx-auto", 4, "ngIf"], [1, "flex", "justify-center", "space-x-12", "text-sm", "text-gray-500", "mt-8"], [1, "flex", "flex-col", "items-center"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-6", "h-6", "text-blue-600", "mb-2"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z"], [1, "bg-white", "rounded-2xl", "shadow-lg", "p-8", "max-w-md", "mx-auto"], [1, "w-16", "h-16", "bg-green-100", "rounded-full", "flex", "items-center", "justify-center"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-8", "h-8", "text-green-600"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M5 13l4 4L19 7"], [1, "text-2xl", "font-bold", "text-gray-900", "mb-4"], [1, "text-gray-600", "mb-6", "leading-relaxed"], [1, "bg-blue-50", "rounded-lg", "p-4", "mb-6"], [1, "text-blue-800", "text-sm"], [1, "font-bold"], [1, "text-blue-600", "hover:text-blue-500", "text-sm", "font-medium", "cursor-pointer", 3, "click"], [1, "text-center", "mb-8"], [1, "text-2xl", "font-bold", "text-gray-900", "mb-2"], [1, "flex", "mb-8", "bg-gray-100", "rounded-lg", "p-1"], ["type", "button", 1, "flex-1", "py-2", "px-4", "text-center", "font-medium", "rounded-md", "text-gray-600", "hover:text-gray-800", "transition-all", "cursor-pointer", 3, "click"], ["type", "button", 1, "flex-1", "py-2", "px-4", "text-center", "font-medium", "rounded-md", "bg-blue-600", "text-white", "transition-all", "cursor-pointer"], ["class", "mb-4 p-3 bg-green-50 border border-green-200 rounded-lg", 4, "ngIf"], [3, "ngSubmit", "formGroup"], [1, "space-y-4"], [1, "grid", "grid-cols-2", "gap-4"], ["for", "first_name", 1, "block", "text-sm", "font-medium", "text-gray-700", "mb-1"], ["id", "first_name", "type", "text", "formControlName", "first_name", "placeholder", "First name", "required", "", 1, "w-full", "px-3", "py-2", "border", "border-gray-300", "rounded-lg", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", "focus:border-transparent", "transition-all", "placeholder-gray-400"], ["for", "last_name", 1, "block", "text-sm", "font-medium", "text-gray-700", "mb-1"], ["id", "last_name", "type", "text", "formControlName", "last_name", "placeholder", "Last name", "required", "", 1, "w-full", "px-3", "py-2", "border", "border-gray-300", "rounded-lg", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", "focus:border-transparent", "transition-all", "placeholder-gray-400"], ["for", "company_name", 1, "block", "text-sm", "font-medium", "text-gray-700", "mb-1"], ["id", "company_name", "type", "text", "formControlName", "company_name", "placeholder", "Enter your company name", "required", "", 1, "w-full", "px-3", "py-2", "border", "border-gray-300", "rounded-lg", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", "focus:border-transparent", "transition-all", "placeholder-gray-400"], ["for", "email", 1, "block", "text-sm", "font-medium", "text-gray-700", "mb-1"], ["id", "email", "type", "email", "formControlName", "email", "placeholder", "Enter your email", "required", "", 1, "w-full", "px-3", "py-2", "border", "border-gray-300", "rounded-lg", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", "focus:border-transparent", "transition-all", "placeholder-gray-400"], ["for", "password", 1, "block", "text-sm", "font-medium", "text-gray-700", "mb-1"], ["id", "password", "type", "password", "formControlName", "password", "placeholder", "Create a password", "required", "", 1, "w-full", "px-3", "py-2", "border", "border-gray-300", "rounded-lg", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", "focus:border-transparent", "transition-all", "placeholder-gray-400"], ["for", "password_confirmation", 1, "block", "text-sm", "font-medium", "text-gray-700", "mb-1"], ["id", "password_confirmation", "type", "password", "formControlName", "password_confirmation", "placeholder", "Confirm your password", "required", "", 1, "w-full", "px-3", "py-2", "border", "border-gray-300", "rounded-lg", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", "focus:border-transparent", "transition-all", "placeholder-gray-400"], ["class", "text-red-500 text-xs mt-1", 4, "ngIf"], ["type", "submit", 1, "w-full", "bg-blue-600", "text-white", "py-3", "px-4", "rounded-lg", "font-medium", "hover:bg-blue-700", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", "focus:ring-offset-2", "transition-all", "disabled:opacity-50", "disabled:cursor-not-allowed", "cursor-pointer", "mt-6", 3, "disabled"], [4, "ngIf"], ["class", "flex items-center justify-center", 4, "ngIf"], [1, "mb-4", "p-3", "bg-green-50", "border", "border-green-200", "rounded-lg"], [1, "text-green-600", "text-sm"], [1, "text-red-500", "text-xs", "mt-1"], [1, "flex", "items-center", "justify-center"], ["xmlns", "http://www.w3.org/2000/svg", "fill", "none", "viewBox", "0 0 24 24", 1, "animate-spin", "-ml-1", "mr-3", "h-5", "w-5", "text-white"], ["cx", "12", "cy", "12", "r", "10", "stroke", "currentColor", "stroke-width", "4", 1, "opacity-25"], ["fill", "currentColor", "d", "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z", 1, "opacity-75"]], template: function RegisterComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(14, "Enterprise Asset Management System");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(15, RegisterComponent_div_15_Template, 18, 1, "div", 13)(16, RegisterComponent_div_16_Template, 43, 18, "div", 13);
    ...
    <div *ngIf="showSuccessMessage" class="bg-white rounded-2xl shadow-lg p-8 max-w-md mx-auto">\r
      <div class="text-center">\r
        ...
        <p class="text-gray-600 mb-6 leading-relaxed">\r
          User registered successfully. Please check your email to verify your account.\r
        </p>\r
        \r
        <!-- Countdown -->\r
...
function ForgotPasswordComponent_div_15_div_6_Template(rf, ctx) {
  if (rf & 1) {
...
function ForgotPasswordComponent_div_15_span_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
...
function ForgotPasswordComponent_div_15_span_15_Template(rf, ctx) {
  if (rf & 1) {
...
function ForgotPasswordComponent_div_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(6, ForgotPasswordComponent_div_15_div_6_Template, 3, 1, "div", 17);
    \u0275\u0275elementStart(7, "form", 18);
    \u0275\u0275listener("ngSubmit", function ForgotPasswordComponent_div_15_Template_form_ngSubmit_7_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onSubmit());
    });
    \u0275\u0275elementStart(8, "div", 19)(9, "div")(10, "label", 20);
    \u0275\u0275text(11, "Email Address");
    \u0275\u0275elementEnd();
    \u0275\u0275element(12, "input", 21);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "button", 22);
    \u0275\u0275template(14, ForgotPasswordComponent_div_15_span_14_Template, 2, 0, "span", 23)(15, ForgotPasswordComponent_div_15_span_15_Template, 5, 0, "span", 24);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "div", 2)(17, "button", 25);
    \u0275\u0275listener("click", function ForgotPasswordComponent_div_15_Template_button_click_17_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
...
function ForgotPasswordComponent_div_16_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 14)(1, "div", 2)(2, "div", 3)(3, "div", 32);
    \u0275\u0275namespaceSVG();
    ...
    \u0275\u0275listener("click", function ForgotPasswordComponent_div_16_Template_button_click_16_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.goBack());
    });
...
var ForgotPasswordComponent = class _ForgotPasswordComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ForgotPasswordComponent, selectors: [["app-forgot-password"]], decls: 17, vars: 2, consts: [[1, "min-h-screen", "bg-gray-50", "flex", "items-center", "justify-center", "py-12", "px-4", "sm:px-6", "lg:px-8"], [1, "max-w-md", "w-full", "space-y-8"], [1, "text-center"], [1, "flex", "justify-center", "mb-6"], [1, "flex", "items-center", "space-x-3"], [1, "relative"], [1, "w-10", "h-10", "bg-blue-600", "rounded-full"], [1, "absolute", "top-1", "left-1", "w-2", "h-2", "bg-blue-400", "rounded-full"], [1, "absolute", "top-2", "right-1", "w-2", "h-2", "bg-blue-400", "rounded-full"], [1, "absolute", "bottom-1", "left-2", "w-2", "h-2", "bg-blue-400", "rounded-full"], [1, "absolute", "bottom-1", "right-2", "w-2", "h-2", "bg-blue-400", "rounded-full"], [1, "text-2xl", "font-bold", "text-gray-900"], [1, "text-gray-600"], ["class", "bg-white rounded-2xl shadow-lg p-8 max-w-md mx-auto", 4, "ngIf"], [1, "bg-white", "rounded-2xl", "shadow-lg", "p-8", "max-w-md", "mx-auto"], [1, "text-center", "mb-8"], [1, "text-2xl", "font-bold", "text-gray-900", "mb-2"], ["class", "mb-4 p-3 bg-red-50 border border-red-200 rounded-lg", 4, "ngIf"], [3, "ngSubmit", "formGroup"], [1, "space-y-6"], ["for", "email", 1, "block", "text-sm", "font-medium", "text-gray-700", "mb-2"], ["id", "email", "type", "email", "formControlName", "email", "placeholder", "Enter your email address", "required", "", 1, "w-full", "px-4", "py-3", "border", "border-gray-300", "rounded-lg", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", "focus:border-transparent", "transition-all", "placeholder-gray-400"], ["type", "submit", 1, "w-full", "bg-blue-600", "text-white", "py-3", "px-4", "rounded-lg", "font-medium", "hover:bg-blue-700", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", "focus:ring-offset-2", "transition-all", "disabled:opacity-50", "disabled:cursor-not-allowed", "cursor-pointer", 3, "disabled"], [4, "ngIf"], ["class", "flex items-center justify-center", 4, "ngIf"], ["type", "button", 1, "text-blue-600", "hover:text-blue-500", "text-sm", "font-medium", "cursor-pointer", 3, "click"], [1, "mb-4", "p-3", "bg-red-50", "border", "border-red-200", "rounded-lg"], [1, "text-red-600", "text-sm"], [1, "flex", "items-center", "justify-center"], ["xmlns", "http://www.w3.org/2000/svg", "fill", "none", "viewBox", "0 0 24 24", 1, "animate-spin", "-ml-1", "mr-3", "h-5", "w-5", "text-white"], ["cx", "12", "cy", "12", "r", "10", "stroke", "currentColor", "stroke-width", "4", 1, "opacity-25"], ["fill", "currentColor", "d", "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z", 1, "opacity-75"], [1, "w-16", "h-16", "bg-green-100", "rounded-full", "flex", "items-center", "justify-center"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-8", "h-8", "text-green-600"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M5 13l4 4L19 7"], [1, "text-2xl", "font-bold", "text-gray-900", "mb-4"], [1, "text-gray-600", "mb-6", "leading-relaxed"], [1, "bg-blue-50", "rounded-lg", "p-4", "mb-6"], [1, "text-blue-800", "text-sm"], [1, "font-bold"], [1, "text-blue-600", "hover:text-blue-500", "text-sm", "font-medium", "cursor-pointer", 3, "click"]], template: function ForgotPasswordComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(14, "Enterprise Asset Management System");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(15, ForgotPasswordComponent_div_15_Template, 19, 7, "div", 13)(16, ForgotPasswordComponent_div_16_Template, 18, 1, "div", 13);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(15);
...
function ResetPasswordComponent_div_15_div_6_Template(rf, ctx) {
  if (rf & 1) {
...
function ResetPasswordComponent_div_15_form_7_div_10_Template(rf, ctx) {
  if (rf & 1) {
...
function ResetPasswordComponent_div_15_form_7_span_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
...
function ResetPasswordComponent_div_15_form_7_span_13_Template(rf, ctx) {
  if (rf & 1) {
...
function ResetPasswordComponent_div_15_form_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "form", 23);
    \u0275\u0275listener("ngSubmit", function ResetPasswordComponent_div_15_form_7_Template_form_ngSubmit_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.onSubmit());
    });
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div")(7, "label", 27);
    \u0275\u0275text(8, "Confirm New Password");
    \u0275\u0275elementEnd();
    \u0275\u0275element(9, "input", 28);
    \u0275\u0275template(10, ResetPasswordComponent_div_15_form_7_div_10_Template, 2, 0, "div", 29);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "button", 30);
    \u0275\u0275template(12, ResetPasswordComponent_div_15_form_7_span_12_Template, 2, 0, "span", 31)(13, ResetPasswordComponent_div_15_form_7_span_13_Template, 5, 0, "span", 32);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    let tmp_3_0;
...
function ResetPasswordComponent_div_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(6, ResetPasswordComponent_div_15_div_6_Template, 3, 1, "div", 17)(7, ResetPasswordComponent_div_15_form_7_Template, 14, 9, "form", 18);
    \u0275\u0275elementStart(8, "div", 19)(9, "button", 20);
    \u0275\u0275listener("click", function ResetPasswordComponent_div_15_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
...
function ResetPasswordComponent_div_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 14)(1, "div", 2)(2, "div", 3)(3, "div", 38);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(4, "svg", 39);
    \u0275\u0275element(5, "path", 40);
    \u0275\u0275elementEnd()()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(6, "h2", 41);
    ...
    \u0275\u0275listener("click", function ResetPasswordComponent_div_16_Template_button_click_16_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.goToLogin());
    });
...
var ResetPasswordComponent = class _ResetPasswordComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ResetPasswordComponent, selectors: [["app-reset-password"]], decls: 17, vars: 2, consts: [[1, "min-h-screen", "bg-gray-50", "flex", "items-center", "justify-center", "py-12", "px-4", "sm:px-6", "lg:px-8"], [1, "max-w-md", "w-full", "space-y-8"], [1, "text-center"], [1, "flex", "justify-center", "mb-6"], [1, "flex", "items-center", "space-x-3"], [1, "relative"], [1, "w-10", "h-10", "bg-blue-600", "rounded-full"], [1, "absolute", "top-1", "left-1", "w-2", "h-2", "bg-blue-400", "rounded-full"], [1, "absolute", "top-2", "right-1", "w-2", "h-2", "bg-blue-400", "rounded-full"], [1, "absolute", "bottom-1", "left-2", "w-2", "h-2", "bg-blue-400", "rounded-full"], [1, "absolute", "bottom-1", "right-2", "w-2", "h-2", "bg-blue-400", "rounded-full"], [1, "text-2xl", "font-bold", "text-gray-900"], [1, "text-gray-600"], ["class", "bg-white rounded-2xl shadow-lg p-8 max-w-md mx-auto", 4, "ngIf"], [1, "bg-white", "rounded-2xl", "shadow-lg", "p-8", "max-w-md", "mx-auto"], [1, "text-center", "mb-8"], [1, "text-2xl", "font-bold", "text-gray-900", "mb-2"], ["class", "mb-4 p-3 bg-red-50 border border-red-200 rounded-lg", 4, "ngIf"], [3, "formGroup", "ngSubmit", 4, "ngIf"], [1, "text-center", "mt-6"], ["type", "button", 1, "text-blue-600", "hover:text-blue-500", "text-sm", "font-medium", "cursor-pointer", 3, "click"], [1, "mb-4", "p-3", "bg-red-50", "border", "border-red-200", "rounded-lg"], [1, "text-red-600", "text-sm"], [3, "ngSubmit", "formGroup"], [1, "space-y-6"], ["for", "password", 1, "block", "text-sm", "font-medium", "text-gray-700", "mb-2"], ["id", "password", "type", "password", "formControlName", "password", "placeholder", "Enter new password", "required", "", 1, "w-full", "px-4", "py-3", "border", "border-gray-300", "rounded-lg", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", "focus:border-transparent", "transition-all", "placeholder-gray-400"], ["for", "password_confirmation", 1, "block", "text-sm", "font-medium", "text-gray-700", "mb-2"], ["id", "password_confirmation", "type", "password", "formControlName", "password_confirmation", "placeholder", "Confirm new password", "required", "", 1, "w-full", "px-4", "py-3", "border", "border-gray-300", "rounded-lg", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", "focus:border-transparent", "transition-all", "placeholder-gray-400"], ["class", "text-red-500 text-xs mt-1", 4, "ngIf"], ["type", "submit", 1, "w-full", "bg-blue-600", "text-white", "py-3", "px-4", "rounded-lg", "font-medium", "hover:bg-blue-700", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", "focus:ring-offset-2", "transition-all", "disabled:opacity-50", "disabled:cursor-not-allowed", "cursor-pointer", 3, "disabled"], [4, "ngIf"], ["class", "flex items-center justify-center", 4, "ngIf"], [1, "text-red-500", "text-xs", "mt-1"], [1, "flex", "items-center", "justify-center"], ["xmlns", "http://www.w3.org/2000/svg", "fill", "none", "viewBox", "0 0 24 24", 1, "animate-spin", "-ml-1", "mr-3", "h-5", "w-5", "text-white"], ["cx", "12", "cy", "12", "r", "10", "stroke", "currentColor", "stroke-width", "4", 1, "opacity-25"], ["fill", "currentColor", "d", "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z", 1, "opacity-75"], [1, "w-16", "h-16", "bg-green-100", "rounded-full", "flex", "items-center", "justify-center"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-8", "h-8", "text-green-600"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M5 13l4 4L19 7"], [1, "text-2xl", "font-bold", "text-gray-900", "mb-4"], [1, "text-gray-600", "mb-6", "leading-relaxed"], [1, "bg-blue-50", "rounded-lg", "p-4", "mb-6"], [1, "text-blue-800", "text-sm"], [1, "font-bold"], [1, "text-blue-600", "hover:text-blue-500", "text-sm", "font-medium", "cursor-pointer", 3, "click"]], template: function ResetPasswordComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(14, "Enterprise Asset Management System");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(15, ResetPasswordComponent_div_15_Template, 11, 2, "div", 13)(16, ResetPasswordComponent_div_16_Template, 18, 1, "div", 13);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(15);
...
function ActivateAccountComponent_div_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 15)(1, "div", 16);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(2, "svg", 17);
    \u0275\u0275element(3, "circle", 18)(4, "path", 19);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(5, "h2", 20);
...
function ActivateAccountComponent_div_18_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 15)(1, "div", 16)(2, "div", 21);
    \u0275\u0275namespaceSVG();
    ...
    \u0275\u0275listener("click", function ActivateAccountComponent_div_18_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.goToLogin());
    });
...
function ActivateAccountComponent_div_19_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 15)(1, "div", 16)(2, "div", 26);
    \u0275\u0275namespaceSVG();
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "div", 29)(10, "button", 25);
    \u0275\u0275listener("click", function ActivateAccountComponent_div_19_Template_button_click_10_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function ActivateAccountComponent_div_19_Template_button_click_12_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.goToLogin());
    });
...
var ActivateAccountComponent = class _ActivateAccountComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ActivateAccountComponent, selectors: [["app-activate-account"]], decls: 20, vars: 3, consts: [[1, "min-h-screen", "bg-gray-50", "flex", "items-center", "justify-center", "py-12", "px-4", "sm:px-6", "lg:px-8"], [1, "max-w-md", "w-full", "space-y-8"], [1, "text-center"], [1, "flex", "justify-center", "mb-6"], [1, "flex", "items-center", "space-x-3"], [1, "relative"], [1, "w-10", "h-10", "bg-blue-600", "rounded-full"], [1, "absolute", "top-1", "left-1", "w-2", "h-2", "bg-blue-400", "rounded-full"], [1, "absolute", "top-2", "right-1", "w-2", "h-2", "bg-blue-400", "rounded-full"], [1, "absolute", "bottom-1", "left-2", "w-2", "h-2", "bg-blue-400", "rounded-full"], [1, "absolute", "bottom-1", "right-2", "w-2", "h-2", "bg-blue-400", "rounded-full"], [1, "text-2xl", "font-bold", "text-gray-900"], [1, "text-gray-600"], [1, "bg-white", "rounded-2xl", "shadow-lg", "p-8", "max-w-md", "mx-auto"], ["class", "py-8", 4, "ngIf"], [1, "py-8"], [1, "flex", "justify-center", "mb-4"], ["xmlns", "http://www.w3.org/2000/svg", "fill", "none", "viewBox", "0 0 24 24", 1, "animate-spin", "h-12", "w-12", "text-blue-600"], ["cx", "12", "cy", "12", "r", "10", "stroke", "currentColor", "stroke-width", "4", 1, "opacity-25"], ["fill", "currentColor", "d", "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z", 1, "opacity-75"], [1, "text-2xl", "font-bold", "text-gray-900", "mb-2"], [1, "w-16", "h-16", "bg-green-100", "rounded-full", "flex", "items-center", "justify-center"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-8", "h-8", "text-green-600"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M5 13l4 4L19 7"], [1, "text-gray-600", "mb-6"], [1, "w-full", "bg-blue-600", "text-white", "py-3", "px-4", "rounded-lg", "font-medium", "hover:bg-blue-700", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", "focus:ring-offset-2", "transition-all", "cursor-pointer", 3, "click"], [1, "w-16", "h-16", "bg-red-100", "rounded-full", "flex", "items-center", "justify-center"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-8", "h-8", "text-red-600"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M6 18L18 6M6 6l12 12"], [1, "space-y-3"], [1, "w-full", "text-blue-600", "py-3", "px-4", "rounded-lg", "font-medium", "hover:bg-blue-50", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", "focus:ring-offset-2", "transition-all", "cursor-pointer", 3, "click"]], template: function ActivateAccountComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(14, "Enterprise Asset Management System");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(15, "div", 13)(16, "div", 2);
      \u0275\u0275template(17, ActivateAccountComponent_div_17_Template, 9, 0, "div", 14)(18, ActivateAccountComponent_div_18_Template, 11, 1, "div", 14)(19, ActivateAccountComponent_div_19_Template, 14, 1, "div", 14);
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(17);
...
//# sourceMappingURL=chunk-JVGHQNL5.js.map
