...
var routes = [
  {
    ...
    children: [
      ...
      {
        path: "dashboard",
        loadComponent: () => import("./chunk-2QNVXJQW.js").then((m) => m.InventoryDashboardComponent),
        children: [
          {
            path: "",
            redirectTo: "overview",
          ...
          {
            path: "overview",
            loadComponent: () => import("./chunk-3E44NAVQ.js").then((m) => m.DashboardOverviewComponent)
          },
          {
            path: "automation",
            loadComponent: () => import("./chunk-2GOZT3NK.js").then((m) => m.DashboardAutomationComponent)
          },
          {
            path: "alerts",
            loadComponent: () => import("./chunk-CMA6QNFF.js").then((m) => m.DashboardAlertsComponent)
          }
        ]
      },
      {
        path: "parts-catalog",
        loadComponent: () => import("./chunk-MOASPWDJ.js").then((m) => m.PartsCatalogComponent)
      },
      {
        path: "stock-levels",
        loadComponent: () => import("./chunk-T5VREHPW.js").then((m) => m.StockLevelsComponent)
      },
      {
        path: "transactions",
        loadComponent: () => import("./chunk-BSSTESCX.js").then((m) => m.TransactionsComponent)
      },
      {
        path: "purchase-orders",
        loadComponent: () => import("./chunk-OT6J3IZG.js").then((m) => m.PurchaseOrdersComponent)
      },
      {
        path: "abc-analysis",
        loadComponent: () => import("./chunk-4HPHN6GM.js").then((m) => m.AbcAnalysisComponent)
      },
      {
        path: "analytics",
        loadComponent: () => import("./chunk-UP6P27SW.js").then((m) => m.AnalyticsComponent)
      }
    ]
  }
];
...
//# sourceMappingURL=chunk-5RRBVTLL.js.map
