...
function TransactionsComponent_Conditional_45_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 18)(1, "button", 23);
    \u0275\u0275listener("click", function TransactionsComponent_Conditional_45_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r4);
    ...
    \u0275\u0275listener("click", function TransactionsComponent_Conditional_45_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r4 = \u0275\u0275nextContext();
...
function TransactionsComponent_div_46_Template(rf, ctx) {
  if (rf & 1) {
...
function TransactionsComponent_div_47_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function TransactionsComponent_div_47_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r4 = \u0275\u0275nextContext();
...
function TransactionsComponent_div_48_tr_30_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r4.formatDate(transaction_r7.created_at), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", ctx_r4.getTransactionTypeClass(transaction_r7.type));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r4.getTransactionTypeLabel(transaction_r7.type), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate((transaction_r7.part == null ? null : transaction_r7.part.name) || "Unknown Part");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate((transaction_r7.part == null ? null : transaction_r7.part.part_number) || "N/A");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate((transaction_r7.location == null ? null : transaction_r7.location.name) || "Unknown Location");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate((transaction_r7.location == null ? null : transaction_r7.location.code) || "N/A");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction3(16, _c0, transaction_r7.type === "receipt" || transaction_r7.type === "transfer_in" || transaction_r7.type === "return", transaction_r7.type === "issue" || transaction_r7.type === "transfer_out", transaction_r7.type === "adjustment"));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" ", transaction_r7.type === "issue" || transaction_r7.type === "transfer_out" ? "-" : "+", "", transaction_r7.quantity, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r4.formatCurrency(transaction_r7.unit_cost || 0), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r4.formatCurrency(transaction_r7.total_cost || 0));
    \u0275\u0275advance(2);
    \u0275\u0275property("title", transaction_r7.reason);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", transaction_r7.reason || "N/A", " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("title", transaction_r7.reference);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", transaction_r7.reference || "N/A", " ");
  }
}
function TransactionsComponent_div_48_div_31_Template(rf, ctx) {
  if (rf & 1) {
...
function TransactionsComponent_div_48_div_32_button_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 86);
    \u0275\u0275listener("click", function TransactionsComponent_div_48_div_32_button_6_Template_button_click_0_listener() {
      const i_r10 = \u0275\u0275restoreView(_r9).index;
      const ctx_r4 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r4.onPageChange(i_r10 + 1));
    });
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r4 = \u0275\u0275nextContext(3);
    \u0275\u0275classProp("active", ctx_r4.currentPage === i_r10 + 1);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", i_r10 + 1, " ");
  }
}
function TransactionsComponent_div_48_div_32_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 78)(1, "button", 79);
    \u0275\u0275listener("click", function TransactionsComponent_div_48_div_32_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r4 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275template(6, TransactionsComponent_div_48_div_32_button_6_Template, 2, 3, "button", 83);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "button", 84);
    \u0275\u0275listener("click", function TransactionsComponent_div_48_div_32_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r4 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r4.onPageChange(ctx_r4.currentPage + 1));
    });
...
function TransactionsComponent_div_48_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(30, TransactionsComponent_div_48_tr_30_Template, 32, 20, "tr", 48);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(31, TransactionsComponent_div_48_div_31_Template, 8, 0, "div", 49)(32, TransactionsComponent_div_48_div_32_Template, 11, 4, "div", 50);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext();
...
var TransactionsComponent = class _TransactionsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TransactionsComponent, selectors: [["app-transactions"]], decls: 49, vars: 14, consts: [[1, "transactions-container"], [1, "header-section"], [1, "header-content"], [1, "text-2xl", "font-bold", "text-gray-900"], [1, "text-gray-600"], [1, "header-actions"], [1, "btn", "btn-secondary", 3, "click", "disabled"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-4", "h-4", "mr-2"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"], [1, "filters-section"], [1, "filters-grid"], [1, "filter-group"], [1, "filter-label"], [1, "filter-select", 3, "ngModelChange", "ngModel"], [3, "value", 4, "ngFor", "ngForOf"], ["value", ""], ["type", "date", 1, "filter-input", 3, "ngModelChange", "ngModel"], ["type", "text", "placeholder", "Search transactions...", 1, "filter-input", 3, "ngModelChange", "ngModel"], [1, "filter-actions", "mt-6"], ["class", "loading-state", 4, "ngIf"], ["class", "error-state", 4, "ngIf"], ["class", "table-container", 4, "ngIf"], [3, "value"], [1, "btn", "btn-outline", 3, "click"], [1, "btn", "btn-primary", 3, "click"], [1, "loading-state"], [1, "loading-spinner"], [1, "error-state"], [1, "error-icon"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-8", "h-8"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"], [1, "error-message"], [1, "table-container"], [1, "table-header"], [1, "table-title"], [1, "table-actions"], [1, "text-sm", "text-gray-500"], [1, "table-wrapper"], [1, "transactions-table"], [1, "th-date"], [1, "th-type"], [1, "th-part"], [1, "th-location"], [1, "th-quantity"], [1, "th-cost"], [1, "th-total"], [1, "th-reason"], [1, "th-reference"], ["class", "table-row", 4, "ngFor", "ngForOf"], ["class", "empty-state", 4, "ngIf"], ["class", "pagination", 4, "ngIf"], [1, "table-row"], [1, "td-date"], [1, "td-type"], [1, "transaction-type-badge", 3, "ngClass"], [1, "td-part"], [1, "part-info"], [1, "part-name"], [1, "part-number"], [1, "td-location"], [1, "location-info"], [1, "location-name"], [1, "location-code"], [1, "td-quantity"], [1, "quantity-value", 3, "ngClass"], [1, "td-cost"], [1, "td-total"], [1, "total-cost"], [1, "td-reason"], [1, "reason-text", 3, "title"], [1, "td-reference"], [1, "reference-text", 3, "title"], [1, "empty-state"], [1, "empty-icon"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-12", "h-12"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"], [1, "empty-title"], [1, "empty-description"], [1, "pagination"], [1, "pagination-btn", "pagination-prev", 3, "click", "disabled"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-4", "h-4"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M15 19l-7-7 7-7"], [1, "pagination-pages"], ["class", "pagination-page", 3, "active", "click", 4, "ngFor", "ngForOf"], [1, "pagination-btn", "pagination-next", 3, "click", "disabled"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M9 5l7 7-7 7"], [1, "pagination-page", 3, "click"]], template: function TransactionsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(45, TransactionsComponent_Conditional_45_Template, 5, 0, "div", 18);
      \u0275\u0275elementEnd();
      \u0275\u0275template(46, TransactionsComponent_div_46_Template, 4, 0, "div", 19)(47, TransactionsComponent_div_47_Template, 8, 1, "div", 20)(48, TransactionsComponent_div_48_Template, 33, 6, "div", 21);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(8);
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.filters.type || ctx.filters.part_id || ctx.filters.location_id || ctx.filters.start_date || ctx.filters.end_date || ctx.filters.search ? 45 : -1);
      \u0275\u0275advance();
...
\r
    @if (filters.type || filters.part_id || filters.location_id || filters.start_date || filters.end_date || filters.search){\r
...
//# sourceMappingURL=chunk-VKJRXIAJ.js.map
