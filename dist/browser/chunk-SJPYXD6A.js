...
var AddSupplierModalComponent = class _AddSupplierModalComponent {
  ...
  onPhoneKeyPress(event) {
    if ([8, 9, 27, 13, 46, 35, 36, 37, 38, 39, 40].indexOf(event.keyCode) !== -1 || // Allow: Ctrl+A, Ctrl+C, Ctrl+V, Ctrl+X
    event.ctrlKey === true && [65, 67, 86, 88].indexOf(event.keyCode) !== -1 || // Allow: home, end, left, right, down, up
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AddSupplierModalComponent, selectors: [["app-add-supplier-modal"]], outputs: { closeModal: "closeModal", supplierCreated: "supplierCreated" }, decls: 177, vars: 10, consts: [[1, "modal-overlay", 3, "click"], [1, "modal-container", 3, "click"], [1, "modal-header"], [1, "modal-title"], [1, "modal-subtitle"], [1, "close-btn", 3, "click"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-5", "h-5"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M6 18L18 6M6 6l12 12"], [1, "modal-body"], [3, "ngSubmit", "formGroup"], [1, "form-section"], [1, "section-header"], [1, "section-icon", "basic"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"], [1, "section-title"], [1, "form-row"], [1, "form-field"], ["for", "supplierCode", 1, "field-label"], [1, "input-with-button"], ["type", "text", "id", "supplierCode", "formControlName", "supplier_code", "placeholder", "Enter supplier code", 1, "form-input"], ["type", "button", 1, "generate-btn", 3, "click"], ["class", "error-message", 4, "ngIf"], ["for", "businessName", 1, "field-label"], ["type", "text", "id", "businessName", "formControlName", "name", "placeholder", "Enter business name", 1, "form-input"], ["for", "contactPerson", 1, "field-label"], ["type", "text", "id", "contactPerson", "formControlName", "contact_person", "placeholder", "Enter contact person name", 1, "form-input"], ["for", "taxRegistration", 1, "field-label"], ["type", "text", "id", "taxRegistration", "formControlName", "tax_registration_number", "placeholder", "Enter tax registration number", 1, "form-input"], [1, "section-icon", "contact"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"], ["for", "email", 1, "field-label"], ["type", "email", "id", "email", "formControlName", "email", "placeholder", "Enter email address", 1, "form-input"], ["for", "primaryPhone", 1, "field-label"], ["type", "tel", "id", "primaryPhone", "formControlName", "phone", "placeholder", "Enter primary phone", "pattern", "[0-9]*", "inputmode", "numeric", 1, "form-input", 3, "keypress"], ["for", "alternatePhone", 1, "field-label"], ["type", "tel", "id", "alternatePhone", "formControlName", "alternate_phone", "placeholder", "Enter alternate phone", "pattern", "[0-9]*", "inputmode", "numeric", 1, "form-input", 3, "keypress"], ["for", "website", 1, "field-label"], ["type", "url", "id", "website", "formControlName", "website", "placeholder", "Enter website URL", 1, "form-input"], [1, "section-icon", "address"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"], [1, "form-field", "full-width"], ["for", "streetAddress", 1, "field-label"], [1, "input-with-icon"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "input-icon"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M15 11a3 3 0 11-6 0 3 3 0 016 0z"], ["type", "text", "id", "streetAddress", "formControlName", "street_address", "placeholder", "Enter supplier address", 1, "form-input"], ["for", "city", 1, "field-label"], ["type", "text", "id", "city", "formControlName", "city", "placeholder", "Enter city", 1, "form-input"], ["for", "state", 1, "field-label"], ["id", "state", "formControlName", "state", 1, "form-select"], ["value", ""], ["value", "Abu Dhabi"], ["value", "Dubai"], ["value", "Sharjah"], ["value", "Ajman"], ["value", "Umm Al Quwain"], ["value", "Ras Al Khaimah"], ["value", "Fujairah"], ["for", "postalCode", 1, "field-label"], ["type", "text", "id", "postalCode", "formControlName", "postal_code", "placeholder", "Enter postal code", 1, "form-input"], [1, "section-icon", "business"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1"], ["for", "paymentTerms", 1, "field-label"], ["id", "paymentTerms", "formControlName", "payment_terms", 1, "form-select"], ["value", "Net 30"], ["value", "Net 45"], ["value", "Net 60"], ["value", "Net 90"], ["value", "Due on Receipt"], ["for", "currency", 1, "field-label"], ["id", "currency", "formControlName", "currency", 1, "form-select"], ["value", "AED"], ["value", "USD"], ["value", "EUR"], ["value", "GBP"], ["for", "creditLimit", 1, "field-label"], ["type", "number", "id", "creditLimit", "formControlName", "credit_limit", "min", "0", "step", "0.01", "placeholder", "Enter credit limit", 1, "form-input"], ["for", "deliveryLeadTime", 1, "field-label"], ["type", "number", "id", "deliveryLeadTime", "formControlName", "delivery_lead_time", "min", "1", "placeholder", "Enter lead time", 1, "form-input"], [1, "section-icon", "notes"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"], ["for", "notes", 1, "field-label"], ["id", "notes", "formControlName", "notes", "rows", "3", "placeholder", "Additional notes about this supplier...", 1, "form-textarea"], ["class", "error-section", 4, "ngIf"], [1, "modal-footer"], ["type", "button", 1, "btn", "btn-secondary", 3, "click"], ["type", "submit", 1, "btn", "btn-primary", 3, "click", "disabled"], [4, "ngIf"], [1, "error-message"], [1, "error-section"]], template: function AddSupplierModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("keypress", function AddSupplierModalComponent_Template_input_keypress_59_listener($event) {
      ...
      \u0275\u0275listener("keypress", function AddSupplierModalComponent_Template_input_keypress_65_listener($event) {
        return ctx.onPhoneKeyPress($event);
      });
      \u0275\u0275elementEnd()();
          ...
          <div class="form-row">\r
            ...
            <div class="form-field">\r
              ...
              <input \r
                ...
                class="form-input" \r
                placeholder="Enter primary phone"\r
                pattern="[0-9]*"\r
                inputmode="numeric"\r
                (keypress)="onPhoneKeyPress($event)">\r
          ...
          <div class="form-row">\r
            <div class="form-field">\r
              ...
              <input \r
                type="tel" \r
                id="alternatePhone" \r
                formControlName="alternate_phone" \r
                class="form-input" \r
                placeholder="Enter alternate phone"\r
                pattern="[0-9]*"\r
                inputmode="numeric"\r
                (keypress)="onPhoneKeyPress($event)">\r
            </div>\r
...
function CreatePurchaseOrderModalComponent_option_25_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" ", supplier_r2.name, " - ", supplier_r2.contact_person, " ");
  }
}
function CreatePurchaseOrderModalComponent_div_33_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.getFieldError("vendor_name"), " ");
  }
}
function CreatePurchaseOrderModalComponent_div_38_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.getFieldError("vendor_contact"), " ");
  }
}
function CreatePurchaseOrderModalComponent_div_52_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 61);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.getFieldError("order_date"), " ");
  }
}
function CreatePurchaseOrderModalComponent_div_58_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 61);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.getFieldError("expected_date"), " ");
  }
}
function CreatePurchaseOrderModalComponent_div_84_button_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 74);
    \u0275\u0275listener("click", function CreatePurchaseOrderModalComponent_div_84_button_4_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r4);
...
function CreatePurchaseOrderModalComponent_div_84_option_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 60);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", part_r6.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" ", part_r6.name, " (", part_r6.part_number, ") ");
  }
}
function CreatePurchaseOrderModalComponent_div_84_div_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 61);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.getArrayFieldError("items", i_r5, "part_id"), " ");
  }
}
function CreatePurchaseOrderModalComponent_div_84_div_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 61);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.getArrayFieldError("items", i_r5, "part_number"), " ");
  }
}
function CreatePurchaseOrderModalComponent_div_84_div_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 61);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.getArrayFieldError("items", i_r5, "description"), " ");
  }
}
function CreatePurchaseOrderModalComponent_div_84_div_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 61);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.getArrayFieldError("items", i_r5, "qty"), " ");
  }
}
function CreatePurchaseOrderModalComponent_div_84_div_37_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 61);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.getArrayFieldError("items", i_r5, "unit_cost"), " ");
  }
}
function CreatePurchaseOrderModalComponent_div_84_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 62)(1, "div", 63)(2, "h4", 64);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, CreatePurchaseOrderModalComponent_div_84_button_4_Template, 3, 0, "button", 65);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 15)(6, "div", 16)(7, "label", 66);
    \u0275\u0275text(8, "Part ");
    \u0275\u0275elementStart(9, "span");
    \u0275\u0275text(10, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "select", 67)(12, "option", 20);
    \u0275\u0275text(13, "Select a part");
    \u0275\u0275elementEnd();
    \u0275\u0275template(14, CreatePurchaseOrderModalComponent_div_84_option_14_Template, 2, 3, "option", 21);
    \u0275\u0275elementEnd();
    \u0275\u0275template(15, CreatePurchaseOrderModalComponent_div_84_div_15_Template, 2, 1, "div", 25);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "div", 16)(17, "label", 66);
    \u0275\u0275text(18, "Part Number *");
    \u0275\u0275elementEnd();
    \u0275\u0275element(19, "input", 68);
    \u0275\u0275template(20, CreatePurchaseOrderModalComponent_div_84_div_20_Template, 2, 1, "div", 25);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "div", 15)(22, "div", 39)(23, "label", 66);
    \u0275\u0275text(24, "Description *");
    \u0275\u0275elementEnd();
    \u0275\u0275element(25, "input", 69);
    \u0275\u0275template(26, CreatePurchaseOrderModalComponent_div_84_div_26_Template, 2, 1, "div", 25);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(27, "div", 15)(28, "div", 16)(29, "label", 66);
    \u0275\u0275text(30, "Quantity *");
    \u0275\u0275elementEnd();
    \u0275\u0275element(31, "input", 70);
    \u0275\u0275template(32, CreatePurchaseOrderModalComponent_div_84_div_32_Template, 2, 1, "div", 25);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "div", 16)(34, "label", 66);
    \u0275\u0275text(35, "Unit Cost *");
    \u0275\u0275elementEnd();
    \u0275\u0275element(36, "input", 71);
    \u0275\u0275template(37, CreatePurchaseOrderModalComponent_div_84_div_37_Template, 2, 1, "div", 25);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "div", 16)(39, "label", 72);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("Item ", i_r5 + 1, "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.itemsArray.length > 1);
    \u0275\u0275advance(3);
    \u0275\u0275property("for", "part_" + i_r5);
    \u0275\u0275advance(4);
    \u0275\u0275property("id", "part_" + i_r5);
    \u0275\u0275advance(3);
    \u0275\u0275property("ngForOf", ctx_r2.parts);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.getArrayFieldError("items", i_r5, "part_id"));
    \u0275\u0275advance(2);
    \u0275\u0275property("for", "partNumber_" + i_r5);
    \u0275\u0275advance(2);
    \u0275\u0275property("id", "partNumber_" + i_r5);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.getArrayFieldError("items", i_r5, "part_number"));
    \u0275\u0275advance(3);
    \u0275\u0275property("for", "description_" + i_r5);
    \u0275\u0275advance(2);
    \u0275\u0275property("id", "description_" + i_r5);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.getArrayFieldError("items", i_r5, "description"));
    \u0275\u0275advance(3);
    \u0275\u0275property("for", "qty_" + i_r5);
    \u0275\u0275advance(2);
    \u0275\u0275property("id", "qty_" + i_r5);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.getArrayFieldError("items", i_r5, "qty"));
    \u0275\u0275advance(2);
    \u0275\u0275property("for", "cost_" + i_r5);
    \u0275\u0275advance(2);
    \u0275\u0275property("id", "cost_" + i_r5);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.getArrayFieldError("items", i_r5, "unit_cost"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(43, 20, ctx_r2.calculateItemTotal(i_r5)));
  }
}
function CreatePurchaseOrderModalComponent_Conditional_120_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 58);
  }
}
function CreatePurchaseOrderModalComponent_app_add_supplier_modal_122_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-add-supplier-modal", 76);
    \u0275\u0275listener("closeModal", function CreatePurchaseOrderModalComponent_app_add_supplier_modal_122_Template_app_add_supplier_modal_closeModal_0_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.closeAddSupplierModal());
    })("supplierCreated", function CreatePurchaseOrderModalComponent_app_add_supplier_modal_122_Template_app_add_supplier_modal_supplierCreated_0_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onSupplierCreated($event));
    });
    \u0275\u0275elementEnd();
  }
}
var CreatePurchaseOrderModalComponent = class _CreatePurchaseOrderModalComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CreatePurchaseOrderModalComponent, selectors: [["app-create-purchase-order-modal"]], viewQuery: function CreatePurchaseOrderModalComponent_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuery(_c0, 5);
    }
    if (rf & 2) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(8, "div", 8)(9, "form", 9);
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(15, "h3", 14);
      \u0275\u0275text(16, "Supplier Information");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(17, "div", 15)(18, "div", 16)(19, "label", 17);
      \u0275\u0275text(20, "Supplier (Optional)");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(21, "div", 18)(22, "select", 19)(23, "option", 20);
      \u0275\u0275text(24, "Select a supplier");
      \u0275\u0275elementEnd();
      \u0275\u0275template(25, CreatePurchaseOrderModalComponent_option_25_Template, 2, 3, "option", 21);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(26, "button", 22);
      \u0275\u0275listener("click", function CreatePurchaseOrderModalComponent_Template_button_click_26_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.openAddSupplierModal());
      });
      \u0275\u0275text(27, " New Supplier ");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(28, "div", 15)(29, "div", 16)(30, "label", 23);
      \u0275\u0275text(31, "Vendor Name *");
      \u0275\u0275elementEnd();
      \u0275\u0275element(32, "input", 24);
      \u0275\u0275template(33, CreatePurchaseOrderModalComponent_div_33_Template, 2, 1, "div", 25);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(34, "div", 16)(35, "label", 26);
      \u0275\u0275text(36, "Vendor Contact *");
      \u0275\u0275elementEnd();
      \u0275\u0275element(37, "input", 27);
      \u0275\u0275template(38, CreatePurchaseOrderModalComponent_div_38_Template, 2, 1, "div", 25);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(39, "div", 10)(40, "div", 11)(41, "div", 28);
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(42, "svg", 6);
      \u0275\u0275element(43, "path", 29);
      \u0275\u0275elementEnd()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(44, "h3", 14);
      \u0275\u0275text(45, "Order Details");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(46, "div", 15)(47, "div", 16)(48, "label", 30);
      \u0275\u0275text(49, "Order Date *");
      \u0275\u0275elementEnd();
      \u0275\u0275element(50, "input", 31, 0);
      \u0275\u0275template(52, CreatePurchaseOrderModalComponent_div_52_Template, 2, 1, "div", 25);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(53, "div", 16)(54, "label", 32);
      \u0275\u0275text(55, "Expected Delivery *");
      \u0275\u0275elementEnd();
      \u0275\u0275element(56, "input", 33, 0);
      \u0275\u0275template(58, CreatePurchaseOrderModalComponent_div_58_Template, 2, 1, "div", 25);
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275text(63, "Order date should be on or before the expected delivery date");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(64, "div", 15)(65, "div", 16)(66, "label", 37);
      \u0275\u0275text(67, "Tax Rate (%)");
      \u0275\u0275elementEnd();
      \u0275\u0275element(68, "input", 38);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(69, "div", 15)(70, "div", 39)(71, "label", 40);
      \u0275\u0275text(72, "Terms & Conditions");
      \u0275\u0275elementEnd();
      \u0275\u0275element(73, "textarea", 41);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(74, "div", 10)(75, "div", 11)(76, "div", 42);
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(77, "svg", 6);
      \u0275\u0275element(78, "path", 43);
      \u0275\u0275elementEnd()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(79, "h3", 14);
      \u0275\u0275text(80, "Order Items");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(81, "button", 22);
      \u0275\u0275listener("click", function CreatePurchaseOrderModalComponent_Template_button_click_81_listener() {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275template(84, CreatePurchaseOrderModalComponent_div_84_Template, 44, 22, "div", 45);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(85, "div", 46)(86, "div", 47)(87, "div", 48);
      \u0275\u0275text(88, "Subtotal:");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(89, "div", 49);
      \u0275\u0275text(90);
      \u0275\u0275pipe(91, "currency");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(92, "div", 47)(93, "div", 48);
      \u0275\u0275text(94);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275pipe(97, "currency");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(98, "div", 50)(99, "div", 48);
      \u0275\u0275text(100, "Total Order Value:");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(101, "div", 49);
      \u0275\u0275text(102);
      \u0275\u0275pipe(103, "currency");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(104, "div", 10)(105, "div", 11)(106, "div", 51);
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(107, "svg", 6);
      \u0275\u0275element(108, "path", 52);
      \u0275\u0275elementEnd()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(109, "h3", 14);
      \u0275\u0275text(110, "Additional Information");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(111, "div", 15)(112, "div", 39)(113, "label", 53);
      \u0275\u0275text(114, "Notes");
      \u0275\u0275elementEnd();
      \u0275\u0275element(115, "textarea", 54);
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275elementStart(116, "div", 55)(117, "button", 56);
      \u0275\u0275listener("click", function CreatePurchaseOrderModalComponent_Template_button_click_117_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onCancel());
      });
      \u0275\u0275text(118, " Cancel ");
      ...
      \u0275\u0275listener("click", function CreatePurchaseOrderModalComponent_Template_button_click_119_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onSubmit());
      });
      \u0275\u0275template(120, CreatePurchaseOrderModalComponent_Conditional_120_Template, 1, 0, "span", 58);
      \u0275\u0275text(121);
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(122, CreatePurchaseOrderModalComponent_app_add_supplier_modal_122_Template, 1, 0, "app-add-supplier-modal", 59);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      let tmp_12_0;
          ...
          <div class="form-row">\r
            <div class="form-field">\r
              ...
              <input\r
                ...
                id="orderDate"\r
                #dateInput\r
                formControlName="order_date"\r
                class="form-input flatpickr-input"\r
                [class.error]="getFieldError('order_date')"\r
                placeholder="Select order date"\r
                readonly>\r
...
\r
            <div class="form-field">\r
              ...
              <input\r
                type="text"\r
                id="expectedDelivery"\r
                #dateInput\r
                formControlName="expected_date"\r
                class="form-input flatpickr-input"\r
                [class.error]="getFieldError('expected_date')"\r
                placeholder="Select expected delivery date"\r
                readonly>\r
...
\r
          ...
          <div class="form-hint">\r
            ...
            <span>Order date should be on or before the expected delivery date</span>\r
          </div>\r
\r
          <div class="form-row">\r
            <div class="form-field">\r
...
\r
              <div class="form-row">\r
                <div class="form-field">\r
                  <label [for]="'part_' + i" class="field-label">Part <span>*</span></label>\r
                  ...
                  <div class="error-message" *ngIf="getArrayFieldError('items', i, 'part_id')">\r
                    {{ getArrayFieldError('items', i, 'part_id') }}\r
                  </div>\r
                </div>\r
\r
                <div class="form-field">\r
                  <label [for]="'partNumber_' + i" class="field-label">Part Number *</label>\r
                  <input type="text" [id]="'partNumber_' + i" formControlName="part_number" class="form-input" placeholder="Auto-populated when part is selected" readonly>\r
...
\r
              <div class="form-row">\r
                <div class="form-field full-width">\r
                  ...
                  <input type="text" [id]="'description_' + i" formControlName="description" class="form-input" placeholder="Auto-populated when part is selected" readonly>\r
...
\r
                <div class="form-field">\r
                  ...
                  <div class="line-total">{{ calculateItemTotal(i) | currency }}</div>\r
                </div>\r
              </div>\r
            </div>\r
          </div>\r
\r
          <div class="total-section">\r
            <div class="total-row">\r
              ...
              <div class="total-value">{{ calculateSubtotal() | currency }}</div>\r
            </div>\r
            <div class="total-row">\r
              <div class="total-label">Tax ({{ poForm.get('tax_rate')?.value || 0 }}%):</div>\r
              <div class="total-value">{{ calculateTax() | currency }}</div>\r
            </div>\r
            <div class="total-row total-final">\r
              <div class="total-label">Total Order Value:</div>\r
              <div class="total-value">{{ calculateTotal() | currency }}</div>\r
            </div>\r
          </div>\r
        </div>\r
\r
...
\r
    ...
    <div class="modal-footer">\r
      ...
      <button type="submit" class="btn btn-primary gap-2 flex items-center" (click)="onSubmit()" [disabled]="!poForm.valid || submitting">\r
        @if (submitting){\r
          <span class="border-t border-white border-opacity-25 ml-2 w-4 h-4 rounded-full animate-spin inline-block"></span>\r
        }\r
\r
        {{ submitting ? 'Creating...' : 'Create Purchase Order' }}\r
      </button>\r
    </div>\r
  </div>\r
\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CreatePurchaseOrderModalComponent, { className: "CreatePurchaseOrderModalComponent", filePath: "src/app/inventory/components/create-purchase-order-modal/create-purchase-order-modal.component.ts", lineNumber: 15 });
})();
...
function ViewPurchaseOrderModalComponent_div_76_tr_17_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", (item_r1 == null ? null : item_r1.location_info == null ? null : item_r1.location_info.name) || "N/A", " ");
    \u0275\u0275advance(2);
...
function ViewPurchaseOrderModalComponent_div_76_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(17, ViewPurchaseOrderModalComponent_div_76_tr_17_Template, 13, 6, "tr", 37);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(17);
    \u0275\u0275property("ngForOf", (ctx_r1.purchaseOrder == null ? null : ctx_r1.purchaseOrder.items) || \u0275\u0275pureFunction0(1, _c02));
  }
}
...
function ViewPurchaseOrderModalComponent_Conditional_96_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate((ctx_r1.purchaseOrder == null ? null : ctx_r1.purchaseOrder.created_by.first_name) + " " + (ctx_r1.purchaseOrder == null ? null : ctx_r1.purchaseOrder.created_by.last_name) || "System");
  }
}
function ViewPurchaseOrderModalComponent_button_105_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 46);
    \u0275\u0275listener("click", function ViewPurchaseOrderModalComponent_button_105_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
...
var ViewPurchaseOrderModalComponent = class _ViewPurchaseOrderModalComponent {
  ...
  static \u0275fac = function ViewPurchaseOrderModalComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ViewPurchaseOrderModalComponent)(\u0275\u0275directiveInject(CurrencyService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ViewPurchaseOrderModalComponent, selectors: [["app-view-purchase-order-modal"]], inputs: { purchaseOrder: "purchaseOrder" }, outputs: { closeModal: "closeModal", purchaseOrderUpdated: "purchaseOrderUpdated" }, decls: 106, vars: 23, consts: [[1, "modal-overlay", 3, "click"], [1, "modal-content", 3, "click"], [1, "modal-header"], [1, "header-content"], [1, "modal-title"], [1, "po-number"], [1, "close-button", 3, "click"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-5", "h-5"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M6 18L18 6M6 6l12 12"], [1, "modal-body"], [1, "info-section"], [1, "section-header"], [1, "info-grid"], [1, "info-item"], [1, "status-badge", 3, "ngClass"], [1, "total-value"], [1, "supplier-info"], [1, "supplier-card"], [1, "supplier-header"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"], [1, "supplier-details"], [1, "supplier-name"], [1, "supplier-id"], [1, "supplier-contact"], [1, "contact-item"], [1, "items-summary"], ["class", "items-table-container", 4, "ngIf"], ["class", "no-items", 4, "ngIf"], [1, "additional-info"], [1, "notes"], [1, "terms"], [1, "modal-footer"], [1, "btn", "btn-secondary", 3, "click"], ["class", "btn btn-primary !hidden", 3, "click", 4, "ngIf"], [1, "items-table-container"], [1, "items-table"], [1, "text-end"], [4, "ngFor", "ngForOf"], [1, "part-number"], [1, "description"], [1, "quantity"], [1, "unit-cost"], [1, "item-total"], [1, "no-items"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-12", "h-12"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4"], [1, "btn", "btn-primary", "!hidden", 3, "click"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-4", "h-4"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"]], template: function ViewPurchaseOrderModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(96, ViewPurchaseOrderModalComponent_Conditional_96_Template, 2, 1, "span");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(97, "div", 13)(98, "label");
      \u0275\u0275text(99, "Created Date");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(100, "span");
      \u0275\u0275text(101);
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275elementStart(102, "div", 31)(103, "button", 32);
      \u0275\u0275listener("click", function ViewPurchaseOrderModalComponent_Template_button_click_103_listener() {
        return ctx.onClose();
      });
      \u0275\u0275text(104, " Close ");
      \u0275\u0275elementEnd();
      \u0275\u0275template(105, ViewPurchaseOrderModalComponent_button_105_Template, 4, 0, "button", 33);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(7);
      ...
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1("Total Quantity: ", ctx.calculateItemsTotal((ctx.purchaseOrder == null ? null : ctx.purchaseOrder.items) || \u0275\u0275pureFunction0(21, _c02)), "");
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate1("Total Value: ", ctx.formatCurrency(ctx.calculateTotalValue((ctx.purchaseOrder == null ? null : ctx.purchaseOrder.items) || \u0275\u0275pureFunction0(22, _c02))), "");
      \u0275\u0275advance();
      ...
      \u0275\u0275advance(4);
      \u0275\u0275conditional((ctx.purchaseOrder == null ? null : ctx.purchaseOrder.created_by) ? 96 : -1);
      \u0275\u0275advance(5);
...
\r
        <div class="items-table-container" *ngIf="hasItems">\r
          <table class="items-table">\r
            <thead>\r
              <tr>\r
                <th>Received From</th>\r
                <th>Part Number</th>\r
                <th>Description</th>\r
                <th>Quantity</th>\r
                <th>Unit Cost</th>\r
                <th class="text-end">Total</th>\r
              </tr>\r
            </thead>\r
            <tbody>\r
              <tr *ngFor="let item of (purchaseOrder?.items || [])">\r
                <td>\r
                  {{ item?.location_info?.name || 'N/A' }}\r
                </td>\r
      ...
      <div class="info-section">\r
        ...
        <div class="additional-info">\r
          ...
          <div class="info-item">\r
            ...
            @if (purchaseOrder?.created_by){\r
              <span>{{ purchaseOrder?.created_by.first_name + ' ' + purchaseOrder?.created_by.last_name || 'System' }}</span>\r
            }\r
          </div>\r
          <div class="info-item">\r
...
\r
    ...
    <div class="modal-footer">\r
      ...
      <button class="btn btn-primary !hidden" (click)="onEdit()" *ngIf="purchaseOrder?.status === 'draft'">\r
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">\r
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>\r
        </svg>\r
...
`, styles: ['/* src/app/inventory/components/view-purchase-order-modal/view-purchase-order-modal.component.scss */\n.modal-overlay {\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background-color: rgba(0, 0, 0, 0.5);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  z-index: 1000;\n  padding: 1rem;\n}\n.modal-content {\n  background-color: white;\n  border-radius: 0.75rem;\n  box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.25);\n  max-width: 900px;\n  width: 100%;\n  max-height: 90vh;\n  overflow-y: auto;\n  display: flex;\n  flex-direction: column;\n}\n.modal-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: flex-start;\n  padding: 1.5rem 1.5rem 1rem 1.5rem;\n  border-bottom: 1px solid #e5e7eb;\n}\n.modal-header .header-content {\n  flex: 1;\n}\n.modal-header .header-content .modal-title {\n  font-size: 1.5rem;\n  font-weight: 700;\n  color: #111827;\n  margin: 0 0 0.5rem 0;\n}\n.modal-header .header-content .po-number {\n  font-size: 1.125rem;\n  font-weight: 600;\n  color: #3b82f6;\n  font-family: "Courier New", monospace;\n}\n.modal-header .close-button {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  width: 2rem;\n  height: 2rem;\n  border: none;\n  background: none;\n  color: #6b7280;\n  cursor: pointer;\n  border-radius: 0.375rem;\n  transition: all 0.2s;\n}\n.modal-header .close-button:hover {\n  background-color: #f3f4f6;\n  color: #374151;\n}\n.modal-body {\n  flex: 1;\n  padding: 1.5rem;\n  overflow-y: auto;\n}\n.modal-body .info-section {\n  margin-bottom: 2rem;\n}\n.modal-body .info-section:last-child {\n  margin-bottom: 0;\n}\n.modal-body .info-section .section-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 1rem;\n  padding-bottom: 0.75rem;\n  border-bottom: 2px solid #f3f4f6;\n}\n.modal-body .info-section .section-header h3 {\n  font-size: 1.125rem;\n  font-weight: 600;\n  color: #111827;\n  margin: 0;\n}\n.modal-body .info-section .section-header .items-summary {\n  display: flex;\n  gap: 1rem;\n  font-size: 0.875rem;\n  color: #6b7280;\n}\n.modal-body .info-section .section-header .items-summary span {\n  font-weight: 500;\n}\n.modal-body .info-section .info-grid {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));\n  gap: 1rem;\n}\n.modal-body .info-section .info-grid .info-item {\n  display: flex;\n  flex-direction: column;\n  gap: 0.25rem;\n}\n.modal-body .info-section .info-grid .info-item label {\n  font-size: 0.875rem;\n  font-weight: 500;\n  color: #6b7280;\n  text-transform: uppercase;\n  letter-spacing: 0.05em;\n}\n.modal-body .info-section .info-grid .info-item span {\n  font-size: 1rem;\n  color: #111827;\n  font-weight: 500;\n}\n.modal-body .info-section .info-grid .info-item span.total-value {\n  font-weight: 700;\n  color: #10b981;\n  font-size: 1.125rem;\n}\n.modal-body .info-section .info-grid .info-item .status-badge {\n  display: inline-flex;\n  align-items: center;\n  padding: 0.25rem 0.75rem;\n  border-radius: 9999px;\n  font-size: 0.75rem;\n  font-weight: 600;\n  text-transform: capitalize;\n  width: fit-content;\n}\n.modal-body .info-section .info-grid .info-item .status-badge.status-draft {\n  background-color: #f3f4f6;\n  color: #374151;\n}\n.modal-body .info-section .info-grid .info-item .status-badge.status-pending {\n  background-color: #fef3c7;\n  color: #92400e;\n}\n.modal-body .info-section .info-grid .info-item .status-badge.status-approved {\n  background-color: #d1fae5;\n  color: #065f46;\n}\n.modal-body .info-section .info-grid .info-item .status-badge.status-ordered {\n  background-color: #dbeafe;\n  color: #1e40af;\n}\n.modal-body .info-section .info-grid .info-item .status-badge.status-rejected {\n  background-color: #fee2e2;\n  color: #991b1b;\n}\n.modal-body .info-section .info-grid .info-item .status-badge.status-closed {\n  background-color: #e5e7eb;\n  color: #374151;\n}\n.modal-body .info-section .info-grid .info-item .status-badge.status-cancelled {\n  background-color: #fef2f2;\n  color: #7f1d1d;\n}\n.modal-body .info-section .supplier-info .supplier-card {\n  background-color: #f9fafb;\n  border: 1px solid #e5e7eb;\n  border-radius: 0.5rem;\n  padding: 1rem;\n}\n.modal-body .info-section .supplier-info .supplier-card .supplier-header {\n  display: flex;\n  align-items: center;\n  gap: 0.75rem;\n  margin-bottom: 1rem;\n  padding-bottom: 0.75rem;\n  border-bottom: 1px solid #e5e7eb;\n}\n.modal-body .info-section .supplier-info .supplier-card .supplier-header svg {\n  color: #6b7280;\n}\n.modal-body .info-section .supplier-info .supplier-card .supplier-header .supplier-details .supplier-name {\n  font-size: 1.125rem;\n  font-weight: 600;\n  color: #111827;\n  margin-bottom: 0.25rem;\n}\n.modal-body .info-section .supplier-info .supplier-card .supplier-header .supplier-details .supplier-id {\n  font-size: 0.875rem;\n  color: #6b7280;\n  font-family: "Courier New", monospace;\n}\n.modal-body .info-section .supplier-info .supplier-card .supplier-contact {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));\n  gap: 0.75rem;\n}\n.modal-body .info-section .supplier-info .supplier-card .supplier-contact .contact-item {\n  display: flex;\n  flex-direction: column;\n  gap: 0.25rem;\n}\n.modal-body .info-section .supplier-info .supplier-card .supplier-contact .contact-item label {\n  font-size: 0.75rem;\n  font-weight: 500;\n  color: #6b7280;\n  text-transform: uppercase;\n  letter-spacing: 0.05em;\n}\n.modal-body .info-section .supplier-info .supplier-card .supplier-contact .contact-item span {\n  font-size: 0.875rem;\n  color: #111827;\n}\n.modal-body .info-section .items-table-container {\n  overflow-x: auto;\n  border: 1px solid #e5e7eb;\n  border-radius: 0.5rem;\n}\n.modal-body .info-section .items-table-container .items-table {\n  width: 100%;\n  border-collapse: collapse;\n  font-size: 0.875rem;\n}\n.modal-body .info-section .items-table-container .items-table thead {\n  background-color: #f9fafb;\n  border-bottom: 1px solid #e5e7eb;\n}\n.modal-body .info-section .items-table-container .items-table thead th {\n  padding: 0.75rem;\n  text-align: left;\n  font-weight: 600;\n  color: #374151;\n  white-space: nowrap;\n  border-bottom: 1px solid #e5e7eb;\n}\n.modal-body .info-section .items-table-container .items-table tbody tr {\n  border-bottom: 1px solid #f3f4f6;\n}\n.modal-body .info-section .items-table-container .items-table tbody tr:last-child {\n  border-bottom: none;\n}\n.modal-body .info-section .items-table-container .items-table tbody tr:hover {\n  background-color: #f9fafb;\n}\n.modal-body .info-section .items-table-container .items-table tbody tr td {\n  padding: 0.75rem;\n  color: #111827;\n  vertical-align: top;\n}\n.modal-body .info-section .items-table-container .items-table tbody tr td.item-name {\n  font-weight: 600;\n  color: #3b82f6;\n}\n.modal-body .info-section .items-table-container .items-table tbody tr td.part-number {\n  font-family: "Courier New", monospace;\n  color: #6b7280;\n}\n.modal-body .info-section .items-table-container .items-table tbody tr td.description {\n  max-width: 200px;\n  color: #6b7280;\n}\n.modal-body .info-section .items-table-container .items-table tbody tr td.quantity {\n  font-weight: 500;\n  text-align: center;\n}\n.modal-body .info-section .items-table-container .items-table tbody tr td.unit-price {\n  font-weight: 500;\n  text-align: right;\n}\n.modal-body .info-section .items-table-container .items-table tbody tr td.item-total {\n  font-weight: 600;\n  color: #10b981;\n  text-align: right;\n}\n.modal-body .info-section .no-items {\n  text-align: center;\n  padding: 2rem;\n  color: #6b7280;\n}\n.modal-body .info-section .no-items svg {\n  color: #d1d5db;\n  margin: 0 auto 1rem auto;\n}\n.modal-body .info-section .no-items p {\n  margin: 0;\n  font-size: 1rem;\n}\n.modal-body .info-section .additional-info {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(250px, 1fr));\n  gap: 1rem;\n}\n.modal-body .info-section .additional-info .info-item {\n  display: flex;\n  flex-direction: column;\n  gap: 0.25rem;\n}\n.modal-body .info-section .additional-info .info-item label {\n  font-size: 0.875rem;\n  font-weight: 500;\n  color: #6b7280;\n  text-transform: uppercase;\n  letter-spacing: 0.05em;\n}\n.modal-body .info-section .additional-info .info-item span {\n  font-size: 1rem;\n  color: #111827;\n  font-weight: 500;\n}\n.modal-body .info-section .additional-info .info-item span.notes,\n.modal-body .info-section .additional-info .info-item span.terms {\n  color: #6b7280;\n  font-style: italic;\n}\n.modal-footer {\n  display: flex;\n  justify-content: flex-end;\n  gap: 1rem;\n  padding: 1rem 1.5rem 1.5rem 1.5rem;\n  border-top: 1px solid #e5e7eb;\n  background-color: #f9fafb;\n}\n.modal-footer .btn {\n  display: inline-flex;\n  align-items: center;\n  gap: 0.5rem;\n  padding: 0.75rem 1.5rem;\n  border-radius: 0.5rem;\n  font-size: 0.875rem;\n  font-weight: 500;\n  cursor: pointer;\n  transition: all 0.2s;\n  border: none;\n  white-space: nowrap;\n}\n.modal-footer .btn.btn-secondary {\n  background-color: white;\n  color: #374151;\n  border: 1px solid #d1d5db;\n}\n.modal-footer .btn.btn-secondary:hover {\n  background-color: #f9fafb;\n  border-color: #9ca3af;\n}\n.modal-footer .btn.btn-primary {\n  background-color: #3b82f6;\n  color: white;\n}\n.modal-footer .btn.btn-primary:hover {\n  background-color: #2563eb;\n}\n.modal-footer .btn svg {\n  width: 1rem;\n  height: 1rem;\n}\n@media (max-width: 768px) {\n  .modal-content {\n    max-width: 95vw;\n    margin: 0.5rem;\n  }\n  .modal-header {\n    padding: 1rem;\n  }\n  .modal-header .header-content .modal-title {\n    font-size: 1.25rem;\n  }\n  .modal-header .header-content .po-number {\n    font-size: 1rem;\n  }\n  .modal-body {\n    padding: 1rem;\n  }\n  .modal-body .info-section .section-header {\n    flex-direction: column;\n    align-items: flex-start;\n    gap: 0.5rem;\n  }\n  .modal-body .info-section .section-header .items-summary {\n    flex-direction: column;\n    gap: 0.25rem;\n  }\n  .modal-body .info-section .info-grid {\n    grid-template-columns: 1fr;\n  }\n  .modal-body .info-section .supplier-info .supplier-card .supplier-contact {\n    grid-template-columns: 1fr;\n  }\n  .modal-body .info-section .items-table-container .items-table {\n    font-size: 0.75rem;\n  }\n  .modal-body .info-section .items-table-container .items-table thead th,\n  .modal-body .info-section .items-table-container .items-table tbody td {\n    padding: 0.5rem;\n  }\n  .modal-body .info-section .additional-info {\n    grid-template-columns: 1fr;\n  }\n  .modal-footer {\n    padding: 1rem;\n    flex-direction: column;\n  }\n  .modal-footer .btn {\n    width: 100%;\n    justify-content: center;\n  }\n}\n@media (max-width: 480px) {\n  .modal-overlay {\n    padding: 0.5rem;\n  }\n  .modal-content {\n    max-width: 100vw;\n    margin: 0;\n    border-radius: 0;\n    max-height: 100vh;\n  }\n  .modal-header {\n    border-radius: 0;\n  }\n  .modal-footer {\n    border-radius: 0;\n  }\n}\n/*# sourceMappingURL=view-purchase-order-modal.component.css.map */\n'] }]
  }], () => [{ type: CurrencyService }], { purchaseOrder: [{
    type: Input
  }], closeModal: [{
    type: Output
...
function ReceiveItemsModalComponent_div_9_div_9_div_1_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r0.getBackendError("items"), " ");
  }
}
function ReceiveItemsModalComponent_div_9_div_9_div_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 40)(1, "strong");
    \u0275\u0275text(2, "Location:");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r0.getBackendError("location_id"), " ");
  }
}
function ReceiveItemsModalComponent_div_9_div_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 38);
    \u0275\u0275template(1, ReceiveItemsModalComponent_div_9_div_9_div_1_Template, 4, 1, "div", 39)(2, ReceiveItemsModalComponent_div_9_div_9_div_2_Template, 4, 1, "div", 39);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.getBackendError("items"));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.getBackendError("location_id"));
  }
}
function ReceiveItemsModalComponent_div_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(4, "div", 34)(5, "h4", 35);
    \u0275\u0275text(6, "Error Receiving Items");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "p", 36);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275template(9, ReceiveItemsModalComponent_div_9_div_9_Template, 3, 2, "div", 37);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275textInterpolate(ctx_r0.error);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.errors);
  }
}
function ReceiveItemsModalComponent_div_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 41)(1, "h3", 12);
    \u0275\u0275text(2, "Purchase Order Summary");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 42)(4, "div", 43)(5, "label");
    \u0275\u0275text(6, "PO Number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "span");
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "div", 43)(10, "label");
    \u0275\u0275text(11, "Supplier");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "span");
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "div", 43)(15, "label");
...
function ReceiveItemsModalComponent_option_21_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", location_r2.name, " ");
  }
}
...
function ReceiveItemsModalComponent_div_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 36);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ReceiveItemsModalComponent_div_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 36)(1, "strong");
    \u0275\u0275text(2, "No items available to receive.");
    \u0275\u0275elementEnd();
    \u0275\u0275text(3, " All items from this purchase order have already been received. ");
    \u0275\u0275elementEnd();
  }
}
function ReceiveItemsModalComponent_div_29_div_1_div_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 36);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ReceiveItemsModalComponent_div_29_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 48)(1, "div", 49)(2, "h4", 50);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(11, "div", 21)(12, "div", 13)(13, "label", 55);
    \u0275\u0275text(14, "Receive Quantity *");
    \u0275\u0275elementEnd();
    \u0275\u0275element(15, "input", 56);
    \u0275\u0275template(16, ReceiveItemsModalComponent_div_29_div_1_div_16_Template, 2, 1, "div", 18);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    let tmp_5_0;
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", (tmp_5_0 = item_r4.get("part_number")) == null ? null : tmp_5_0.value, " 21123");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("Ordered: ", (tmp_6_0 = item_r4.get("ordered_qty")) == null ? null : tmp_6_0.value, "");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("Received: ", (tmp_7_0 = item_r4.get("received_qty")) == null ? null : tmp_7_0.value, "");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("Remaining: ", (tmp_8_0 = item_r4.get("remaining_qty")) == null ? null : tmp_8_0.value, "");
    \u0275\u0275advance(3);
    \u0275\u0275property("for", "receive_qty_" + i_r3);
    \u0275\u0275advance(2);
    \u0275\u0275property("id", "receive_qty_" + i_r3)("min", 1)("max", (tmp_12_0 = item_r4.get("remaining_qty")) == null ? null : tmp_12_0.value);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.getArrayFieldError(i_r3, "receive_qty"));
  }
}
function ReceiveItemsModalComponent_div_29_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 46);
    \u0275\u0275template(1, ReceiveItemsModalComponent_div_29_div_1_Template, 17, 10, "div", 47);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275classProp("has-error", ctx_r0.getBackendError("items") && ctx_r0.itemsArray.length > 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r0.itemsArray.controls);
  }
}
function ReceiveItemsModalComponent_span_47_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "Receiving...");
    \u0275\u0275elementEnd();
...
function ReceiveItemsModalComponent_span_48_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
...
var ReceiveItemsModalComponent = class _ReceiveItemsModalComponent {
  ...
  locations = [];
  constructor(fb, inventoryService, currency) {
    this.fb = fb;
    this.inventoryService = inventoryService;
    this.currency = currency;
  ...
  loadLocations() {
    this.inventoryService.getLocations(1, 1e3, void 0, "name", "asc").subscribe({
      next: (response) => {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReceiveItemsModalComponent, selectors: [["app-receive-items-modal"]], inputs: { purchaseOrder: "purchaseOrder" }, outputs: { closeModal: "closeModal", itemsReceived: "itemsReceived" }, decls: 49, vars: 14, consts: [[1, "modal-overlay", 3, "click"], [1, "modal-container", 3, "click"], [1, "modal-header"], [1, "modal-title"], [1, "close-btn", 3, "click"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-5", "h-5"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M6 18L18 6M6 6l12 12"], [1, "modal-body"], ["class", "error-banner", 4, "ngIf"], ["class", "po-summary", 4, "ngIf"], [1, "receive-form", 3, "ngSubmit", "formGroup"], [1, "form-section"], [1, "section-title"], [1, "form-field"], ["for", "location", 1, "field-label"], ["id", "location", "formControlName", "location_id", 1, "form-select"], ["value", ""], [3, "value", 4, "ngFor", "ngForOf"], ["class", "error-message", 4, "ngIf"], ["class", "error-message items-error", 4, "ngIf"], ["formArrayName", "items", "class", "items-container", 3, "has-error", 4, "ngIf"], [1, "form-row"], ["for", "reference", 1, "field-label"], ["type", "text", "id", "reference", "formControlName", "reference", "placeholder", "e.g., Delivery Note DN-001", 1, "form-input"], [1, "form-field", "full-width"], ["for", "notes", 1, "field-label"], ["id", "notes", "formControlName", "notes", "rows", "3", "placeholder", "Add any additional notes about this delivery...", 1, "form-textarea"], [1, "modal-footer"], ["type", "button", 1, "btn", "btn-secondary", 3, "click"], ["type", "submit", 1, "btn", "btn-primary", 3, "click", "disabled"], [4, "ngIf"], [1, "error-banner"], [1, "error-icon"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z"], [1, "error-content"], [1, "error-title"], [1, "error-message"], ["class", "field-errors", 4, "ngIf"], [1, "field-errors"], ["class", "field-error", 4, "ngIf"], [1, "field-error"], [1, "po-summary"], [1, "summary-grid"], [1, "summary-item"], [3, "value"], [1, "error-message", "items-error"], ["formArrayName", "items", 1, "items-container"], ["class", "item-row", 3, "formGroupName", 4, "ngFor", "ngForOf"], [1, "item-row", 3, "formGroupName"], [1, "item-header"], [1, "item-title"], [1, "item-summary"], [1, "ordered"], [1, "received"], [1, "remaining"], [1, "field-label", 3, "for"], ["type", "number", "formControlName", "receive_qty", 1, "form-input", 3, "id", "min", "max"]], template: function ReceiveItemsModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275template(9, ReceiveItemsModalComponent_div_9_Template, 10, 2, "div", 8)(10, ReceiveItemsModalComponent_div_10_Template, 24, 4, "div", 9);
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(21, ReceiveItemsModalComponent_option_21_Template, 2, 2, "option", 17);
      \u0275\u0275elementEnd();
      \u0275\u0275template(22, ReceiveItemsModalComponent_div_22_Template, 2, 1, "div", 18)(23, ReceiveItemsModalComponent_div_23_Template, 2, 1, "div", 18);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(24, "div", 11)(25, "h3", 12);
      \u0275\u0275text(26, "Items to Receive");
      \u0275\u0275elementEnd();
      \u0275\u0275template(27, ReceiveItemsModalComponent_div_27_Template, 4, 1, "div", 19)(28, ReceiveItemsModalComponent_div_28_Template, 4, 0, "div", 18)(29, ReceiveItemsModalComponent_div_29_Template, 2, 3, "div", 20);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(30, "div", 11)(31, "h3", 12);
      \u0275\u0275text(32, "Additional Information");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(33, "div", 21)(34, "div", 13)(35, "label", 22);
      \u0275\u0275text(36, "Reference");
      \u0275\u0275elementEnd();
      \u0275\u0275element(37, "input", 23);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(38, "div", 21)(39, "div", 24)(40, "label", 25);
      \u0275\u0275text(41, "Notes");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275listener("click", function ReceiveItemsModalComponent_Template_button_click_46_listener() {
        return ctx.onSubmit();
      });
      \u0275\u0275template(47, ReceiveItemsModalComponent_span_47_Template, 2, 0, "span", 30)(48, ReceiveItemsModalComponent_span_48_Template, 2, 0, "span", 30);
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(9);
      ...
      \u0275\u0275advance(7);
      \u0275\u0275classProp("error", ctx.errors.location_id);
      \u0275\u0275advance(3);
      \u0275\u0275property("ngForOf", ctx.locations);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.getFieldError("location_id"));
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.getBackendError("location_id"));
      \u0275\u0275advance(4);
      \u0275\u0275property("ngIf", ctx.getBackendError("items"));
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.itemsArray.length === 0);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.itemsArray.length > 0);
      \u0275\u0275advance(17);
    ...
    <div class="modal-body">\r
      ...
      <div *ngIf="error" class="error-banner">\r
        ...
        <div class="error-content">\r
          <h4 class="error-title">Error Receiving Items</h4>\r
          <p class="error-message">{{ error }}</p>\r
          \r
          <!-- Field-specific errors -->\r
          <div *ngIf="errors" class="field-errors">\r
            <div *ngIf="getBackendError('items')" class="field-error">\r
              <strong>Items:</strong> {{ getBackendError('items') }}\r
            </div>\r
            <div *ngIf="getBackendError('location_id')" class="field-error">\r
              <strong>Location:</strong> {{ getBackendError('location_id') }}\r
            </div>\r
          </div>\r
        </div>\r
      </div>\r
      ...
      <form [formGroup]="receiveForm" (ngSubmit)="onSubmit()" class="receive-form">\r
        ...
        <div class="form-section">\r
          ...
          <div class="form-field">\r
            ...
            <select id="location" formControlName="location_id" class="form-select" [class.error]="errors.location_id">\r
            ...
            <div class="error-message" *ngIf="getBackendError('location_id')">\r
              {{ getBackendError('location_id') }}\r
            </div>\r
          </div>\r
        </div>\r
\r
        ...
        <div class="form-section">\r
          ...
          <div *ngIf="getBackendError('items')" class="error-message items-error">\r
            <strong>Items Error:</strong> {{ getBackendError('items') }}\r
          </div>\r
          <div *ngIf="itemsArray.length === 0" class="error-message">\r
            <strong>No items available to receive.</strong> All items from this purchase order have already been received.\r
          </div>\r
          \r
          <div formArrayName="items" class="items-container" [class.has-error]="getBackendError('items') && itemsArray.length > 0" *ngIf="itemsArray.length > 0">\r
            <div *ngFor="let item of itemsArray.controls; let i = index" [formGroupName]="i" class="item-row">\r
              <div class="item-header">\r
                <h4 class="item-title">{{ item.get('part_number')?.value }} 21123</h4>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReceiveItemsModalComponent, { className: "ReceiveItemsModalComponent", filePath: "src/app/inventory/components/receive-items-modal/receive-items-modal.component.ts", lineNumber: 14 });
})();

// src/app/inventory/components/purchase-orders/purchase-orders.component.ts
function PurchaseOrdersComponent_div_73_Template(rf, ctx) {
  if (rf & 1) {
...
function PurchaseOrdersComponent_div_74_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275listener("click", function PurchaseOrdersComponent_div_74_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
...
function PurchaseOrdersComponent_div_75_div_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275listener("click", function PurchaseOrdersComponent_div_75_div_7_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function PurchaseOrdersComponent_div_75_div_8_tr_21_button_37_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 97);
    \u0275\u0275listener("click", function PurchaseOrdersComponent_div_75_div_8_tr_21_button_37_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r6);
...
function PurchaseOrdersComponent_div_75_div_8_tr_21_button_38_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 97);
    \u0275\u0275listener("click", function PurchaseOrdersComponent_div_75_div_8_tr_21_button_38_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r7);
      const po_r5 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
...
function PurchaseOrdersComponent_div_75_div_8_tr_21_button_39_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 97);
    \u0275\u0275listener("click", function PurchaseOrdersComponent_div_75_div_8_tr_21_button_39_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r8);
      const po_r5 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275element(2, "path", 9);
    \u0275\u0275elementEnd();
    \u0275\u0275text(3, " Receive Items ");
    \u0275\u0275elementEnd();
  }
}
function PurchaseOrdersComponent_div_75_div_8_tr_21_button_40_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 97);
    \u0275\u0275listener("click", function PurchaseOrdersComponent_div_75_div_8_tr_21_button_40_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const po_r5 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.closePurchaseOrder(po_r5));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 34);
...
function PurchaseOrdersComponent_div_75_div_8_tr_21_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275listener("click", function PurchaseOrdersComponent_div_75_div_8_tr_21_Template_button_click_28_listener($event) {
    ...
    \u0275\u0275listener("click", function PurchaseOrdersComponent_div_75_div_8_tr_21_Template_button_click_32_listener() {
      const po_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(37, PurchaseOrdersComponent_div_75_div_8_tr_21_button_37_Template, 4, 0, "button", 100)(38, PurchaseOrdersComponent_div_75_div_8_tr_21_button_38_Template, 4, 0, "button", 100)(39, PurchaseOrdersComponent_div_75_div_8_tr_21_button_39_Template, 4, 0, "button", 100)(40, PurchaseOrdersComponent_div_75_div_8_tr_21_button_40_Template, 4, 0, "button", 100);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(6);
    \u0275\u0275property("ngIf", po_r5.status === "draft" || po_r5.status === "pending");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", po_r5.status === "approved");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", po_r5.status === "ordered");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", po_r5.status === "received" || po_r5.status === "ordered");
  }
}
function PurchaseOrdersComponent_div_75_div_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 64)(1, "table", 52)(2, "thead")(3, "tr", 65)(4, "th", 66);
    \u0275\u0275text(5, "PO Number");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(21, PurchaseOrdersComponent_div_75_div_8_tr_21_Template, 41, 16, "tr", 74);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function PurchaseOrdersComponent_div_75_div_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function PurchaseOrdersComponent_div_75_div_9_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function PurchaseOrdersComponent_div_75_div_9_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.onPageChange(ctx_r1.currentPage + 1));
    });
...
function PurchaseOrdersComponent_div_75_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 52)(1, "div", 53)(2, "h3", 54);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 55)(5, "span", 56);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(7, PurchaseOrdersComponent_div_75_div_7_Template, 11, 0, "div", 57)(8, PurchaseOrdersComponent_div_75_div_8_Template, 22, 1, "div", 58)(9, PurchaseOrdersComponent_div_75_div_9_Template, 8, 5, "div", 59);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function PurchaseOrdersComponent_app_create_purchase_order_modal_76_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-create-purchase-order-modal", 107);
    \u0275\u0275listener("closeModal", function PurchaseOrdersComponent_app_create_purchase_order_modal_76_Template_app_create_purchase_order_modal_closeModal_0_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeCreatePOModal());
    })("createPurchaseOrder", function PurchaseOrdersComponent_app_create_purchase_order_modal_76_Template_app_create_purchase_order_modal_createPurchaseOrder_0_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r1 = \u0275\u0275nextContext();
...
function PurchaseOrdersComponent_app_view_purchase_order_modal_77_Template(rf, ctx) {
  if (rf & 1) {
    const _r12 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-view-purchase-order-modal", 108);
    \u0275\u0275listener("closeModal", function PurchaseOrdersComponent_app_view_purchase_order_modal_77_Template_app_view_purchase_order_modal_closeModal_0_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeViewPOModal());
    })("purchaseOrderUpdated", function PurchaseOrdersComponent_app_view_purchase_order_modal_77_Template_app_view_purchase_order_modal_purchaseOrderUpdated_0_listener($event) {
      \u0275\u0275restoreView(_r12);
      const ctx_r1 = \u0275\u0275nextContext();
...
function PurchaseOrdersComponent_app_receive_items_modal_78_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-receive-items-modal", 109);
    \u0275\u0275listener("closeModal", function PurchaseOrdersComponent_app_receive_items_modal_78_Template_app_receive_items_modal_closeModal_0_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeReceiveItemsModal());
    })("itemsReceived", function PurchaseOrdersComponent_app_receive_items_modal_78_Template_app_receive_items_modal_itemsReceived_0_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r1 = \u0275\u0275nextContext();
...
var PurchaseOrdersComponent = class _PurchaseOrdersComponent {
  ...
  constructor(inventoryService, currency) {
    this.inventoryService = inventoryService;
    this.currency = currency;
  }
  ngOnInit() {
  ...
  closePurchaseOrder(po) {
    if (!po.id) {
      this.error = "Purchase Order ID is missing";
      return;
    }
    this.inventoryService.updatePurchaseOrder(po.id, { status: "closed" }).subscribe({
      next: (response) => {
        if (response.success) {
          this.loadPurchaseOrders();
          this.loadOverviewStats();
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PurchaseOrdersComponent, selectors: [["app-purchase-orders"]], decls: 79, vars: 12, consts: [[1, "purchase-orders"], [1, "overview-cards-row"], [1, "overview-card", "total-pos"], [1, "card-content"], [1, "card-value"], [1, "card-label"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "card-icon"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"], [1, "overview-card", "pending"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"], [1, "overview-card", "approved"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M5 13l4 4L19 7"], [1, "overview-card", "total-value"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1"], [1, "control-bar"], [1, "search-controls"], [1, "search-container"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "search-icon"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"], ["type", "text", "placeholder", "Search purchase orders...", 1, "search-input", 3, "ngModelChange", "ngModel"], [1, "status-dropdown"], [1, "status-select", 3, "ngModelChange", "ngModel"], ["value", ""], ["value", "draft"], ["value", "pending"], ["value", "approved"], ["value", "ordered"], ["value", "rejected"], ["value", "closed"], ["value", "cancelled"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "dropdown-arrow"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M19 9l-7 7-7-7"], [1, "action-buttons"], [1, "btn", "btn-secondary", 3, "click"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-4", "h-4"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"], [1, "btn", "btn-secondary", "!hidden"], [1, "btn", "btn-primary", 3, "click"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M12 4v16m8-8H4"], ["class", "loading-state", 4, "ngIf"], ["class", "error-state", 4, "ngIf"], ["class", "purchase-orders-table", 4, "ngIf"], [3, "closeModal", "createPurchaseOrder", 4, "ngIf"], [3, "purchaseOrder", "closeModal", "purchaseOrderUpdated", 4, "ngIf"], [3, "purchaseOrder", "closeModal", "itemsReceived", 4, "ngIf"], [1, "loading-state"], [1, "loading-spinner"], [1, "error-state"], [1, "error-icon"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-8", "h-8"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"], [1, "error-message"], [1, "purchase-orders-table"], [1, "table-header"], [1, "table-title"], [1, "table-actions"], [1, "text-sm", "text-gray-500"], ["class", "empty-state", 4, "ngIf"], ["class", "table-wrapper", 4, "ngIf"], ["class", "pagination", 4, "ngIf"], [1, "empty-state"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "empty-icon"], [1, "empty-title"], [1, "empty-description"], [1, "table-wrapper"], [1, "uppercase"], [1, "th-po-number"], [1, "th-supplier"], [1, "th-order-date"], [1, "th-expected-date"], [1, "th-status"], [1, "th-items"], [1, "th-total"], [1, "th-actions"], ["class", "table-row", 4, "ngFor", "ngForOf"], [1, "table-row"], [1, "td-po-number"], [1, "po-number"], [1, "td-supplier"], [1, "supplier-info"], [1, "supplier-name"], [1, "supplier-id"], [1, "td-order-date"], [1, "td-expected-date"], [1, "td-status"], [1, "status-badge", 3, "ngClass"], [1, "td-items"], [1, "items-info"], [1, "items-count"], [1, "items-summary"], [1, "td-total"], [1, "total-amount"], [1, "td-actions"], [1, "dropdown-container"], [1, "dropdown-trigger", 3, "click"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z"], [1, "dropdown-menu"], [1, "dropdown-item", 3, "click"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M15 12a3 3 0 11-6 0 3 3 0 016 0z"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"], ["class", "dropdown-item", 3, "click", 4, "ngIf"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M6 18L18 6M6 6l12 12"], [1, "pagination"], [1, "pagination-info"], [1, "pagination-buttons"], [1, "btn", "btn-outline", 3, "click", "disabled"], [3, "closeModal", "createPurchaseOrder"], [3, "closeModal", "purchaseOrderUpdated", "purchaseOrder"], [3, "closeModal", "itemsReceived", "purchaseOrder"]], template: function PurchaseOrdersComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("ngModelChange", function PurchaseOrdersComponent_Template_input_ngModelChange_39_listener() {
      ...
      \u0275\u0275listener("ngModelChange", function PurchaseOrdersComponent_Template_select_ngModelChange_41_listener() {
      ...
      \u0275\u0275listener("click", function PurchaseOrdersComponent_Template_button_click_61_listener() {
      ...
      \u0275\u0275listener("click", function PurchaseOrdersComponent_Template_button_click_69_listener() {
        return ctx.openCreatePOModal();
      });
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(70, "svg", 34);
      \u0275\u0275element(71, "path", 38);
      \u0275\u0275elementEnd();
      \u0275\u0275text(72, " Create Purchase Order ");
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(73, PurchaseOrdersComponent_div_73_Template, 4, 0, "div", 39)(74, PurchaseOrdersComponent_div_74_Template, 8, 1, "div", 40)(75, PurchaseOrdersComponent_div_75_Template, 10, 6, "div", 41)(76, PurchaseOrdersComponent_app_create_purchase_order_modal_76_Template, 1, 0, "app-create-purchase-order-modal", 42)(77, PurchaseOrdersComponent_app_view_purchase_order_modal_77_Template, 1, 1, "app-view-purchase-order-modal", 43)(78, PurchaseOrdersComponent_app_receive_items_modal_78_Template, 1, 1, "app-receive-items-modal", 44);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(5);
...
\r
    <div class="action-buttons">\r
      <button class="btn btn-secondary" (click)="refreshData()">\r
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">\r
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"\r
      ...
      <!-- Templates button retained -->\r
      <button class="btn btn-secondary !hidden">\r
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">\r
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"\r
                d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>\r
        </svg>\r
      ...
      <!-- Budget Controls hidden until feature is shipped -->\r
...
\r
    ...
    <div *ngIf="purchaseOrders.length === 0" class="empty-state">\r
      ...
      <p class="empty-description">No purchase orders match your current filters. Try adjusting your search criteria or\r
        create a new purchase order.</p>\r
      <button class="btn btn-primary" (click)="openCreatePOModal()">\r
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">\r
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>\r
        </svg>\r
...
\r
                <button class="dropdown-item" (click)="approvePurchaseOrder(po)"\r
                        *ngIf="po.status === 'draft' || po.status === 'pending'">\r
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">\r
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>\r
                  </svg>\r
                  Approve\r
...
\r
                <button class="dropdown-item" (click)="openReceiveItemsModal(po)" *ngIf="po.status === 'ordered'">\r
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">\r
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"\r
                          d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>\r
                  </svg>\r
...
\r
                <button class="dropdown-item" (click)="closePurchaseOrder(po)"\r
                        *ngIf="po.status === 'received' || po.status === 'ordered'">\r
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">\r
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"\r
...
\r
    ...
    <div *ngIf="purchaseOrders.length > 0" class="pagination">\r
      <div class="pagination-info">\r
        Showing {{ (currentPage - 1) * perPage + 1 }} to {{ getMinValue(currentPage * perPage, totalItems) }}\r
        of {{ totalItems }} results\r
      </div>\r
