    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: "overview",
            loadComponent: () => import("./chunk-XMRKESSR.js").then((m) => m.DashboardOverviewComponent)
          },
          {
            path: "automation",
            loadComponent: () => import("./chunk-VH6NURVJ.js").then((m) => m.DashboardAutomationComponent)
          },
          {
            path: "alerts",
      ...
      {
        path: "parts-catalog",
        loadComponent: () => import("./chunk-IFAP6L73.js").then((m) => m.PartsCatalogComponent)
      },
      {
        path: "stock-levels",
        loadComponent: () => import("./chunk-WJHRXFDI.js").then((m) => m.StockLevelsComponent)
      },
      {
        path: "transactions",
        loadComponent: () => import("./chunk-NHWAAQJI.js").then((m) => m.TransactionsComponent)
      },
      {
        path: "purchase-orders",
        loadComponent: () => import("./chunk-CSL7OO7Z.js").then((m) => m.PurchaseOrdersComponent)
      },
      {
        path: "abc-analysis",
        loadComponent: () => import("./chunk-F36MZQUB.js").then((m) => m.AbcAnalysisComponent)
      },
      {
        path: "analytics",
        loadComponent: () => import("./chunk-F4ZZZYRJ.js").then((m) => m.AnalyticsComponent)
      }
    ]
  }
];
...
//# sourceMappingURL=chunk-UXXIGQYW.js.map
