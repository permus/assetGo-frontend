...
var InventoryAnalyticsService = class _InventoryAnalyticsService {
  ...
  getPartsCatalog(search, status, page = 1, perPage = 15, isArchived) {
  ...
  archivePart(partId, force = false) {
    return this.http.post(`${this.apiUrl}/inventory/parts/${partId}/archive`, { force }, this.getAuthHeaders());
  }
  restorePart(partId) {
    return this.http.post(`${this.apiUrl}/inventory/parts/${partId}/restore`, {}, this.getAuthHeaders());
  }
  // Bulk Import Methods
  downloadPartsImportTemplate() {
    return this.http.get(`${this.apiUrl}/inventory/parts/import/template`, {
      headers: this.getAuthHeaders().headers,
      responseType: "blob"
    });
  }
  importParts(formData) {
    const headers = {};
    ...
    return this.http.post(`${this.apiUrl}/inventory/parts/import`, formData, {
      headers
    });
  }
...
//# sourceMappingURL=chunk-FQPE6O4E.js.map
