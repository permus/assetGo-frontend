...
@Component({
  selector: 'app-maintenance-delete-confirmation-modal',
  standalone: true,
...
export class MaintenanceDeleteConfirmationModalComponent {
  @Input() isOpen = false;
  @Input() selectedCount = 0;
  // Customizable labels so this modal can be reused across entities
  @Input() entitySingular = 'Maintenance Plan';
  @Input() entityPlural = 'Maintenance Plans';
  @Input() title: string | null = null;
  @Input() warningText: string | null = '⚠️ Warning: This action cannot be undone';
