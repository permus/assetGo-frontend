...
@Component({
  ...
  template: `
    <div class="space-y-6">
      ...
      <div class="border bg-white border-gray-200 p-4 rounded-lg space-y-6">
        <h3 class="font-medium">Date, Time & Number Formats</h3>
        <div>
          <div class="text-sm font-medium mb-2">Date Format</div>
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button class="p-6 rounded-lg border border-gray-200 text-center" [class.bg-blue-600]="form().date_format==='MM/DD/YYYY'" [class.text-white]="form().date_format==='MM/DD/YYYY'" (click)="set('date_format','MM/DD/YYYY')">
              <div class="text-sm">MM/DD/YYYY</div>
              <div class="text-xs opacity-80 mt-2">12/25/2024</div>
            </button>
            <button class="p-6 rounded-lg border border-gray-200 text-center" [class.bg-blue-600]="form().date_format==='DD/MM/YYYY'" [class.text-white]="form().date_format==='DD/MM/YYYY'" (click)="set('date_format','DD/MM/YYYY')">
              <div class="text-sm">DD/MM/YYYY</div>
              <div class="text-xs opacity-80 mt-2">25/12/2024</div>
            </button>
            <button class="p-6 rounded-lg border border-gray-200 text-center" [class.bg-blue-600]="form().date_format==='YYYY-MM-DD'" [class.text-white]="form().date_format==='YYYY-MM-DD'" (click)="set('date_format','YYYY-MM-DD')">
        ...
        <div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <button class="p-6 rounded-lg border border-gray-200 text-center" [class.bg-blue-600]="form().time_format==='12'" [class.text-white]="form().time_format==='12'" (click)="set('time_format','12')">
              <div class="text-sm">12-hour</div>
              <div class="text-xs opacity-80 mt-2">2:30 PM</div>
            </button>
            <button class="p-6 rounded-lg border border-gray-200 text-center" [class.bg-blue-600]="form().time_format==='24'" [class.text-white]="form().time_format==='24'" (click)="set('time_format','24')">
        ...
        <div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button class="p-6 rounded-lg border border-gray-200 text-center" [class.bg-blue-600]="form().number_format==='US'" [class.text-white]="form().number_format==='US'" (click)="set('number_format','US')">
              <div class="text-sm">US Format</div>
              <div class="text-xs opacity-80 mt-2">1,234.56</div>
            </button>
            <button class="p-6 rounded-lg border border-gray-200 text-center" [class.bg-blue-600]="form().number_format==='EU'" [class.text-white]="form().number_format==='EU'" (click)="set('number_format','EU')">
              <div class="text-sm">European</div>
              <div class="text-xs opacity-80 mt-2">1.234,56</div>
            </button>
            <button class="p-6 rounded-lg border border-gray-200 text-center" [class.bg-blue-600]="form().number_format==='AR'" [class.text-white]="form().number_format==='AR'" (click)="set('number_format','AR')">
        ...
        <div>
          ...
          <select class="border border-gray-200 p-2 rounded w-full" [value]="form().timezone || 'Asia/Dhaka'" (change)="set('timezone',$any($event.target).value)">
